...
(function() {
  ...
  function Aa(h) {
      h.roundRect = function(h, N, m, u, sa, D, z, w) {
          z && (this.fillStyle = z);
          ...
          this.beginPath();
          this.moveTo(h + sa, N);
          this.lineTo(h + m - sa, N);
          this.quadraticCurveTo(h + m, N, h + m, N + sa);
          this.lineTo(h + m, N + u - sa);
          this.quadraticCurveTo(h + m, N + u, h + m - sa, N + u);
          this.lineTo(h + sa, N + u);
          this.quadraticCurveTo(h, N + u, h, N + u - sa);
          this.lineTo(h, N + sa);
          this.quadraticCurveTo(h, N, h + sa, N);
          this.closePath();
          z && this.fill();
          w && 0 < D && this.stroke()
      }
  ...
  function Q(h, p, N, u, ja) {
      ...
      u.push([h, p, N, ja]);
      return h.addEventListener ? (h.addEventListener(p, N, ja),
      N) : h.attachEvent ? (u = function(p) {
          p = p || window.event;
  ...
  function hb(h) {
      if (h._menuButton)
          h.exportEnabled ? (Y(h._menuButton, {
              backgroundColor: h.toolbar.itemBackgroundColor,
              color: h.toolbar.fontColor
          }),
          Ma(h._menuButton),
          ua(h, h._menuButton, "menu")) : ya(h._menuButton);
          ...
          Q(h._menuButton, "touchstart", function(h) {
              p = !0
          ...
          Q(h._menuButton, "mousemove", function() {
              ...
              0 >= navigator.userAgent.search("MSIE") && Y(h._menuButton.childNodes[0], {
                  WebkitFilter: "invert(100%)",
                  filter: "invert(100%)"
              }))
          }, h.allDOMEventHandlers, !0);
          Q(h._menuButton, "mouseout", function() {
              p || (Y(h._menuButton, {
                  backgroundColor: h.toolbar.itemBackgroundColor,
                  color: h.toolbar.fontColor
              }),
      ...
      if (h.exportEnabled && h._dropdownMenu) {
          ...
          for (var m = h._dropdownMenu.childNodes, $ = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], ja = 0; ja < m.length; ja++)
              Y(m[ja], {
                  backgroundColor: h.toolbar.itemBackgroundColor,
                  color: h.toolbar.fontColor
              }),
          ...
          m.innerHTML = h._cultureInfo.printText,
          m.style.backgroundColor = h.toolbar.itemBackgroundColor,
          m.style.color = h.toolbar.fontColor,
          h._dropdownMenu.appendChild(m),
          Q(m, "touchstart", function(h) {
              p = !0
          }, h.allDOMEventHandlers),
          Q(m, "mousemove", function() {
              p || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover,
              this.style.color = h.toolbar.fontColorOnHover)
          }, h.allDOMEventHandlers, !0),
          Q(m, "mouseout", function() {
              p || (this.style.backgroundColor = h.toolbar.itemBackgroundColor,
          ...
          m.innerHTML = h._cultureInfo.saveJPGText,
          m.style.backgroundColor = h.toolbar.itemBackgroundColor,
          m.style.color = h.toolbar.fontColor,
          h._dropdownMenu.appendChild(m),
          Q(m, "touchstart", function(h) {
          ...
          m.innerHTML = h._cultureInfo.savePNGText,
          m.style.backgroundColor = h.toolbar.itemBackgroundColor,
          m.style.color = h.toolbar.fontColor,
          h._dropdownMenu.appendChild(m),
          Q(m, "touchstart", function(h) {
  ...
  function $a(h, p, m) {
      h *= na;
      p *= na;
      h = m.getImageData(h, p, 2, 2).data;
      p = !0;
      for (m = 0; 4 > m; m++)
          if (h[m] !== h[m + 4] | h[m] !== h[m + 8] | h[m] !== h[m + 12]) {
              p = !1;
              break
          }
  ...
  function oa(h, p, m) {
      return h in p ? p[h] : m[h]
  }
  function Na(h, p, N, $) {
      u && ab ? ($ = !m($) && $ ? h.getContext("2d", {
          willReadFrequently: !0
      }) : h.getContext("2d"),
      Oa = $.webkitBackingStorePixelRatio || $.mozBackingStorePixelRatio || $.msBackingStorePixelRatio || $.oBackingStorePixelRatio || $.backingStorePixelRatio || 1,
      na = Sa / Oa,
      h.width = p * na,
      h.height = N * na,
      Sa !== Oa && (h.style.width = p + "px",
      h.style.height = N + "px",
      $.scale(na, na))) : (h.width = p,
      h.height = N)
  }
  function ib(h) {
      if (!jb) {
          var p = !1
            , m = !1;
          "undefined" === typeof ra.Chart.creditHref ? (h.creditHref = ka("iuuqr;..b`ow`rkr/bnl."),
          h.creditText = ka("B`ow`rKR/bnl")) : (p = h.updateOption("creditText"),
          m = h.updateOption("creditHref"));
  ...
  function ua(h, p, m) {
      p.getAttribute("state") || (p.style.backgroundColor = h.toolbar.itemBackgroundColor,
      ...
      p.getAttribute("state") !== m && (p.setAttribute("state", m),
      ...
      p.innerHTML = "<img src='" + kb[m].image + "' alt='" + h._cultureInfo[m + "Text"] + "' />",
      Y(p.childNodes[0], {
          height: "95%",
          pointerEvents: "none"
      }));
      p.setAttribute("title", h._cultureInfo[m + "Text"])
  }
  function Ma() {
  ...
  function Ta(h, p, m, u, ja) {
      if (null === h || "undefined" === typeof h)
          return "undefined" === typeof m ? p : m;
      h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? p / 100 : 1);
      "undefined" !== typeof u && (h = Math.min(u, h),
      "undefined" !== typeof ja && (h = Math.max(ja, h)));
      return !isNaN(h) && h <= p && 0 <= h ? h : "undefined" === typeof m ? p : m
  }
  function K(h, p, u, $, ja) {
      this._defaultsKey = h;
  ...
  function Ba(h, p) {
      ...
      if (m(this.options.margin) && h.options.subtitles)
          for (var u = h.options.subtitles, $ = 0; $ < u.length; $++)
              if ((m(u[$].horizontalAlign) && "center" === this.horizontalAlign || u[$].horizontalAlign === this.horizontalAlign) && (m(u[$].verticalAlign) && "top" === this.verticalAlign || u[$].verticalAlign === this.verticalAlign) && !u[$].dockInsidePlotArea === !this.dockInsidePlotArea) {
                  this.margin = 0;
                  break
              }
  ...
  function Ja(h, p, m) {
      Ja.base.constructor.call(this, "Subtitle", "subtitles", p, m, h);
      this.chart = h;
      this.canvas = h.canvas;
      this.ctx = this.chart.ctx;
  ...
  var Ia = !1, xa = {}, u = !!document.createElement("canvas").getContext, ra = {
      Chart: {
          width: 500,
          height: 400,
          zoomEnabled: !1,
      ...
      en: {}
  }, z = u ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Ga = u ? "Impact, Charcoal, sans-serif" : "Arial", Ca = {
  ...
  (function() {
      xa.fSDec = function(h) {
          for (var p = "", m = 0; m < h.length; m++)
              p += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(m));
          return p
      }
      ;
  ...
  var gb = function() {
      var h = !1;
      try {
          var p = Object.defineProperty && Object.defineProperty({}, "passive", {
              get: function() {
                  h = !0;
                  return !1
              }
          });
          window.addEventListener && (window.addEventListener("test", null, p),
    ...
    , Da = function() {
      var h = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g
        ...
        , m = "Sun Mon Tue Wed Thu Fri Sat".split(" ")
        , u = "January February March April May June July August September October November December".split(" ")
        , ja = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")
        , z = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g
        , D = /[^-+\dA-Z]/g;
      return function(w, I, P) {
          var E = P ? P.days : p
            , Z = P ? P.months : u
            , Q = P ? P.shortDays : m
            , U = P ? P.shortMonths : ja;
          P = "";
          var Y = !1;
          w = w && w.getTime ? w : w ? new Date(w) : new Date;
          if (isNaN(w))
              throw SyntaxError("invalid date");
          "UTC:" === I.slice(0, 4) && (I = I.slice(4),
          Y = !0);
          P = Y ? "getUTC" : "get";
          var K = w[P + "Date"]()
            , O = w[P + "Day"]()
            ...
            , b = w[P + "Seconds"]()
            , e = w[P + "Milliseconds"]()
            , g = Y ? 0 : w.getTimezoneOffset();
          return P = I.replace(h, function(q) {
              switch (q) {
              case "D":
                  return K;
              case "DD":
              ...
              case "TT":
                  return 12 > d ? "AM" : "PM";
              case "K":
                  return Y ? "UTC" : (String(w).match(z) || [""]).pop().replace(D, "");
              case "z":
    ...
    , nb = function(h) {
      var p = 0 > h;
      if (1 > Math.abs(h)) {
          var m = parseInt(h.toString().split("e-")[1]);
          m && (h = (p ? -1 * h : h) * Math.pow(10, m - 1),
          h = "0." + Array(m).join("0") + h.toString().substring(2),
          h = p ? "-" + h : h)
      } else
          m = parseInt(h.toString().split("+")[1]),
          20 < m && (m -= 20,
          h /= Math.pow(10, m),
          h = h.toString() + Array(m + 1).join("0"));
      return String(h)
  }
    , ga = function(h, p, m) {
      if (null === h)
      ...
      var u = 0 > h ? !0 : !1;
      u && (h *= -1);
      var z = m ? m.decimalSeparator : "."
        , w = m ? m.digitGroupSeparator : ","
        , D = "";
      p = String(p);
      var D = 1
        , I = m = ""
      ...
      for (var O = 0; I && O < I.length; O++)
          ...
          "." === p && 0 > E)
              ...
              if ("%" === p)
                  ...
                  "E" !== p[0] && "e" !== p[0] || "0" !== p[p.length - 1] || (K = !0);
              0 > E ? (P.push(p),
              "#" === p || "0" === p ? Q++ : "," === p && Y++) : (Z.push(p),
              "#" !== p && "0" !== p || U++)
          }
      K && (p = Math.floor(h),
      I = -Math.floor(Math.log(h) / Math.LN10 + 1),
      R = 0 === h ? 0 : 0 === p ? -(Q + I) : nb(p).length - Q,
      D /= Math.pow(10, R));
      0 > E && (E = O);
      D = (h * D).toFixed(U);
      p = D.split(".");
          ...
          "#" === p || "0" === p)
              ...
              E === Q) {
                  var X = D
                    , D = [];
                  if ("0" === p)
                      for (p = Q - U - (X ? X.length : 0); 0 < p; )
                          X.unshift("0"),
                          p--;
                  for (; 0 < X.length; )
                      m = X.pop() + m,
                      K++,
                      0 === K % I && (O === Y && 0 < X.length) && (m = w + m)
              } else
                  0 < D.length ? (m = D.pop() + m,
                  U++,
                  K++) : "0" === p && (m = "0" + m,
                  U++,
                  K++),
                  0 === K % I && (O === Y && 0 < D.length) && (m = w + m);
          else
              "E" !== p[0] && "e" !== p[0] || "0" !== p[p.length - 1] || !/[eE][+-]*[0]+/.test(p) ? "," === p ? (O++,
              I = K,
              K = 0,
              0 < D.length && (m = w + m)) : m = 1 < p.length && ('"' === p[0] && '"' === p[p.length - 1] || "'" === p[0] && "'" === p[p.length - 1]) ? p.slice(1, p.length - 1) + m : p + m : (p = 0 > R ? p.replace("+", "").replace("-", "") : p.replace("-", ""),
              m += p.replace(/[0]+/, function(a) {
                  return ea(R, a.length)
              }));
      w = "";
      for (P = !1; 0 < Z.length; )
          p = Z.shift(),
          "#" === p || "0" === p ? 0 < h.length && 0 !== Number(h.join("")) ? (w += h.shift(),
          P = !0) : "0" === p && (w += "0",
          P = !0) : 1 < p.length && ('"' === p[0] && '"' === p[p.length - 1] || "'" === p[0] && "'" === p[p.length - 1]) ? w += p.slice(1, p.length - 1) : "E" !== p[0] && "e" !== p[0] || "0" !== p[p.length - 1] || !/[eE][+-]*[0]+/.test(p) ? w += p : (p = 0 > R ? p.replace("+", "").replace("-", "") : p.replace("-", ""),
          w += p.replace(/[0]+/, function(a) {
              return ea(R, a.length)
          }));
      m += (P ? z : "") + w;
      return u ? "-" + m : m
    ...
    , Pa = function(h) {
      ...
      m = h.offsetY) : h.layerX || 0 == h.layerX ? (p = h.layerX,
      m = h.layerY) : (p = h.pageX - h.target.offsetLeft,
      m = h.pageY - h.target.offsetTop);
      return {
          x: p,
          y: m
      }
    ...
    , Oa = 1
    , na = ab ? Sa / Oa : 1
    , ba = function(h, p, m, u, w, z, D, I, E, P, Z, U, Q) {
      "undefined" === typeof Q && (Q = 1);
      D = D || 0;
      I = I || "black";
      var K = 15 < u - p && 15 < w - m ? 8 : 0.35 * Math.min(u - p, w - m);
      h.beginPath();
      h.moveTo(p, m);
      h.save();
      h.fillStyle = z;
      h.globalAlpha = Q;
      h.fillRect(p, m, u - p, w - m);
      h.globalAlpha = 1;
      0 < D && (Q = 0 === D % 2 ? 0 : 0.5,
      h.beginPath(),
      h.lineWidth = D,
      h.strokeStyle = I,
      h.moveTo(p, m),
      h.rect(p - Q, m - Q, u - p + 2 * Q, w - m + 2 * Q),
      h.stroke());
      h.restore();
      !0 === E && (h.save(),
      h.beginPath(),
      ...
      h.lineTo(u, m),
      h.closePath(),
      D = h.createLinearGradient((u + p) / 2, m + K, (u + p) / 2, m),
      D.addColorStop(0, z),
      ...
      h.lineTo(u, w),
      h.closePath(),
      D = h.createLinearGradient((u + p) / 2, w - K, (u + p) / 2, w),
      D.addColorStop(0, z),
      D.addColorStop(1, "rgba(255, 255, 255, .4)"),
      h.fillStyle = D,
      h.fill(),
      ...
      h.lineTo(p, w),
      h.closePath(),
      D = h.createLinearGradient(p + K, (w + m) / 2, p, (w + m) / 2),
      D.addColorStop(0, z),
      ...
      h.lineTo(u - K, w - K),
      h.lineTo(u, w),
      D = h.createLinearGradient(u - K, (w + m) / 2, u, (w + m) / 2),
      D.addColorStop(0, z),
      D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
      h.fillStyle = D,
      D.addColorStop(0, z),
    ...
    , ka = function(h) {
      for (var m = "", u = 0; u < h.length; u++)
          m += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(u));
      return m
  }
    , jb = window && (window[ka("mnb`uhno")] && window[ka("mnb`uhno")].href && window[ka("mnb`uhno")].href.indexOf && (-1 !== window[ka("mnb`uhno")].href.indexOf(ka("b`ow`rkr/bnl")) || -1 !== window[ka("mnb`uhno")].href.indexOf(ka("gdonqhy/bnl")) || -1 !== window[ka("mnb`uhno")].href.indexOf(ka("gheemd")))) && -1 === window[ka("mnb`uhno")].href.indexOf(ka("gheemd"))
    , kb = {
      reset: {
  ...
  K.prototype.setOptions = function(h, m) {
      if (ra[this._defaultsKey]) {
          var u = ra[this._defaultsKey], w;
          for (w in u)
              "publicProperties" !== w && u.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : m && w in m ? m[w] : u[w])
      } else
  ...
  K.prototype.get = function(h) {
      ...
      if (m.hasOwnProperty(h) || m.publicProperties && m.publicProperties.hasOwnProperty(h))
          return this[h];
      window.console && window.console.log('Property "' + h + "\" doesn't exist. Please check for typo.")
  }
  ;
  K.prototype.set = function(h, m, u) {
      u = "undefined" === typeof u ? !0 : u;
      var w = ra[this._defaultsKey];
      if ("options" === h)
          this.createUserOptions(m);
      else if (w.hasOwnProperty(h) || w.publicProperties && w.publicProperties.hasOwnProperty(h) && "readWrite" === w.publicProperties[h])
  ...
  ;
  K.prototype.addTo = function(h, m, u, w) {
      w = "undefined" === typeof w ? !0 : w;
      var z = ra[this._defaultsKey];
      z.hasOwnProperty(h) || z.publicProperties && z.publicProperties.hasOwnProperty(h) && "readWrite" === z.publicProperties[h] ? (this.options._isPlaceholder && this.createUserOptions(),
      "undefined" === typeof this.options[h] && (this.options[h] = []),
      h = this.options[h],
      u = "undefined" === typeof u || null === u ? h.length : u,
      h.splice(u, 0, m),
      w && (this.stockChart || this.chart || this).render()) : window.console && (z.publicProperties && z.publicProperties.hasOwnProperty(h) && "readOnly" === z.publicProperties[h] ? window.console.log('Property "' + h + '" is read-only.') : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."))
  }
  ;
      ...
      if ("undefined" !== typeof h || this.options._isPlaceholder)
          ...
          this.isOptionsInArray) {
              ...
              var m = this.parent.options[this.optionsName]
                , u = m.length;
              this.options._isPlaceholder || (Ea(m),
              u = m.indexOf(this.options));
              this.options = "undefined" === typeof h ? {} : h;
              m[u] = this.options
          } else
              this.options = "undefined" === typeof h ? {} : h,
              h = this.parent.options,
              this.optionsName ? m = this.optionsName : (m = this._defaultsKey) && 0 !== m.length ? (u = m.charAt(0).toLowerCase(),
              1 < m.length && (u = u.concat(m.slice(1))),
              m = u) : m = void 0,
              h[m] = this.options
  }
  ;
  ...
  K.prototype.updateOption = function(h) {
      ...
      var p = ra[this._defaultsKey]
        ...
        , I = this._index;
      this.theme && m(this.parent) && m(z) && m(I) ? u = m(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[z]) && (null === I ? u = this.parent.themeOptions[z] : 0 < this.parent.themeOptions[z].length && (u = Math.min(this.parent.themeOptions[z].length - 1, I),
      u = this.parent.themeOptions[z][u]));
      this.themeOptions = u;
      h in p && (w = h in this.options ? this.options[h] : u && h in u ? u[h] : p[h]);
      if (w === this[h])
          return !1;
      this[h] = w;
      return !0
  ...
  ;
  K.prototype.addEventListener = function(h, m, u) {
  ...
  ;
  K.prototype.removeEventListener = function(h, m) {
      if (h && m && this._eventListeners[h])
          for (var u = this._eventListeners[h], w = 0; w < u.length; w++)
              if (u[w].eventHandler === m) {
                  u[w].splice(w, 1);
                  break
              }
  }
  ...
  ;
  K.prototype.dispatchEvent = function(h, m, u) {
      if (h && this._eventListeners[h]) {
          m = m || {};
          for (var w = this._eventListeners[h], z = 0; z < w.length; z++)
              w[z].eventHandler.call(w[z].context, m)
      }
      "function" === typeof this[h] && this[h].call(u || this.chart, m)
  }
  ;
  Fa.prototype.registerSpace = function(h, m) {
  ...
  ;
  Fa.prototype.unRegisterSpace = function(h, m) {
      "top" === h ? this._topOccupied -= m.height : "bottom" === h ? this._bottomOccupied -= m.height : "left" === h ? this._leftOccupied -= m.width : "right" === h && (this._rightOccupied -= m.width)
  }
  ;
  ...
  la.prototype._initialize = function() {
      m(this.padding) || "object" !== typeof this.padding ? this.topPadding = this.rightPadding = this.bottomPadding = this.leftPadding = Number(this.padding) | 0 : (this.topPadding = m(this.padding.top) ? 0 : Number(this.padding.top) | 0,
      this.rightPadding = m(this.padding.right) ? 0 : Number(this.padding.right) | 0,
      this.bottomPadding = m(this.padding.bottom) ? 0 : Number(this.padding.bottom) | 0,
      this.leftPadding = m(this.padding.left) ? 0 : Number(this.padding.left) | 0)
  }
  ;
  la.prototype.render = function(h) {
      if (0 !== this.fontSize) {
          ...
          (0 < this.borderThickness && this.borderColor || this.backgroundColor) && this.ctx.roundRect(0, u, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor);
          this.ctx.fillStyle = this.fontColor;
          for (u = 0; u < this._wrappedText.lines.length; u++) {
              I = this._wrappedText.lines[u];
              if ("right" === this.horizontalAlign || "right" === this.textAlign)
                  w = this.width - I.width - this.rightPadding;
              else if ("left" === this.horizontalAlign || "left" === this.textAlign)
                  w = this.leftPadding;
              else if ("center" === this.horizontalAlign || "center" === this.textAlign)
                  w = (this.width - (this.leftPadding + this.rightPadding)) / 2 - I.width / 2 + this.leftPadding;
              this.ctx.fillText(I.text, w, z);
              z += I.height
          }
          this.ctx.font = m;
          h && this.ctx.restore()
  ...
  ;
  la.prototype._getLineWithWidth = function(h, m, u) {
      h = String(h);
      if (!h)
          return {
              text: "",
      ...
      var w = u = 0
        , z = h.length - 1
        , I = Infinity;
      for (this.ctx.font = this._getFontString(); w <= z; ) {
          var I = Math.floor((w + z) / 2)
            , D = h.substr(0, I + 1);
          u = this.ctx.measureText(D).width;
          if (u < m)
              w = I + 1;
          else if (u > m)
              z = I - 1;
      ...
      u > m && 1 < D.length && (D = D.substr(0, D.length - 1),
      u = this.ctx.measureText(D).width);
      m = !0;
  ...
  la.prototype._wrapText = function() {
      ...
      if (0 === this.frontSize)
          ...
          for (; 0 < h.length; ) {
              ...
              m.push(D);
              var K = z
                , z = Math.max(z, D.width)
                , w = w + D.height
                , h = Ha(h.slice(D.text.length, h.length));
              I && w > I && (D = m.pop(),
              w -= D.height,
              z = K)
          }
      ...
      this.width = z + (this.leftPadding + this.rightPadding);
  ...
  Ba.prototype.setLayout = function() {
      if (this.text) {
          var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, p = h.layoutManager.getFreeSpace(), u = p.x1, w = p.y1, z = 0, I = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 40 : 0, K, E;
          "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = p.width - 4 - D * ("center" === this.horizontalAlign ? 2 : 1)),
          I = 0.5 * p.height - this.margin - 2,
          z = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = p.height - 4),
          I = 0.5 * p.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = p.width - 4),
          I = 0.5 * p.height - 4));
          var P;
          m(this.padding) || "number" !== typeof this.padding ? m(this.padding) || "object" !== typeof this.padding || (P = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0,
          P += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : P = 2 * this.padding;
          ...
          P = I.measureText();
          "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (w = p.y1 + 2 + this.fontSize / 2 + 4,
          E = "top") : "bottom" === this.verticalAlign && (w = p.y2 - 2 - P.height + this.fontSize / 2 + 4,
          E = "bottom"),
          "left" === this.horizontalAlign ? u = p.x1 + 2 : "center" === this.horizontalAlign ? u = p.x1 + p.width / 2 - P.width / 2 : "right" === this.horizontalAlign && (u = p.x2 - 2 - P.width - D),
          K = this.horizontalAlign,
          this.width = P.width,
          this.height = P.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (u = p.x1 + 2 + (this.fontSize / 2 + 4),
          w = p.y2 - 2 - (this.maxWidth / 2 - P.width / 2),
          z = -90,
          E = "left",
          this.width = P.height,
          this.height = P.width) : "right" === this.horizontalAlign ? (u = p.x2 - 2 - (this.fontSize / 2 + 4),
          w = p.y1 + 2 + (this.maxWidth / 2 - P.width / 2),
          z = 90,
          E = "right",
          this.width = P.height,
          this.height = P.width) : "center" === this.horizontalAlign && (w = h.y1 + (h.height / 2 - P.height / 2) + this.fontSize / 2 + 4,
          u = h.x1 + (h.width / 2 - P.width / 2),
          E = "center",
          this.width = P.width,
          ...
          I.horizontalAlign = K;
          this._textBlock = I;
          h.layoutManager.registerSpace(E, {
  ...
  Va.prototype.get = function(h, m) {
      var u = null;
      0 < this.pool.length ? (u = this.pool.pop(),
      Na(u, h, m)) : u = wa(h, m);
      return u
  }
  ;
  ...
  var Qa = {
      ...
      formatNumber: function(h, m, u) {
          u = u || "en";
          if (La[u])
              return ga(h, m || "#,##0.##", new Ka(u));
          throw "Unknown Culture Name";
      },
      formatDate: function(h, m, u) {
          u = u || "en";
          if (La[u])
              return Da(h, m || "DD MMM YYYY", new Ka(u));
          throw "Unknown Culture Name";
      }
  };
  ...
  z = Qa.Chart = function() {
      ...
      function p(a, d, c) {
          ...
          u ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = wa(a, d),
          ...
          this.windowResizeHandler = Q(window, "resize", function() {
          ...
          Q(this.overlaidCanvas, "click", function(a) {
              b._mouseEventHandler(a)
          }, this.allDOMEventHandlers),
          Q(this.overlaidCanvas, "mousemove", function(a) {
              b._mouseEventHandler(a)
          }, this.allDOMEventHandlers),
          Q(this.overlaidCanvas, "mouseup", function(a) {
              b._mouseEventHandler(a)
          }, this.allDOMEventHandlers),
          Q(this.overlaidCanvas, "mousedown", function(a) {
              b._mouseEventHandler(a);
              ya(b._dropdownMenu)
          }, this.allDOMEventHandlers),
          Q(this.overlaidCanvas, "mouseout", function(a) {
              b._mouseEventHandler(a)
          }, this.allDOMEventHandlers),
          Q(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart", function(a) {
              b._touchEventHandler(a)
          }, this.allDOMEventHandlers),
          Q(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerMove" : "touchmove", function(a) {
              b._touchEventHandler(a)
          }, this.allDOMEventHandlers),
          Q(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerUp" : "touchend", function(a) {
              b._touchEventHandler(a)
          }, this.allDOMEventHandlers),
          Q(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerCancel" : "touchcancel", function(a) {
              b._touchEventHandler(a)
          }, this.allDOMEventHandlers),
      ...
      function w(a, d) {
          for (var c = [], b, e = 0; e < a.length; e++)
              if (0 == e)
                  ...
                  var C = (a[q].x - a[g].x) / b;
                  b = (a[q].y - a[g].y) / b;
                  c[c.length] = a[t].x > a[g].x && 0 < C || a[t].x < a[g].x && 0 > C ? {
                      x: a[t].x + C / 3,
                      y: a[t].y + b / 3
                  } : {
                      x: a[t].x,
                      y: a[t].y + (1 === c.length ? 0 : b / 9)
                  };
                  t = e;
                  g = 0 === t ? 0 : t - 1;
                  q = t === a.length - 1 ? t : t + 1;
      ...
      function z(a, d, c, b, e, g, q, t, C, k) {
          var l = 0;
          k ? (q.color = g,
          t.color = g) : k = 1;
          ...
          a.beginPath();
          C && 0 < t.thickness ? (a.moveTo(b - q.thickness / 2, Math.round((c + e) / 2) - n),
          a.lineTo(d + q.thickness / 2, Math.round((c + e) / 2) - n)) : 0 < t.thickness && (a.moveTo(Math.round((d + b) / 2) - n, c + q.thickness / 2),
          a.lineTo(Math.round((d + b) / 2) - n, e - q.thickness / 2));
          a.stroke();
          a.strokeStyle = q.color || g;
          a.lineWidth = q.thickness || 2;
          a.setLineDash && a.setLineDash(I(q.dashType, q.thickness));
          a.beginPath();
          C && 0 < q.thickness ? (a.moveTo(b - l, c),
          a.lineTo(b - l, e),
          a.moveTo(d + l, c),
          a.lineTo(d + l, e)) : 0 < q.thickness && (a.moveTo(d, c + l),
          a.lineTo(b, c + l),
          a.moveTo(d, e - l),
          a.lineTo(b, e - l));
          a.stroke();
      ...
      function R(a, d, c, b) {
          R.base.constructor.call(this, "DataSeries", "data", d, c, a);
          this.chart = a;
          this.canvas = a.canvas;
      ...
      function D(a, d, c, b, e, g) {
          ...
          m(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}),
          this.sessionVariables = this.chart.sessionVariables.axisX[b]) : (this.optionsName = "axisX2",
          m(this.chart.sessionVariables.axisX2[b]) && (this.chart.sessionVariables.axisX2[b] = {}),
          ...
          m(this.chart.sessionVariables.axisY[b]) && (this.chart.sessionVariables.axisY[b] = {}),
          this.sessionVariables = this.chart.sessionVariables.axisY[b]) : (this.optionsName = "axisY2",
          m(this.chart.sessionVariables.axisY2[b]) && (this.chart.sessionVariables.axisY2[b] = {}),
      ...
      function fa(a, d, c, b) {
          ...
          if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
              for (a = 0; a < this.options.customBreaks.length; a++)
                  this.customBreaks.push(new da(this.chart,"customBreaks",this.options.customBreaks[a],a,++this.chart._eventManager.lastObjectId,this)),
      ...
      function da(a, d, c, b, e, g) {
          da.base.constructor.call(this, "Break", d, c, b, g);
          this.id = e;
          this.chart = a;
          this.ctx = this.chart.ctx;
          this.scaleBreaks = g;
      ...
      function ea(a, d, c) {
          ea.base.constructor.call(this, "Crosshair", "crosshair", d, null, c);
          this.chart = a;
          this.ctx = this.chart.ctx;
          this.axis = c;
      ...
      p.prototype._updateOptions = function() {
          ...
          if (this.options.zoomEnabled || this.panEnabled) {
              if (this._zoomButton)
                  ...
                  Q(this._zoomButton, "touchstart", function(a) {
                      d = !0
                  }, this.allDOMEventHandlers);
              ...
              this._resetButton ? (Y(this._resetButton, {
                  borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor,
                  backgroundColor: a.toolbar.itemBackgroundColor,
                  color: a.toolbar.fontColor
              }),
              this._resetButton.title = this._cultureInfo.resetText) : (d = !1,
              ya(this._resetButton = document.createElement("button")),
              ua(this, this._resetButton, "reset"),
              this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor,
              this._toolBar.appendChild(this._resetButton),
              Q(this._resetButton, "touchstart", function(a) {
                  d = !0
              }, this.allDOMEventHandlers),
              Q(this._resetButton, "click", function() {
                  a.toolTip.hide();
                  ...
                  0 >= navigator.userAgent.search("MSIE") && Y(a._resetButton.childNodes[0], {
                      WebkitFilter: "invert(0%)",
                      filter: "invert(0%)"
                  });
              ...
              Q(this._resetButton, "mousemove", function() {
                  d || (Y(a._resetButton, {
                      backgroundColor: a.toolbar.itemBackgroundColorOnHover,
                      color: a.toolbar.fontColorOnHover,
                      transition: "0.4s",
              ...
              this.panEnabled = !1),
              Ma(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0,
              this.panEnabled = !1))
          } else
      ...
      p.prototype._initialize = function() {
          this.isNavigator = m(this.parent) || m(this.parent._defaultsKey) || "Navigator" !== this.parent._defaultsKey ? !1 : !0;
          ...
          if (this.options.data) {
              for (var c = 0; c < this.options.data.length; c++)
                  if (a++,
                  !this.options.data[c].type || 0 <= p._supportedChartTypes.indexOf(this.options.data[c].type)) {
                      var b = new R(this,this.options.data[c],a - 1,++this._eventManager.lastObjectId);
                      if (!m(b) && b.dataPoints)
                      ...
                      "error" === b.type && (b.linkedDataSeriesIndex = m(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex,
      ...
      p.prototype.setLayout = function() {
          ...
          c ? (Ma(this._zoomButton, this._resetButton),
          ...
          fb(this);
          this._processData();
          this.options.title && (this.title = new Ba(this,this.options.title),
          ...
          for (d = 0; d < this._axes.length; d++)
              if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                  u ? (this._breaksCanvas = wa(this.width, this.height, !0),
      ...
      p.prototype.renderElements = function() {
          if (this.height) {
              ...
              u && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height),
              ...
              for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                  for (var g = this.plotInfo.plotTypes[d], q = 0; q < g.plotUnits.length; q++) {
                      ...
                      t.targetCanvas = null;
                      this.animatedRender && (t.targetCanvas = wa(this.width, this.height),
                      ...
                      this.animatedRender && (t.targetCanvasCtx.miterLimit = e,
                      C && c.push(C))
                  }
              ...
              this.animatedRender && 0 < this._indexLabels.length && (e = wa(this.width, this.height).getContext("2d"),
              Aa(e),
              c.push(this.renderIndexLabels(e)));
              var l = this;
              if (0 < c.length)
                  l.disableToolTip = !0,
                  l._animator.animate(200, l.animationDuration, function(a) {
                      ...
                      for (var e = 0; e < c.length; e++)
                          C = c[e],
                          1 > a && "undefined" !== typeof C.startTimePercent ? a >= C.startTimePercent && C.animationCallback(C.easingFunction(a - C.startTimePercent, 0, 1, 1 - C.startTimePercent), C) : C.animationCallback(C.easingFunction(a, 0, 1, 1), C);
                      ...
                      for (var a = 0; a < l.plotInfo.plotTypes.length; a++)
                          for (var e = l.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) {
                              var g = e.plotUnits[d];
      ...
      p.prototype.categoriseDataSeries = function() {
          for (var a = "", d = 0; d < this.data.length; d++)
              ...
              a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= p._supportedChartTypes.indexOf(a.type)) {
                  for (var c = null, b = !1, e = null, g = !1, q = 0; q < this.plotInfo.plotTypes.length; q++)
      ...
      p.prototype._processMultiseriesPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, g = !1, q = 0; q < a.dataSeriesIndexes.length; q++) {
                  var t = this.data[a.dataSeriesIndexes[q]], C = 0, k = !1, l = !1, n;
                  if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement)
                      var r = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity
                  ...
                  for (C = 0; C < t.dataPoints.length; C++) {
                      ...
                      t.dataPoints[C].x.getTime ? (g = !0,
                      b = t.dataPoints[C].x.getTime()) : b = t.dataPoints[C].x;
                      e = t.dataPoints[C].y;
                      b < c.min && (c.min = b);
                      b > c.max && (c.max = b);
                      ...
                      if (0 < C) {
                          if (a.axisX.logarithmic) {
                              ...
                              V = b - t.dataPoints[C - 1].x,
                              0 > V && (V *= -1),
                              c.minDiff > V && 0 !== V && (c.minDiff = V);
                          null !== e && null !== t.dataPoints[C - 1].y && (a.axisY.logarithmic ? (V = e / t.dataPoints[C - 1].y,
                          1 > V && (V = 1 / V),
                          d.minDiff > V && 1 !== V && (d.minDiff = V)) : (V = e - t.dataPoints[C - 1].y,
                          0 > V && (V *= -1),
                          d.minDiff > V && 0 !== V && (d.minDiff = V)))
                      }
                      if (b < r && !k)
                          null !== e && (n = b);
                      else {
                          ...
                          null === e ? c.viewPortMin === b && n < b && (c.viewPortMin = n) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e),
      ...
      p.prototype._processStackedPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, g = !1, q = [], t = [], C = Infinity, k = -Infinity, l = 0; l < a.dataSeriesIndexes.length; l++) {
                  var n = this.data[a.dataSeriesIndexes[l]], r = 0, f = !1, V = !1, h;
                  if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
                      var x = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity
                  ...
                  for (r = 0; r < n.dataPoints.length; r++) {
                      ...
                      n.dataPoints[r].x.getTime ? (g = !0,
                      b = n.dataPoints[r].x.getTime()) : b = n.dataPoints[r].x;
                      ...
                      if (0 < r) {
                          if (a.axisX.logarithmic) {
                              ...
                              y = b - n.dataPoints[r - 1].x,
                              0 > y && (y *= -1),
                              c.minDiff > y && 0 !== y && (c.minDiff = y);
                          null !== e && null !== n.dataPoints[r - 1].y && (a.axisY.logarithmic ? 0 < e && (y = e / n.dataPoints[r - 1].y,
                          1 > y && (y = 1 / y),
                          d.minDiff > y && 1 !== y && (d.minDiff = y)) : (y = e - n.dataPoints[r - 1].y,
                          0 > y && (y *= -1),
                          d.minDiff > y && 0 !== y && (d.minDiff = y)))
                      }
                      if (b < x && !f)
                          null !== n.dataPoints[r].y && (h = b);
                      else {
                          if (!f && (f = !0,
                          0 < r)) {
                              r -= 2;
                          ...
                          b < c.viewPortMin && (c.viewPortMin = b);
                          b > c.viewPortMax && (c.viewPortMax = b);
                          null === n.dataPoints[r].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (n.dataPointEOs[r].cumulativeY = (0 < l ? this.data[a.dataSeriesIndexes[l - 1]].dataPointEOs[r].cumulativeY : 0) + n.dataPoints[r].y,
                          a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                          a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e),
                          0 <= e ? q[b] ? q[b] += e : (q[b] = e,
                          C = Math.min(e, C)) : t[b] ? t[b] += e : (t[b] = e,
                          k = Math.max(e, k)))
                      }
                  }
                  a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, q),
                  d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, t)) : (d.dataPointYPositiveSums = q,
                  d.dataPointYNegativeSums = t));
                  n.axisX.valueType = n.xValueType = g ? "dateTime" : "number"
              }
              for (r in q)
                  q.hasOwnProperty(r) && !isNaN(r) && (a = q[r],
                  a < d.min && (d.min = Math.min(a, C)),
                  a > d.max && (d.max = a),
                  r < c.viewPortMin || r > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, C)),
                  a > d.viewPortMax && (d.viewPortMax = a)));
              for (r in t)
                  t.hasOwnProperty(r) && !isNaN(r) && (a = t[r],
                  a < d.min && (d.min = a),
                  a > d.max && (d.max = Math.max(a, k)),
                  r < c.viewPortMin || r > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a),
      ...
      p.prototype._processStacked100PlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, g = !1, q = !1, t = !1, C = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                  var l = this.data[a.dataSeriesIndexes[k]], n = 0, r = !1, f = !1, V;
                  if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
                      var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity
                  ...
                  for (n = 0; n < l.dataPoints.length; n++) {
                      ...
                      l.dataPoints[n].x.getTime ? (g = !0,
                      b = l.dataPoints[n].x.getTime()) : b = l.dataPoints[n].x;
                      ...
                      if (0 < n) {
                          if (a.axisX.logarithmic) {
                              ...
                              s = b - l.dataPoints[n - 1].x,
                              0 > s && (s *= -1),
                              c.minDiff > s && 0 !== s && (c.minDiff = s);
                          m(e) || null === l.dataPoints[n - 1].y || (a.axisY.logarithmic ? 0 < e && (s = e / l.dataPoints[n - 1].y,
                          1 > s && (s = 1 / s),
                          d.minDiff > s && 1 !== s && (d.minDiff = s)) : (s = e - l.dataPoints[n - 1].y,
                          0 > s && (s *= -1),
                      ...
                      if (b < h && !r)
                          ...
                          b < c.viewPortMin && (c.viewPortMin = b);
                          b > c.viewPortMax && (c.viewPortMax = b);
                          null === e ? c.viewPortMin === b && V < b && (c.viewPortMin = V) : (l.dataPointEOs[n].cumulativeY = (0 < k ? this.data[a.dataSeriesIndexes[k - 1]].dataPointEOs[n].cumulativeY : 0) + l.dataPoints[n].y,
                          a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                          a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e),
                          0 <= e ? q = !0 : 0 > e && (t = !0),
              ...
              a.axisY.logarithmic ? (d.max = m(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)),
              d.min = m(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : q && !t ? (d.max = m(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
              d.min = m(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : q && t ? (d.max = m(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
              d.min = m(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !q && t && (d.max = m(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1),
      ...
      p.prototype._processMultiYPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, g, q, t = !1, C = 0; C < a.dataSeriesIndexes.length; C++) {
                  var k = this.data[a.dataSeriesIndexes[C]], l = 0, n = !1, r = !1, f, V, h;
                  if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
                      var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity
                        , s = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum : Infinity;
                  ...
                  for (l = 0; l < k.dataPoints.length; l++) {
                      ...
                      k.dataPoints[l].x.getTime ? (t = !0,
                      b = k.dataPoints[l].x.getTime()) : b = k.dataPoints[l].x;
                      ...
                      g < d.min && (d.min = g);
                      q > d.max && (d.max = q);
                      0 < l && (a.axisX.logarithmic ? (V = b / k.dataPoints[l - 1].x,
                      1 > V && (V = 1 / V),
                      c.minDiff > V && 1 !== V && (c.minDiff = V)) : (V = b - k.dataPoints[l - 1].x,
                      0 > V && (V *= -1),
                      c.minDiff > V && 0 !== V && (c.minDiff = V)),
                      e && (null !== e[0] && k.dataPoints[l - 1].y && null !== k.dataPoints[l - 1].y[0]) && (a.axisY.logarithmic ? (V = e[0] / k.dataPoints[l - 1].y[0],
                      1 > V && (V = 1 / V),
                      d.minDiff > V && 1 !== V && (d.minDiff = V)) : (V = e[0] - k.dataPoints[l - 1].y[0],
                      0 > V && (V *= -1),
                      d.minDiff > V && 0 !== V && (d.minDiff = V))));
                      if (!(b < m) || n) {
                          if (!n && (n = !0,
                          ...
                          null === e ? c.viewPortMin === b && f < b && (c.viewPortMin = f) : (g < d.viewPortMin && (d.viewPortMin = g),
                          q > d.viewPortMax && (d.viewPortMax = q))
                      }
                  }
      ...
      p.prototype._processSpecificPlotUnit = function(a) {
          if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, g = !1, q = 0; q < a.dataSeriesIndexes.length; q++) {
                  var t = this.data[a.dataSeriesIndexes[q]]
                    , C = 0
                    , k = !1
                    , l = !1
                    , n = b = 0;
                  ...
                  if (t.dataPoints[C].x && t.dataPoints[C].x.getTime || "dateTime" === t.xValueType)
                      g = !0;
                  for (C = 0; C < t.dataPoints.length; C++)
                      "undefined" !== typeof t.dataPoints[C].isCumulativeSum && !0 === t.dataPoints[C].isCumulativeSum ? (t.dataPointEOs[C].cumulativeSumYStartValue = 0,
                      t.dataPointEOs[C].cumulativeSum = 0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum,
                      t.dataPoints[C].y = 0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum) : "undefined" !== typeof t.dataPoints[C].isIntermediateSum && !0 === t.dataPoints[C].isIntermediateSum ? (t.dataPointEOs[C].cumulativeSumYStartValue = n,
                      t.dataPointEOs[C].cumulativeSum = 0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum,
                      t.dataPoints[C].y = 0 === C ? 0 : b,
                      n = 0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum,
                      b = 0) : (e = "number" !== typeof t.dataPoints[C].y ? 0 : t.dataPoints[C].y,
                      t.dataPointEOs[C].cumulativeSumYStartValue = 0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum,
                      t.dataPointEOs[C].cumulativeSum = 0 === C ? e : t.dataPointEOs[C - 1].cumulativeSum + e,
                      b += e);
                  for (C = 0; C < t.dataPoints.length; C++)
                      if ("undefined" === typeof t.dataPoints[C].x && (t.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0)),
                      t.dataPoints[C].x.getTime ? (g = !0,
                      b = t.dataPoints[C].x.getTime()) : b = t.dataPoints[C].x,
                      e = t.dataPoints[C].y,
                      b < c.min && (c.min = b),
                      b > c.max && (c.max = b),
                      t.dataPointEOs[C].cumulativeSum < d.min && (d.min = t.dataPointEOs[C].cumulativeSum),
                      t.dataPointEOs[C].cumulativeSum > d.max && (d.max = t.dataPointEOs[C].cumulativeSum),
                      0 < C && (a.axisX.logarithmic ? (n = b / t.dataPoints[C - 1].x,
                      1 > n && (n = 1 / n),
                      c.minDiff > n && 1 !== n && (c.minDiff = n)) : (n = b - t.dataPoints[C - 1].x,
                      0 > n && (n *= -1),
                      c.minDiff > n && 0 !== n && (c.minDiff = n)),
                      null !== e && null !== t.dataPoints[C - 1].y && (a.axisY.logarithmic ? (e = t.dataPointEOs[C].cumulativeSum / t.dataPointEOs[C - 1].cumulativeSum,
                      1 > e && (e = 1 / e),
                      d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = t.dataPointEOs[C].cumulativeSum - t.dataPointEOs[C - 1].cumulativeSum,
                      0 > e && (e *= -1),
                      ...
                      !(b < r) || k) {
                          ...
                          b < c.viewPortMin && (c.viewPortMin = b);
                          b > c.viewPortMax && (c.viewPortMax = b);
                          0 < C && (t.dataPointEOs[C - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[C - 1].cumulativeSum),
                          t.dataPointEOs[C - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = t.dataPointEOs[C - 1].cumulativeSum));
      ...
      p.prototype.calculateAutoBreaks = function() {
          ...
          function d(a) {
              if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                  ...
                  if (b || c)
                      for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, q = f.min, k = f.max, l = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, r, t = 0, C = 0; C < a.dataSeriesIndexes.length; C++) {
                          var h = e.data[a.dataSeriesIndexes[C]];
                          if (!(4 > h.dataPoints.length))
                              for (t = 0; t < h.dataPoints.length; t++)
                                  if (b && (r = (k + 1 - q) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
                                  ...
                                  c) {
                                      ...
                                      if ((g = "waterfall" === a.type ? h.dataPointEOs[t].cumulativeSum : h.dataPoints[t].y) && g.length)
                                          for (var p = 0; p < g.length; p++)
                                              r = Math.floor((g[p] - l) / u),
                                              g[p] < d[r].min && (d[r].min = g[p]),
                                              g[p] > d[r].max && (d[r].max = g[p]);
                                      else
                                          m(g) || (r = Math.floor((g - l) / u),
                                          g < d[r].min && (d[r].min = g),
                                          g > d[r].max && (d[r].max = g))
                                  }
                      }
          ...
          function c(a) {
              if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                  for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, q = 0, k = 0; k < a.dataSeriesIndexes.length; k++) {
                      ...
                      if (!(4 > l.dataPoints.length))
                          for (q = 0; q < l.dataPoints.length; q++)
                              ...
                              b = l.dataPoints[q].x.getTime ? l.dataPoints[q].x.getTime() : l.dataPoints[q].x,
                              g = Math.floor((b - c) / g),
                              b < f[g].min && (f[g].min = b),
                              b > f[g].max && (f[g].max = b)
                  }
          }
          for (var b, e = this, g = !1, q = 0; q < this._axes.length; q++)
          ...
          if (g) {
              for (q = 0; q < this.plotInfo.plotTypes.length; q++)
                  for (g = this.plotInfo.plotTypes[q],
                  t = 0; t < g.plotUnits.length; t++)
                      b = g.plotUnits[t],
              ...
              for (q = 0; q < this._axes.length; q++)
                  if (this._axes[q].dataInfo._dataRanges) {
                      ...
                      if (this._axes[q].dataInfo.dataPointYPositiveSums) {
                          ...
                          l = k;
                          for (t in r)
                              if (r.hasOwnProperty(t) && !isNaN(t) && (n = r[t],
                              !m(n))) {
                      ...
                      if (this._axes[q].dataInfo.dataPointYNegativeSums) {
                          ...
                          l = k;
                          for (t in r)
                              r.hasOwnProperty(t) && !isNaN(t) && (n = -1 * r[t],
                              m(n) || (f = Math.floor((n - C) / b),
                              n < l[f].min && (l[f].min = n),
                              n > l[f].max && (l[f].max = n)));
                      ...
                      for (t = 0; t < Math.min(g.length, this._axes[q].scaleBreaks.maxNumberOfAutoBreaks); t++)
                          b = a(g[t].start, g[t].end, this._axes[q].logarithmic ? this._axes[q].dataInfo.max / this._axes[q].dataInfo.min : this._axes[q].dataInfo.max - this._axes[q].dataInfo.min, this._axes[q].logarithmic),
                          this._axes[q].scaleBreaks.autoBreaks.push(new da(this,"autoBreaks",b,t,++this._eventManager.lastObjectId,this._axes[q].scaleBreaks)),
      ...
      p.prototype.getDataPointAtXY = function(a, d, c) {
          ...
          for (c = 0; c < b.length; c++)
              if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type)
                  if (e = oa("markerSize", b[c].dataPoint, b[c].dataSeries) || 8,
                  b[c].distance <= e / 2) {
                      d = !0;
                      break
                  }
              ...
              if (!(c && 1 < c.length)) {
                  ...
                  if (this._lastTouchData.scroll && this.zoomEnabled)
                      ...
                      for (c = 0; c < d.length; c++)
                          ...
                          !m(this._lastTouchData.scroll) && !this._lastTouchData.scroll || !this._lastTouchData.scroll && 250 < g || "click" === e)
      ...
      p.prototype._mouseEventHandler = function(a) {
          function d() {
              p.capturedEventParam && (e = p.capturedEventParam,
              q = e.bounds,
              "mouseup" === b && (p.capturedEventParam = null,
              e.chart.overlaidCanvas.releaseCapture ? e.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", e.chart._mouseEventHandler, !1)),
              e.hasOwnProperty(b) && ("mouseup" !== b || e.chart.overlaidCanvas.releaseCapture ? a.target !== e.chart.overlaidCanvas && u || e[b].call(e.context, c.x, c.y) : a.target !== e.chart.overlaidCanvas && (e.chart.isDrag = !1)))
          }
          ...
          this.interactivityEnabled) {
              ...
              if (!g) {
                      ...
                      for (g = 0; g < this._events.length; g++)
                          if (this._events[g].hasOwnProperty(b))
                              ...
                              c.x >= q.x1 && c.x <= q.x2 && c.y >= q.y1 && c.y <= q.y2) {
                                  ...
                                  "mousedown" === b && !0 === e.capture ? (p.capturedEventParam = e,
                                  this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === b && (e.chart.overlaidCanvas.releaseCapture ? e.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", this._mouseEventHandler, !1));
                                  break
                              } else
                                  e = null;
                  ...
                  if (c.x < g.x1 || c.x > g.x2 || c.y < g.y1 || c.y > g.y2) {
                      ...
                      for (g = 0; g < this.axisX.length; g++)
                          this.axisX[g].crosshair && this.axisX[g].crosshair.enabled && (this.axisX[g].crosshair.hide(),
                          this.axisX[g].crosshair.dispatchEvent("hidden", {
                              chart: this,
                              axis: this.axisX[g].options
                          }, this.axisX[g].crosshair));
                      for (g = 0; g < this.axisX2.length; g++)
                          this.axisX2[g].crosshair && this.axisX2[g].crosshair.enabled && (this.axisX2[g].crosshair.hide(),
                          this.axisX2[g].crosshair.dispatchEvent("hidden", {
                              chart: this,
                              axis: this.axisX2[g].options
                          }, this.axisX2[g].crosshair));
                      for (g = 0; g < this.axisY.length; g++)
                          this.axisY[g].crosshair && this.axisY[g].crosshair.enabled && (this.axisY[g].crosshair.hide(),
                          this.axisY[g].crosshair.dispatchEvent("hidden", {
                              chart: this,
                              axis: this.axisY[g].options
                          }, this.axisY[g].crosshair));
                      for (g = 0; g < this.axisY2.length; g++)
                          this.axisY2[g].crosshair && this.axisY2[g].crosshair.enabled && (this.axisY2[g].crosshair.hide(),
                          this.axisY2[g].crosshair.dispatchEvent("hidden", {
                              chart: this,
              ...
              if (this.panEnabled || this.zoomEnabled) {
                  if (this.panEnabled)
                      for (e = g = 0; e < this._axes.length; e++)
                          c = this._axes[e],
                          c.logarithmic ? c.viewportMinimum < c.minimum ? (g = c.minimum / c.viewportMinimum,
                          c.sessionVariables.newViewportMinimum = c.viewportMinimum * g,
                          c.sessionVariables.newViewportMaximum = c.viewportMaximum * g,
                          q = !0) : c.viewportMaximum > c.maximum && (g = c.viewportMaximum / c.maximum,
                          c.sessionVariables.newViewportMinimum = c.viewportMinimum / g,
                          c.sessionVariables.newViewportMaximum = c.viewportMaximum / g,
                          q = !0) : c.viewportMinimum < c.minimum ? (g = c.minimum - c.viewportMinimum,
                          c.sessionVariables.newViewportMinimum = c.viewportMinimum + g,
                          c.sessionVariables.newViewportMaximum = c.viewportMaximum + g,
                          q = !0) : c.viewportMaximum > c.maximum && (g = c.viewportMaximum - c.maximum,
                          c.sessionVariables.newViewportMinimum = c.viewportMinimum - g,
                      ...
                      2 < Math.abs(c - e) && 2 < Math.abs(b - g) && this._zoomPanToSelectedRegion(c, b, e, g) && (q = !0)
                  }
                  q && (this._ignoreNextEvent = !0,
                  ...
                  q && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (Ma(this._zoomButton, this._resetButton),
                  ua(this, this._zoomButton, "pan"),
                  ua(this, this._resetButton, "reset")))
              }
          }
      ...
      p.prototype._plotAreaMouseMove = function(a, d) {
          if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
              var c = 0
                ...
                , g = 0 <= this.zoomType.indexOf("y")
                , q = this;
              "xySwapped" === this.plotInfo.axisPlacement && (c = g,
              g = e,
              e = c);
              ...
              if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                  ...
                  for (var t = 0; t < this.axisX.length; t++)
                      this.axisX[t].crosshair && this.axisX[t].crosshair.enabled && (this.axisX[t].crosshair.hide(),
                      this.axisX[t].crosshair.dispatchEvent("hidden", {
                          chart: this,
                          axis: this.axisX[t].options
                      }, this.axisX[t].crosshair));
                  for (t = 0; t < this.axisX2.length; t++)
                      this.axisX2[t].crosshair && this.axisX2[t].crosshair.enabled && (this.axisX2[t].crosshair.hide(),
                      this.axisX2[t].crosshair.dispatchEvent("hidden", {
                          chart: this,
                          axis: this.axisX2[t].options
                      }, this.axisX2[t].crosshair));
                  for (t = 0; t < this.axisY.length; t++)
                      this.axisY[t].crosshair && this.axisY[t].crosshair.enabled && (this.axisY[t].crosshair.hide(),
                      this.axisY[t].crosshair.dispatchEvent("hidden", {
                          chart: this,
                          axis: this.axisY[t].options
                      }, this.axisY[t].crosshair));
                  for (t = 0; t < this.axisY2.length; t++)
                      this.axisY2[t].crosshair && this.axisY2[t].crosshair.enabled && (this.axisY2[t].crosshair.hide(),
              ...
              if ((!e || 2 < Math.abs(c) || !g || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                  if (this.panEnabled)
                      e = {
                          ...
                          y1: g ? this.plotArea.y1 + b : this.plotArea.y1,
                          x2: e ? this.plotArea.x2 + c : this.plotArea.x2,
                          y2: g ? this.plotArea.y2 + b : this.plotArea.y2
                      },
                      clearTimeout(q._panTimerId),
                      q._panTimerId = setTimeout(function(b, c, e, f) {
                          return function() {
                              q._zoomPanToSelectedRegion(b, c, e, f, !0) && (q._dispatchRangeEvent("rangeChanging", "pan"),
                              q.stockChart && (q.stockChart.navigator && q.stockChart.navigator.enabled) && (q.stockChart._rangeEventParameter.type = "rangeChanging",
                              q.stockChart.dispatchEvent("rangeChanging", q.stockChart._rangeEventParameter, q.stockChart)),
                              q.render(),
                              q._dispatchRangeEvent("rangeChanged", "pan"),
                              q.stockChart && (q.stockChart.navigator && q.stockChart.navigator.enabled) && (q.stockChart._rangeEventParameter.type = "rangeChanged",
                              q.stockChart.dispatchEvent("rangeChanged", q.stockChart._rangeEventParameter, q.stockChart)),
                      ...
                      var b = e ? this.dragStartPoint.x : this.plotArea.x1
                        , t = g ? this.dragStartPoint.y : this.plotArea.y1
                        , C = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1
                        , k = g ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1;
                      this.validateRegion(b, t, e ? a : this.plotArea.x2 - this.plotArea.x1, g ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(),
      ...
      p.prototype.validateRegion = function(a, d, c, b, e) {
          e = e || !1;
          for (var g = 0 <= this.zoomType.indexOf("x"), q = 0 <= this.zoomType.indexOf("y"), t = !1, C = [], k = [], l = [], n = 0; n < this._axes.length; n++)
              ("axisX" === this._axes[n].type && g || "axisY" === this._axes[n].type && q) && k.push(this._axes[n]);
          for (q = 0; q < k.length; q++) {
              var n = k[q]
                , g = !1
                , r = n.convertPixelToValue({
                  x: a,
                  y: d
              })
                , f = n.convertPixelToValue({
                  x: c,
                  y: b
              });
              if (r > f)
                  var h = f
                    ...
                    , r = h;
              if (n.scaleBreaks)
                  for (h = 0; !g && h < n.scaleBreaks._appliedBreaks.length; h++)
                      g = n.scaleBreaks._appliedBreaks[h].startValue <= r && n.scaleBreaks._appliedBreaks[h].endValue >= f;
              if (isFinite(n.dataInfo.minDiff))
                  if (h = n.getApparentDifference(r, f, null, !0),
                  !(g || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && h < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && h < 3 * Math.abs(n.dataInfo.minDiff)) || r < n.minimum || f > n.maximum))
                      C.push(n),
                      l.push({
                          val1: r,
                          val2: f
      ...
      p.prototype.renderIndexLabels = function(a) {
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
              var l = this._indexLabels[a], n = l.chartType.toLowerCase(), r, f, q = oa("indexLabelFontColor", l.dataPoint, l.dataSeries), h = oa("indexLabelFontSize", l.dataPoint, l.dataSeries), t = oa("indexLabelFontFamily", l.dataPoint, l.dataSeries), C = oa("indexLabelFontStyle", l.dataPoint, l.dataSeries), k = oa("indexLabelFontWeight", l.dataPoint, l.dataSeries), J = oa("indexLabelBackgroundColor", l.dataPoint, l.dataSeries);
              r = oa("indexLabelMaxWidth", l.dataPoint, l.dataSeries);
              f = oa("indexLabelWrap", l.dataPoint, l.dataSeries);
              var x = oa("indexLabelLineDashType", l.dataPoint, l.dataSeries)
                , s = oa("indexLabelLineColor", l.dataPoint, l.dataSeries)
                , y = m(l.dataPoint.indexLabelLineThickness) ? m(l.dataSeries.options.indexLabelLineThickness) ? 0 : l.dataSeries.options.indexLabelLineThickness : l.dataPoint.indexLabelLineThickness
              ...
              var A = l.dataPoint.indexLabelFormatter ? l.dataPoint.indexLabelFormatter(p) : l.dataPoint.indexLabel ? this.replaceKeywordsWithValue(l.dataPoint.indexLabel, l.dataPoint, l.dataSeries, null, l.indexKeyword) : l.dataSeries.indexLabelFormatter ? l.dataSeries.indexLabelFormatter(p) : l.dataSeries.indexLabel ? this.replaceKeywordsWithValue(l.dataSeries.indexLabel, l.dataPoint, l.dataSeries, null, l.indexKeyword) : null;
              if (null !== A && "" !== A) {
                  var v = oa("indexLabelPlacement", l.dataPoint, l.dataSeries)
                    , p = oa("indexLabelOrientation", l.dataPoint, l.dataSeries)
                    , B = oa("indexLabelTextAlign", l.dataPoint, l.dataSeries)
                    , w = l.direction
                    , e = l.dataSeries.axisX
                    , g = l.dataSeries.axisY
                    , z = !1
                    , J = new la(d,{
                      x: 0,
                      y: 0,
                  ...
                  if ("stackedarea100" === n) {
                      ...
                      continue;
                  q = t = 2;
                  "horizontal" === p ? (C = J.width,
                  k = J.height) : (k = J.width,
                  C = J.height);
                  if ("normal" === this.plotInfo.axisPlacement) {
                      if (0 <= n.indexOf("line") || 0 <= n.indexOf("area"))
                          ...
                          v = "inside";
                      r = l.point.x - ("horizontal" === p ? C / 2 : C / 2 - h / 2);
                      "inside" !== v ? (e = c.y1,
                      g = c.y2,
                      0 < w ? (f = l.point.y + ("horizontal" === p ? h / 2 : 0) - k - t - b,
                      f < e && (f = "auto" === v ? Math.max(l.point.y, e) + h / 2 + t : e + h / 2 + t,
                      z = f + k > l.point.y)) : (f = l.point.y + h / 2 + t + b,
                      f > g - k && (f = "auto" === v ? Math.min(l.point.y, g) + h / 2 - k - t : g + h / 2 - k,
                      z = f < l.point.y))) : (e = Math.max(l.bounds.y1, c.y1),
                      g = Math.min(l.bounds.y2, c.y2 - k + h / 2),
                      b = 0 <= n.indexOf("range") || "error" === n ? 0 < w ? Math.max(l.bounds.y1, c.y1) + h / 2 + t : Math.min(l.bounds.y2, c.y2) + h / 2 - k + t : (Math.max(l.bounds.y1, c.y1) + Math.min(l.bounds.y2, c.y2)) / 2 - k / 2 + h / 2 + ("horizontal" === p ? t : 0),
                      0 < w ? (f = Math.max(l.point.y, b),
                      f < e && ("bubble" === n || "scatter" === n) && (f = Math.max(l.point.y - k - t, c.y1 + t))) : (f = Math.min(l.point.y, b),
                      f > g - k - t && ("bubble" === n || "scatter" === n) && (f = Math.min(l.point.y + t, c.y2 - k - t))),
                      f = Math.min(f, g))
                  } else
                      0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (v = "auto",
                      q = 4) : 0 <= n.indexOf("stacked") ? "auto" === v && (v = "inside") : "bubble" === n && (v = "inside"),
                      f = l.point.y + h / 2 - k / 2 + t,
                      "inside" !== v ? (e = c.x1,
                      g = c.x2,
                      0 > w ? (r = l.point.x - ("horizontal" === p ? C : C - h / 2) - q - b,
                      r < e && (r = "auto" === v ? Math.max(l.point.x, e) + q : e + q,
                      z = r + C > l.point.x)) : (r = l.point.x + ("horizontal" === p ? 0 : h / 2) + q + b,
                      r > g - C - q - b && (r = "auto" === v ? Math.min(l.point.x, g) - ("horizontal" === p ? C : C / 2) - q : g - C - q,
                      z = r < l.point.x))) : (e = Math.max(l.bounds.x1, c.x1),
                      Math.min(l.bounds.x2, c.x2),
                      b = 0 <= n.indexOf("range") || "error" === n ? 0 > w ? Math.max(l.bounds.x1, c.x1) + h / 2 + q : Math.min(l.bounds.x2, c.x2) - C / 2 - q + ("horizontal" === p ? 0 : h / 2) : (Math.max(l.bounds.x1, c.x1) + Math.min(l.bounds.x2, c.x2)) / 2 + ("horizontal" === p ? 0 : h / 2),
                      r = 0 > w ? Math.max(l.point.x, b) - ("horizontal" === p ? C / 2 : 0) : Math.min(l.point.x, b) - C / 2,
                      r = Math.max(r, e));
                  "vertical" === p && (f += k - h / 2);
                  J.x = r;
                  J.y = f;
                  J.render(!0);
                  y && ("inside" !== v && (0 > n.indexOf("bar") && ("error" !== n || !l.axisSwapped) && l.point.x > c.x1 && l.point.x < c.x2 || !z) && (0 > n.indexOf("column") && ("error" !== n || l.axisSwapped) && l.point.y > c.y1 && l.point.y < c.y2 || !z)) && (d.lineWidth = y,
                  d.strokeStyle = s ? s : "gray",
                  d.setLineDash && d.setLineDash(I(x, y)),
                  d.beginPath(),
                  d.moveTo(l.point.x, l.point.y),
                  0 <= n.indexOf("bar") || "error" === n && l.axisSwapped ? d.lineTo(r + (0 < l.direction ? -q : C + q) + ("vertical" === p ? -h / 2 : 0), f + ("vertical" === p ? -k / 2 : k / 2 - h / 2) - t) : 0 <= n.indexOf("column") || "error" === n && !l.axisSwapped ? d.lineTo(r + C / 2 - ("horizontal" === p ? 0 : h / 2), f + ("vertical" === p ? (f - k < l.point.y ? 0 : -k) + t : (f - h / 2 < l.point.y ? k : 0) - h / 2)) : 0 <= n.indexOf("waterfall") ? d.lineTo(r + C / 2 - ("horizontal" === p ? 0 : h / 2), "vertical" === p ? 0 < w && f < l.point.y ? f : 0 > w && f - k > l.point.y ? f - k : l.point.y : 0 < w && f + k - h / 2 < l.point.y ? f + k - h / 2 : 0 > w && f - h / 2 > l.point.y ? f - h / 2 - 2 : l.point.y) : d.lineTo(r + C / 2 - ("horizontal" === p ? 0 : h / 2), f + ("vertical" === p ? f - k < l.point.y ? 0 : -k : (f + k < l.point.y ? k : 0) - h / 2)),
                  d.stroke())
              }
          }
          d = {
          ...
          for (a = 0; a < this._indexLabels.length; a++)
              ...
              l.dataSeries.indexLabelBackgroundColor = m(J) ? u ? "transparent" : null : J;
          return d
      }
      ;
      p.prototype.renderLine = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var g = [], q, t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  var h = k._colorSet
                    , m = h = k.lineColor = k.options.lineColor ? k.options.lineColor : h[0];
                  c.strokeStyle = h;
                  var x = !0, s = 0, p, v;
                  c.beginPath();
                  if (0 < l.length) {
                      for (var H = !1, s = 0; s < l.length; s++)
                          if (p = l[s].x.getTime ? l[s].x.getTime() : l[s].x,
                          !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !H)))
                              if ("number" !== typeof l[s].y)
                                  0 < s && !(k.connectNullData || H || x) && (c.stroke(),
                                  u && b.stroke()),
                                  H = !0;
                              else {
                                  ...
                                  x || H ? (!x && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(),
                                  c.beginPath(),
                                  c.moveTo(q.x, q.y),
                                  n = k.nullDataLineDashType,
                                  c.setLineDash(r)),
                                  c.lineTo(p, v),
                                  u && b.lineTo(p, v)) : (c.beginPath(),
                                  c.moveTo(p, v),
                                  u && (b.beginPath(),
                                  b.moveTo(p, v))),
                                  H = x = !1) : (c.lineTo(p, v),
                                  ...
                                  s < l.length - 1 && (m !== (l[s].lineColor || h) || n !== (l[s].lineDashType || k.lineDashType)) && (c.stroke(),
                                  c.beginPath(),
                                  c.moveTo(p, v),
                                  m = l[s].lineColor || h,
                                  c.strokeStyle = m,
                                  c.setLineDash && (l[s].lineDashType ? (n = l[s].lineDashType,
                                  c.setLineDash(I(n, k.lineThickness))) : (n = k.lineDashType,
                                  c.setLineDash(f))));
                                  if (0 !== l[s].markerSize && (0 < l[s].markerSize || 0 < k.markerSize)) {
                                      var B = k.getMarkerProperties(s, p, v, c);
                                      g.push(B);
                                      A = Z(A);
                                      u && g.push({
                                          x: p,
              ...
              X.drawMarkers(g);
              u && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
      ...
      p.prototype.renderStepLine = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var g = [], q, t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  if (0 < l.length) {
                      for (var H = !1, s = 0; s < l.length; s++)
                          if (y = l[s].getTime ? l[s].x.getTime() : l[s].x,
                          !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !H)))
                              if ("number" !== typeof l[s].y)
                                  0 < s && !(k.connectNullData || H || p) && (c.stroke(),
                                  u && b.stroke()),
                                  H = !0;
                              else {
                                  var A = v;
                                  ...
                                  p || H ? (!p && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(),
                                  c.beginPath(),
                                  c.moveTo(q.x, q.y),
                                  n = k.nullDataLineDashType,
                                  c.setLineDash(r)),
                                  ...
                                  c.setLineDash(I(n, k.lineThickness))) : (n = k.lineDashType,
                                  c.setLineDash(f))));
                                  0 !== l[s].markerSize && (0 < l[s].markerSize || 0 < k.markerSize) && (A = k.getMarkerProperties(s, y, v, c),
                                  g.push(A),
                                  B = Z(B),
                                  u && g.push({
                                      x: y,
      ...
      p.prototype.renderSpline = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var q = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  var m = k._colorSet
                    , p = m = k.lineColor = k.options.lineColor ? k.options.lineColor : m[0];
                  b.strokeStyle = m;
                  var x = 0, s, y, v = [];
                  b.beginPath();
                  if (0 < l.length)
                      for (y = !1,
                      x = 0; x < l.length; x++)
                          if (s = l[x].getTime ? l[x].x.getTime() : l[x].x,
                          !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                              if ("number" !== typeof l[x].y)
                                  0 < x && !y && (k.connectNullData ? b.setLineDash && (0 < v.length && (k.options.nullDataLineDashType || !l[x - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = r,
                                  n = k.nullDataLineDashType) : (d(v),
                                  v = [])),
                                  y = !0;
                              else {
                                  ...
                                  x < l.length - 1 && (p !== (l[x].lineColor || m) || n !== (l[x].lineDashType || k.lineDashType)) && (p = l[x].lineColor || m,
                                  v[v.length - 1].newStrokeStyle = p,
                                  b.setLineDash && (l[x].lineDashType ? (n = l[x].lineDashType,
                                  v[v.length - 1].newLineDashArray = I(n, k.lineThickness)) : (n = k.lineDashType,
              ...
              X.drawMarkers(q);
              u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                  var r = a.dataSeriesIndexes[l]
                    ...
                    , m = f.dataPoints;
                  if (0 < m.length)
                      for (var p = 5 < n && f.bevelEnabled ? !0 : !1, g = 0; g < m.length; g++)
                          if (m[g].getTime ? h = m[g].x.getTime() : h = m[g].x,
                          !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[g].y) {
                              q = a.axisX.convertValueToPixel(h);
                              t = a.axisY.convertValueToPixel(m[g].y);
                              ...
                              t = s,
                              s = b);
                              b = m[g].color ? m[g].color : f._colorSet[g % f._colorSet.length];
                              ba(c, a.axisX.reversed ? x : q, t, a.axisX.reversed ? q : x, s, b, 0, null, p && (a.axisY.reversed ? 0 > m[g].y : 0 <= m[g].y), (a.axisY.reversed ? 0 <= m[g].y : 0 > m[g].y) && p, !1, !1, f.fillOpacity);
                              b = f.dataPointIds[g];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = Z(b);
                              u && ba(this._eventManager.ghostCtx, a.axisX.reversed ? x : q, t, a.axisX.reversed ? q : x, s, b, 0, null, !1, !1, !1, !1);
                              (m[g].indexLabel || f.indexLabel || m[g].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: "column",
                                  dataPoint: m[g],
                                  dataSeries: f,
                                  point: {
                                      x: q + (x - q) / 2,
                                      y: 0 > m[g].y === a.axisY.reversed ? t : s
                                  },
                                  direction: 0 > m[g].y === a.axisY.reversed ? 1 : -1,
                                  bounds: {
                                      x1: q,
                                      y1: Math.min(t, s),
                                      x2: x,
      ...
      p.prototype.renderStackedColumn = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              m = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                  ...
                  if (0 < s.length) {
                      ...
                      for (k = 0; k < s.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                              ...
                              ba(c, l, a.axisY.reversed ? H : n, v, a.axisY.reversed ? n : H, b, 0, null, y && (a.axisY.reversed ? 0 > s[k].y : 0 <= s[k].y), (a.axisY.reversed ? 0 <= s[k].y : 0 > s[k].y) && y, !1, !1, x.fillOpacity);
                              b = x.dataPointIds[k];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = Z(b);
                              u && ba(this._eventManager.ghostCtx, l, n, v, H, b, 0, null, !1, !1, !1, !1);
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                  var p = a.dataSeriesIndexes[f]
                    ...
                    , s = x.dataPoints;
                  if (0 < s.length)
                      for (var y = 5 < m && x.bevelEnabled ? !0 : !1, k = 0; k < s.length; k++)
                          if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x,
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                              l = a.axisX.convertValueToPixel(b);
                              ...
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y) {
                                  ...
                                  h[b] = n + ("undefined" !== typeof h[b] ? h[b] : 0),
                                  H = a.axisY.convertValueToPixel(h[b]),
                                  n = q[b] ? q[b] : r,
                                  q[b] = H;
                              else if (n = a.axisY.convertValueToPixel(n),
                              0 <= s[k].y) {
                                  var A = "undefined" !== typeof g[b] ? g[b] : 0;
                                  n -= A;
                                  H = r - A;
                                  ...
                                  A = "undefined" !== typeof q[b] ? q[b] : 0,
                                  H = n + A,
                                  n = r + A,
                                  a.dataSeriesIndexes.length - 1 === f && 1 >= Math.abs(e.y2 - H) && (H = e.y2),
                                  q[b] = A + (H - n);
                              b = s[k].color ? s[k].color : x._colorSet[k % x._colorSet.length];
                              ba(c, l, a.axisY.reversed ? H : n, v, a.axisY.reversed ? n : H, b, 0, null, y && (a.axisY.reversed ? 0 > s[k].y : 0 <= s[k].y), (a.axisY.reversed ? 0 <= s[k].y : 0 > s[k].y) && y, !1, !1, x.fillOpacity);
                              b = x.dataPointIds[k];
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                  var r = a.dataSeriesIndexes[l]
                    ...
                    , m = f.dataPoints;
                  if (0 < m.length) {
                      var p = 5 < n && f.bevelEnabled ? !0 : !1;
                      c.strokeStyle = "#4572A7 ";
                      for (g = 0; g < m.length; g++)
                          if (m[g].getTime ? h = m[g].x.getTime() : h = m[g].x,
                          !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[g].y) {
                              t = a.axisX.convertValueToPixel(h);
                              q = a.axisY.convertValueToPixel(m[g].y);
                              ...
                              q = k);
                              b = m[g].color ? m[g].color : f._colorSet[g % f._colorSet.length];
                              ba(c, a.axisY.reversed ? q : s, a.axisX.reversed ? x : t, a.axisY.reversed ? s : q, a.axisX.reversed ? t : x, b, 0, null, p, !1, !1, !1, f.fillOpacity);
                              b = f.dataPointIds[g];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = Z(b);
                              u && ba(this._eventManager.ghostCtx, s, a.axisX.reversed ? x : t, q, a.axisX.reversed ? t : x, b, 0, null, !1, !1, !1, !1);
                              (m[g].indexLabel || f.indexLabel || m[g].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: "bar",
                                  dataPoint: m[g],
                                  dataSeries: f,
                  ...
                  if (0 < s.length) {
                      ...
                      for (k = 0; k < s.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                              ...
                              n = n - a.plotType.plotUnits.length * m / 2 + a.index * m << 0;
                              var v = n + m << 0, H;
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y)
                                  t[b] = s[k].y + (t[b] ? t[b] : 0),
                                  0 < t[b] && (H = g[b] ? g[b] : r,
                                  ...
                                  h[b] = s[k].y + (h[b] ? h[b] : 0),
                                  l = q[b] ? q[b] : r,
                                  q[b] = H = a.axisY.convertValueToPixel(h[b]);
                              else if (l = a.axisY.convertValueToPixel(s[k].y),
                              0 <= s[k].y) {
                                  var A = g[b] ? g[b] : 0;
                                  H = r + A;
                                  l += A;
                                  ...
                                  q[b] = A + (l - H);
                              b = s[k].color ? s[k].color : x._colorSet[k % x._colorSet.length];
                              ba(c, a.axisY.reversed ? l : H, n, a.axisY.reversed ? H : l, v, b, 0, null, y, !1, !1, !1, x.fillOpacity);
                              b = x.dataPointIds[k];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = Z(b);
                              u && ba(this._eventManager.ghostCtx, H, n, l, v, b, 0, null, !1, !1, !1, !1);
                              (s[k].indexLabel || x.indexLabel || s[k].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
                      ...
                      for (k = 0; k < s.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                              ...
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y) {
                                  ...
                                  h[b] = v + (h[b] ? h[b] : 0),
                                  l = q[b] ? q[b] : r,
                                  q[b] = v = a.axisY.convertValueToPixel(h[b]);
                              else if (l = a.axisY.convertValueToPixel(v),
                              0 <= s[k].y) {
                                  var A = g[b] ? g[b] : 0;
                                  v = r + A;
                                  l += A;
                                  ...
                                  v = l - A,
                                  l = r - A,
                                  a.dataSeriesIndexes.length - 1 === f && 1 >= Math.abs(e.x1 - v) && (v = e.x1),
                                  q[b] = A + (l - v);
                              b = s[k].color ? s[k].color : x._colorSet[k % x._colorSet.length];
                              ba(c, a.axisY.reversed ? l : v, n, a.axisY.reversed ? v : l, H, b, 0, null, y, !1, !1, !1, x.fillOpacity);
                              b = x.dataPointIds[k];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = Z(b);
                              u && ba(this._eventManager.ghostCtx, v, n, l, H, b, 0, null, !1, !1, !1, !1);
                              (s[k].indexLabel || x.indexLabel || s[k].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
      ...
      p.prototype.renderArea = function(a) {
          ...
          function b() {
              ...
              a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? H = v : 0 > a.axisY.viewportMaximum ? H = t.y1 : 0 < a.axisY.viewportMinimum && (H = v),
              g.lineTo(x, H),
              g.lineTo(A.x, H),
              g.closePath(),
              g.globalAlpha = f.fillOpacity,
              g.fill(),
              g.globalAlpha = 1,
              u && (q.lineTo(x, H),
              q.lineTo(A.x, H),
          ...
          var e = a.targetCanvasCtx || this.plotArea.ctx
            , g = u ? this._preRenderCtx : e;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var q = this._eventManager.ghostCtx, t = a.axisY.lineCoordinates, h = [], k = this.plotArea, l;
              g.save();
              u && q.save();
              g.beginPath();
              ...
              g.clip();
              u && (q.beginPath(),
              q.rect(k.x1, k.y1, k.width, k.height),
              q.clip());
              for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                  ...
                  h = [];
                  d = !0;
                  var p = 0, x, s, y, v = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), H, A = null;
                  if (0 < m.length) {
                      var B = f._colorSet[p % f._colorSet.length]
                        , w = f.lineColor = f.options.lineColor || B
                        , z = w;
                      g.fillStyle = B;
                      g.strokeStyle = w;
                      ...
                      for (var ha = !0; p < m.length; p++)
                          if (y = m[p].x.getTime ? m[p].x.getTime() : m[p].x,
                          !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!f.connectNullData || !ha)))
                              if ("number" !== typeof m[p].y)
                                  f.connectNullData || (ha || d) || b(),
                                  ha = !0;
                              else {
                                  x = a.axisX.convertValueToPixel(y);
                                  s = a.axisY.convertValueToPixel(m[p].y);
                                  d || ha ? (!d && f.connectNullData ? (g.setLineDash && (f.options.nullDataLineDashType || c === f.lineDashType && f.lineDashType !== f.nullDataLineDashType) && (d = x,
                                  c = s,
                                  x = l.x,
                                  s = l.y,
                                  b(),
                                  ...
                                  p < m.length - 1 && (z !== (m[p].lineColor || w) || c !== (m[p].lineDashType || f.lineDashType)) && (b(),
                                  z = m[p].lineColor || w,
                                  g.strokeStyle = z,
                                  g.setLineDash && (m[p].lineDashType ? (c = m[p].lineDashType,
                                  g.setLineDash(I(c, f.lineThickness))) : (c = f.lineDashType,
                                  g.setLineDash(T))));
                                  var ca = f.dataPointIds[p];
                                  ...
                                  0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < f.markerSize) && (y = f.getMarkerProperties(p, x, s, g),
                                  h.push(y),
                                  ca = Z(ca),
                                  u && h.push({
                                      x: x,
                                  ...
                                  (m[p].indexLabel || f.indexLabel || m[p].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({
                                      chartType: "area",
                                      dataPoint: m[p],
                                      dataSeries: f,
                                      point: {
              ...
              this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
              g.clearRect(k.x1, k.y1, k.width, k.height),
              this._eventManager.ghostCtx.restore());
              g.restore();
              return {
                  source: e,
      ...
      p.prototype.renderSplineArea = function(a) {
          function d() {
              ...
              if (0 < c.length) {
                  ...
                  for (d = 0; d < c.length - 3; d += 3)
                      ...
                      u && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y);
                  a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? x = p : 0 > a.axisY.viewportMaximum ? x = g.y1 : 0 < a.axisY.viewportMinimum && (x = p);
                  s = {
                      x: c[0].x,
                      y: c[0].y
                  };
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                  ...
                  q = Z(q);
                  e.fillStyle = q;
                  var q = [], r = 0, f, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), x, s = null, y = [];
                  if (0 < n.length) {
                      var v = l._colorSet[r % l._colorSet.length]
                        , H = l.lineColor = l.options.lineColor || v
                        , A = H;
                      b.fillStyle = v;
                      b.strokeStyle = H;
                      ...
                      if (b.setLineDash) {
                          var z = I(l.nullDataLineDashType, l.lineThickness)
                            , B = l.lineDashType
                            , D = I(B, l.lineThickness);
                          b.setLineDash(D)
                      }
                      for (m = !1; r < n.length; r++)
                          if (f = n[r].x.getTime ? n[r].x.getTime() : n[r].x,
                          !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !m)))
                              if ("number" !== typeof n[r].y)
                                  0 < r && !m && (l.connectNullData ? b.setLineDash && (0 < y.length && (l.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = z,
                                  B = l.nullDataLineDashType) : (d(),
                                  y = [])),
                                  m = !0;
                              else {
                                  ...
                                  r < n.length - 1 && (A !== (n[r].lineColor || H) || B !== (n[r].lineDashType || l.lineDashType)) && (A = n[r].lineColor || H,
                                  y[y.length - 1].newStrokeStyle = A,
                                  b.setLineDash && (n[r].lineDashType ? (B = n[r].lineDashType,
                                  y[y.length - 1].newLineDashArray = I(B, l.lineThickness)) : (B = l.lineDashType,
                                  y[y.length - 1].newLineDashArray = D)));
                                  if (0 !== n[r].markerSize && (0 < n[r].markerSize || 0 < l.markerSize)) {
                                      var T = l.getMarkerProperties(r, f, m, b);
                                      q.push(T);
                                      L = Z(L);
                                      u && q.push({
                                          x: f,
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                  ...
                  if (0 < m.length) {
                      ...
                      var L = "solid";
                      if (g.setLineDash) {
                          var T = I(f.nullDataLineDashType, f.lineThickness)
                            , L = f.lineDashType
                            , D = I(L, f.lineThickness);
                          g.setLineDash(D)
                      }
                      for (; p < m.length; p++)
                          if (y = m[p].x.getTime ? m[p].x.getTime() : m[p].x,
                          !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!f.connectNullData || !c))) {
                              var ca = s;
                              "number" !== typeof m[p].y ? (f.connectNullData || (c || d) || b(),
                              c = !0) : (x = a.axisX.convertValueToPixel(y),
                              s = a.axisY.convertValueToPixel(m[p].y),
                              d || c ? (!d && f.connectNullData ? (g.setLineDash && (f.options.nullDataLineDashType || L === f.lineDashType && f.lineDashType !== f.nullDataLineDashType) && (d = x,
                              c = s,
                              x = l.x,
                              s = l.y,
                              b(),
                              ...
                              s = c,
                              A = l,
                              L = f.nullDataLineDashType,
                              g.setLineDash(T)),
                              g.lineTo(x, ca),
                              g.lineTo(x, s),
                              u && (q.lineTo(x, ca),
                              q.lineTo(x, s))) : (g.beginPath(),
                              g.moveTo(x, s),
                              u && (q.beginPath(),
                              q.moveTo(x, s)),
                              A = {
                              ...
                              p < m.length - 1 && (z !== (m[p].lineColor || w) || L !== (m[p].lineDashType || f.lineDashType)) && (b(),
                              z = m[p].lineColor || w,
                              g.strokeStyle = z,
                              g.setLineDash && (m[p].lineDashType ? (L = m[p].lineDashType,
                              g.setLineDash(I(L, f.lineThickness))) : (L = f.lineDashType,
                              g.setLineDash(D)))),
                              y = f.dataPointIds[p],
                              ...
                              0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < f.markerSize) && (ca = f.getMarkerProperties(p, x, s, g),
                              h.push(ca),
                              y = Z(y),
                              u && h.push({
                                  x: x,
      ...
      p.prototype.renderStackedArea = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx
            , b = u ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, g = null, q = [], t = this.plotArea, h = [], k = [], l = [], n = [], r = 0, f, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), x = this._eventManager.ghostCtx, s, y, v;
              u && x.beginPath();
              b.save();
              u && x.save();
              b.beginPath();
              ...
              b.clip();
              u && (x.beginPath(),
              x.rect(t.x1, t.y1, t.width, t.height),
              x.clip());
              for (var e = [], H = 0; H < a.dataSeriesIndexes.length; H++) {
                  var A = a.dataSeriesIndexes[H]
                    , B = this.data[A]
                    , w = B.dataPoints;
                  B.dataPointIndexes = [];
                  for (r = 0; r < w.length; r++)
                      A = w[r].x.getTime ? w[r].x.getTime() : w[r].x,
                      B.dataPointIndexes[A] = r,
                      e[A] || (l.push(A),
                      e[A] = !0);
                  l.sort(Ra)
              }
              for (H = 0; H < a.dataSeriesIndexes.length; H++) {
                  ...
                  if (0 < l.length) {
                      var e = B._colorSet[0]
                        , z = B.lineColor = B.options.lineColor || e
                        , L = z;
                      b.fillStyle = e;
                      b.strokeStyle = z;
                      ...
                      if (b.setLineDash) {
                          ...
                          v = B.lineDashType;
                          var D = I(v, B.lineThickness);
                          b.setLineDash(D)
                      }
                      for (var ca = !0, r = 0; r < l.length; r++) {
                          var g = l[r]
                            , ia = null
                            , ia = 0 <= B.dataPointIndexes[g] ? w[B.dataPointIndexes[g]] : {
                              x: g,
                              y: null
                          };
                          if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !ca)))
                              if ("number" !== typeof ia.y)
                                  B.connectNullData || (ca || y) || d(),
                                  ca = !0;
                              else {
                                  ...
                                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                      ...
                                      if (0 >= n[g] && a.axisY.logarithmic)
                                          continue;
                                      m = a.axisY.convertValueToPixel(n[g])
                                  } else
                                      m = a.axisY.convertValueToPixel(ia.y),
                                      m -= pa;
                                  k.push({
                                      x: f,
                                      y: p - pa
                                  ...
                                  h[g] = p - m;
                                  y || ca ? (!y && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || v === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (y = k.pop(),
                                  v = k[k.length - 1],
                                  d(),
                                  b.moveTo(s.x, s.y),
                                  k.push(v),
                                  k.push(y),
                                  v = B.nullDataLineDashType,
                                  b.setLineDash(T)),
                                  b.lineTo(f, m),
                                  u && x.lineTo(f, m)) : (b.beginPath(),
                                  b.moveTo(f, m),
                                  u && (x.beginPath(),
                                  x.moveTo(f, m))),
                                  ca = y = !1) : (b.lineTo(f, m),
                                  ...
                                  r < w.length - 1 && (L !== (w[r].lineColor || z) || v !== (w[r].lineDashType || B.lineDashType)) && (d(),
                                  b.beginPath(),
                                  b.moveTo(f, m),
                                  k.push({
                                      x: f,
                                  ...
                                  L = w[r].lineColor || z,
                                  b.strokeStyle = L,
                                  b.setLineDash && (w[r].lineDashType ? (v = w[r].lineDashType,
                                  b.setLineDash(I(v, B.lineThickness))) : (v = B.lineDashType,
                                  b.setLineDash(D))));
                                  ...
                                  0 <= B.dataPointIndexes[g] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < B.markerSize) && (pa = B.getMarkerProperties(B.dataPointIndexes[g], f, m, b),
                                  q.push(pa),
                                  g = Z(ma),
                                  u && q.push({
                                      x: f,
                                  ...
                                  (ia.indexLabel || B.indexLabel || ia.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({
                                      ...
                                      direction: 0 > w[r].y === a.axisY.reversed ? 1 : -1,
                                      color: e
                                  })
                              }
                      }
      ...
      p.prototype.renderStackedArea100 = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx
            , b = u ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, g = null, q = this.plotArea, t = [], h = [], k = [], l = [], n = [], r = 0, f, m, p, x, s, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v = this._eventManager.ghostCtx;
              b.save();
              u && v.save();
              b.beginPath();
              ...
              b.clip();
              u && (v.beginPath(),
              v.rect(q.x1, q.y1, q.width, q.height),
              v.clip());
              for (var e = [], H = 0; H < a.dataSeriesIndexes.length; H++) {
                  var A = a.dataSeriesIndexes[H]
                    , B = this.data[A]
              ...
              for (H = 0; H < a.dataSeriesIndexes.length; H++) {
                  ...
                  k = [];
                  if (0 < l.length) {
                      var e = B._colorSet[r % B._colorSet.length]
                        , z = B.lineColor = B.options.lineColor || e
                        , L = z;
                      b.fillStyle = e;
                      b.strokeStyle = z;
                          ...
                          if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !ca)))
                              if ("number" !== typeof ia.y)
                                  ...
                                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                      ...
                                      m = a.axisY.convertValueToPixel(pa),
                                      m -= ma;
                                  k.push({
                                      x: f,
                                      y: y - ma
                                  ...
                                  h[g] = y - m;
                                  x || ca ? (!x && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || s === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (x = k.pop(),
                                  s = k[k.length - 1],
                                  d(),
                                  b.moveTo(p.x, p.y),
                                  k.push(s),
                                  k.push(x),
                                  s = B.nullDataLineDashType,
                                  b.setLineDash(T)),
                                  b.lineTo(f, m),
                                  u && v.lineTo(f, m)) : (b.beginPath(),
                                  b.moveTo(f, m),
                                  u && (v.beginPath(),
                                  v.moveTo(f, m))),
                                  ca = x = !1) : (b.lineTo(f, m),
                                  ...
                                  r < w.length - 1 && (L !== (w[r].lineColor || z) || s !== (w[r].lineDashType || B.lineDashType)) && (d(),
                                  b.beginPath(),
                                  b.moveTo(f, m),
                                  k.push({
                                      x: f,
                                  ...
                                  L = w[r].lineColor || z,
                                  b.strokeStyle = L,
                                  b.setLineDash && (w[r].lineDashType ? (s = w[r].lineDashType,
                                  b.setLineDash(I(s, B.lineThickness))) : (s = B.lineDashType,
                                  b.setLineDash(D))));
                                  if (0 <= B.dataPointIndexes[g]) {
                                  ...
                                  0 <= B.dataPointIndexes[g] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < B.markerSize) && (ma = B.getMarkerProperties(r, f, m, b),
                                  t.push(ma),
                                  g = Z(F),
                                  u && t.push({
                                      x: f,
      ...
      p.prototype.renderBubble = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              this._eventManager.ghostCtx.clip());
              for (var t = -Infinity, m = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                  for (var l = a.dataSeriesIndexes[k], n = this.data[l], r = n.dataPoints, f = 0, e = 0; e < r.length; e++)
                      g = r[e].getTime ? g = r[e].x.getTime() : g = r[e].x,
                      g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax || "undefined" === typeof r[e].z || (f = r[e].z,
                      f > t && (t = f),
                      f < m && (m = f));
              for (var h = 25 * Math.PI, p = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, h), k = 0; k < a.dataSeriesIndexes.length; k++)
                  if (l = a.dataSeriesIndexes[k],
                  n = this.data[l],
                  r = n.dataPoints,
                  0 < r.length)
                      for (c.strokeStyle = "#4572A7 ",
                      e = 0; e < r.length; e++)
                          if (g = r[e].getTime ? g = r[e].x.getTime() : g = r[e].x,
                          !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y) {
                              g = a.axisX.convertValueToPixel(g);
                              q = a.axisY.convertValueToPixel(r[e].y);
                              var f = r[e].z
                                , x = 2 * Math.max(Math.sqrt((t === m ? p / 2 : h + (p - h) / (t - m) * (f - m)) / Math.PI) << 0, 1)
                                , f = n.getMarkerProperties(e, c);
                              f.size = x;
                              ...
                              (r[e].indexLabel || n.indexLabel || r[e].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: "bubble",
                                  dataPoint: r[e],
                                  dataSeries: n,
                                  point: {
              ...
              for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  if (0 < l.length) {
                      ...
                      for (var n = 0, r = 0, e = 0; e < l.length; e++)
                          if (g = l[e].getTime ? g = l[e].x.getTime() : g = l[e].x,
                          !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
                              g = a.axisX.convertValueToPixel(g);
                              ...
                              c.globalAlpha = 1;
                              Math.sqrt((n - g) * (n - g) + (r - q) * (r - q)) < Math.min(f.size, 5) && l.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = k.dataPointIds[e],
                              ...
                              n = Z(n),
                              u && X.drawMarker(f.x, f.y, this._eventManager.ghostCtx, f.type, f.size, n, n, f.borderThickness),
                              (l[e].indexLabel || k.indexLabel || l[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: "scatter",
                                  dataPoint: l[e],
                                  dataSeries: k,
                                  point: {
      ...
      p.prototype.renderCandlestick = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, g = null, q = this.plotArea, t = 0, h, k, l, n, r, f, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, p = a.axisX.dataInfo.minDiff;
              isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
              p = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * q.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) << 0;
              ...
              for (var J = 0; J < a.dataSeriesIndexes.length; J++) {
                  var x = a.dataSeriesIndexes[J]
                    , s = this.data[x]
                    , y = s.dataPoints;
                  if (0 < y.length)
                      for (var v = 5 < p && s.bevelEnabled ? !0 : !1, t = 0; t < y.length; t++)
                          if (y[t].getTime ? f = y[t].x.getTime() : f = y[t].x,
                          !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !m(y[t].y) && y[t].y.length && "number" === typeof y[t].y[0] && "number" === typeof y[t].y[1] && "number" === typeof y[t].y[2] && "number" === typeof y[t].y[3]) {
                              ...
                              var w = h - p / 2 << 0
                                ...
                                , e = y[t].color ? y[t].color : s._colorSet[0]
                                , B = Math.round(Math.max(1, 0.15 * p))
                                , z = 0 === B % 2 ? 0 : 0.5
                                , D = s.dataPointIds[t];
                              ...
                              "candlestick" === s.type ? (c.moveTo(h - z, l),
                              c.lineTo(h - z, Math.min(k, r)),
                              c.stroke(),
                              c.moveTo(h - z, Math.max(k, r)),
                              c.lineTo(h - z, n),
                              c.stroke(),
                              ba(c, w, Math.min(k, r), A, Math.max(k, r), y[t].y[0] <= y[t].y[3] ? s.risingColor : g, B, e, v, v, !1, !1, s.fillOpacity),
                              u && (e = Z(D),
                              b.strokeStyle = e,
                              b.moveTo(h - z, l),
                              b.lineTo(h - z, Math.min(k, r)),
                              b.stroke(),
                              b.moveTo(h - z, Math.max(k, r)),
                              b.lineTo(h - z, n),
                              b.stroke(),
                              ba(b, w, Math.min(k, r), A, Math.max(k, r), e, 0, null, !1, !1, !1, !1))) : "ohlc" === s.type && (c.moveTo(h - z, l),
                              c.lineTo(h - z, n),
                              c.stroke(),
                              c.beginPath(),
                              c.moveTo(h, k),
                              ...
                              b.lineTo(A, r),
                              b.stroke()));
                              (y[t].indexLabel || s.indexLabel || y[t].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: s.type,
                                  dataPoint: y[t],
                                  dataSeries: s,
                                  point: {
                                      x: w + (A - w) / 2,
                                      y: a.axisY.reversed ? n : l
                                  },
                                  direction: 1,
                                  bounds: {
                                      x1: w,
      ...
      p.prototype.renderBoxAndWhisker = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            ...
            , b = this._eventManager.ghostCtx;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, g = this.plotArea, q = 0, t, h, k, l, n, r, f, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, q = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, p = a.axisX.dataInfo.minDiff;
              isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
              p = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * g.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) << 0;
              ...
              b.rect(g.x1, g.y1, g.width, g.height),
              b.clip());
              for (var J = !1, J = !!a.axisY.reversed, x = 0; x < a.dataSeriesIndexes.length; x++) {
                  var s = a.dataSeriesIndexes[x]
                    , y = this.data[s]
                    , v = y.dataPoints;
                  if (0 < v.length)
                      for (var w = 5 < p && y.bevelEnabled ? !0 : !1, q = 0; q < v.length; q++)
                          if (v[q].getTime ? f = v[q].x.getTime() : f = v[q].x,
                          !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !m(v[q].y) && v[q].y.length && "number" === typeof v[q].y[0] && "number" === typeof v[q].y[1] && "number" === typeof v[q].y[2] && "number" === typeof v[q].y[3] && "number" === typeof v[q].y[4] && 5 === v[q].y.length) {
                              t = a.axisX.convertValueToPixel(f);
                              h = a.axisY.convertValueToPixel(v[q].y[0]);
                              ...
                              var A = t - p / 2 << 0
                                , B = t + p / 2 << 0
                                , e = v[q].color ? v[q].color : y._colorSet[0]
                                , z = Math.round(Math.max(1, 0.15 * p))
                                , D = 0 === z % 2 ? 0 : 0.5
                                , L = v[q].whiskerColor ? v[q].whiskerColor : v[q].color ? y.whiskerColor ? y.whiskerColor : v[q].color : y.whiskerColor ? y.whiskerColor : e
                                , T = "number" === typeof v[q].whiskerThickness ? v[q].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : z
                                , ha = v[q].whiskerDashType ? v[q].whiskerDashType : y.whiskerDashType
                                , ca = m(v[q].whiskerLength) ? m(y.options.whiskerLength) ? p : y.whiskerLength : v[q].whiskerLength
                                , ca = "number" === typeof ca ? 0 >= ca ? 0 : ca >= p ? p : ca : "string" === typeof ca ? parseInt(ca) * p / 100 > p ? p : parseInt(ca) * p / 100 : p
                                , ia = 1 === Math.round(T) % 2 ? 0.5 : 0
                                , pa = v[q].stemColor ? v[q].stemColor : v[q].color ? y.stemColor ? y.stemColor : v[q].color : y.stemColor ? y.stemColor : e
                                , ma = "number" === typeof v[q].stemThickness ? v[q].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : z
                                , F = 1 === Math.round(ma) % 2 ? 0.5 : 0
                                , E = v[q].stemDashType ? v[q].stemDashType : y.stemDashType
                                , K = v[q].lineColor ? v[q].lineColor : v[q].color ? y.lineColor ? y.lineColor : v[q].color : y.lineColor ? y.lineColor : e
                                , N = "number" === typeof v[q].lineThickness ? v[q].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : z
                                , P = v[q].lineDashType ? v[q].lineDashType : y.lineDashType
                                , M = 1 === Math.round(N) % 2 ? 0.5 : 0
                                , Q = y.upperBoxColor
                                , R = y.lowerBoxColor
                                , va = m(y.options.fillOpacity) ? 1 : y.fillOpacity
                                , S = y.dataPointIds[q];
                              this._eventManager.objectMap[S] = {
                                  id: S,
                                  objectType: "dataPoint",
                              ...
                              c.strokeStyle = pa,
                              c.lineWidth = ma,
                              c.setLineDash && c.setLineDash(I(E, ma)),
                              c.moveTo(t - F, k),
                              c.lineTo(t - F, h),
                              c.stroke(),
                              c.moveTo(t - F, n),
                              ...
                              c.beginPath();
                              ba(c, A, Math.min(r, k), B, Math.max(k, r), R, 0, e, J ? w : !1, J ? !1 : w, !1, !1, va);
                              c.beginPath();
                              ba(c, A, Math.min(l, r), B, Math.max(r, l), Q, 0, e, J ? !1 : w, J ? w : !1, !1, !1, va);
                              c.beginPath();
                              c.lineWidth = z;
                              c.strokeStyle = e;
                              c.rect(A - D, Math.min(k, l) - D, B - A + 2 * D, Math.max(k, l) - Math.min(k, l) + 2 * D);
                              c.stroke();
                              c.save();
                              0 < N && (c.beginPath(),
                              c.globalAlpha = 1,
                              c.setLineDash && c.setLineDash(I(P, N)),
                              c.strokeStyle = K,
                              c.lineWidth = N,
                              c.moveTo(A, r - M),
                              c.lineTo(B, r - M),
                              ...
                              c.save();
                              0 < T && (c.beginPath(),
                              c.setLineDash && c.setLineDash(I(ha, T)),
                              c.strokeStyle = L,
                              c.lineWidth = T,
                              c.moveTo(t - ca / 2 << 0, n - ia),
                              c.lineTo(t + ca / 2 << 0, n - ia),
                              c.stroke(),
                              c.moveTo(t - ca / 2 << 0, h + ia),
                              c.lineTo(t + ca / 2 << 0, h + ia),
                              c.stroke());
                              c.restore();
                              u && (e = Z(S),
                              b.strokeStyle = e,
                              b.lineWidth = ma,
                              0 < ma && (b.moveTo(t - D - F, k),
                              b.lineTo(t - D - F, Math.max(h, n)),
                              b.stroke(),
                              b.moveTo(t - D - F, Math.min(h, n)),
                              b.lineTo(t - D - F, l),
                              b.stroke()),
                              ba(b, A, Math.max(k, l), B, Math.min(k, l), e, 0, null, !1, !1, !1, !1),
                              0 < T && (b.beginPath(),
                              b.lineWidth = T,
                              b.moveTo(t + ca / 2, n - ia),
                              b.lineTo(t - ca / 2, n - ia),
                              b.stroke(),
                              b.moveTo(t + ca / 2, h + ia),
                              b.lineTo(t - ca / 2, h + ia),
                              b.stroke()));
                              (v[q].indexLabel || y.indexLabel || v[q].indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: y.type,
                                  dataPoint: v[q],
                                  dataSeries: y,
                                  point: {
                                      x: A + (B - A) / 2,
                                      y: a.axisY.reversed ? h : n
                                  },
                                  direction: 1,
                                  bounds: {
                                      x1: A,
      ...
      p.prototype.renderRangeColumn = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = u ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, g = 0, q, t, h, g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
              ...
              for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                  var n = a.dataSeriesIndexes[l]
                    ...
                    , f = r.dataPoints;
                  if (0 < f.length)
                      for (var p = 5 < k && r.bevelEnabled ? !0 : !1, g = 0; g < f.length; g++)
                          if (f[g].getTime ? h = f[g].x.getTime() : h = f[g].x,
                          !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !m(f[g].y) && f[g].y.length && "number" === typeof f[g].y[0] && "number" === typeof f[g].y[1]) {
                              b = a.axisX.convertValueToPixel(h);
                              q = a.axisY.convertValueToPixel(f[g].y[0]);
                              t = a.axisY.convertValueToPixel(f[g].y[1]);
                              var J = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + l) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + l) * k << 0
                                , x = a.axisX.reversed ? J - k << 0 : J + k << 0
                                , b = f[g].color ? f[g].color : r._colorSet[g % r._colorSet.length];
                              if (q > t) {
                                  var s = q;
                                  q = t;
                                  t = s
                              ...
                              ba(c, a.axisX.reversed ? x : J, q, a.axisX.reversed ? J : x, t, b, 0, b, p, p, !1, !1, r.fillOpacity);
                              b = Z(s);
                              u && ba(this._eventManager.ghostCtx, a.axisX.reversed ? x : J, q, a.axisX.reversed ? J : x, t, b, 0, null, !1, !1, !1, !1);
      ...
      p.prototype.renderError = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, g = !1, q = this.plotArea, t = 0, h, k, l, n, r, f, p, J = a.axisX.dataInfo.minDiff;
              ...
              for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                  var v = a.dataSeriesIndexes[y]
                    , w = this.data[v]
                    , A = w.dataPoints
                    , B = m(w._linkedSeries) ? !1 : w._linkedSeries.type.match(/(bar|column)/ig) && w._linkedSeries.visible ? !0 : !1
                    , D = 0;
                  if (B)
                      for (e = w._linkedSeries.id,
                      s = 0; s < e; s++)
                          !this.data[s].type.match(/(bar|column)/ig) || !this.data[s].visible || this.data[s].type.match(/(stacked)/ig) && D || (this.data[s].type.match(/(range)/ig) && (g = !0),
                          D++);
                  ...
                  s > t && (s = t);
                  if (0 < A.length)
                      for (var I = w._colorSet, t = 0; t < A.length; t++) {
                          var e = w.lineColor = w.options.color ? w.options.color : I[0]
                            , L = {
                              color: A[t].whiskerColor ? A[t].whiskerColor : A[t].color ? w.whiskerColor ? w.whiskerColor : A[t].color : w.whiskerColor ? w.whiskerColor : e,
                              thickness: m(A[t].whiskerThickness) ? w.whiskerThickness : A[t].whiskerThickness,
                              dashType: A[t].whiskerDashType ? A[t].whiskerDashType : w.whiskerDashType,
                              length: m(A[t].whiskerLength) ? m(w.options.whiskerLength) ? s : w.options.whiskerLength : A[t].whiskerLength,
                              trimLength: m(A[t].whiskerLength) ? m(w.options.whiskerLength) ? 50 : 0 : 0
                          };
                          ...
                          var T = {
                              color: A[t].stemColor ? A[t].stemColor : A[t].color ? w.stemColor ? w.stemColor : A[t].color : w.stemColor ? w.stemColor : e,
                              thickness: A[t].stemThickness ? A[t].stemThickness : w.stemThickness,
                              dashType: A[t].stemDashType ? A[t].stemDashType : w.stemDashType
                          };
                          T.thickness = "number" === typeof T.thickness ? 0 > T.thickness ? 0 : Math.round(T.thickness) : 2;
                          A[t].getTime ? p = A[t].x.getTime() : p = A[t].x;
                          if (!(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax) && !m(A[t].y) && A[t].y.length && "number" === typeof A[t].y[0] && "number" === typeof A[t].y[1]) {
                              var ha = a.axisX.convertValueToPixel(p);
                              b ? k = ha : h = ha;
                              ha = a.axisY.convertValueToPixel(A[t].y[0]);
                              b ? l = ha : r = ha;
                              ha = a.axisY.convertValueToPixel(A[t].y[1]);
                              b ? n = ha : f = ha;
                              b ? (r = a.axisX.reversed ? k + (B ? x : 1) * s / 2 - (B ? D - 1 : 0) * s << 0 : k - (B ? x : 1) * s / 2 + (B ? D - 1 : 0) * s << 0,
                              f = a.axisX.reversed ? r - s << 0 : r + s << 0) : (l = a.axisX.reversed ? h + (B ? x : 1) * s / 2 - (B ? D - 1 : 0) * s << 0 : h - (B ? x : 1) * s / 2 + (B ? D - 1 : 0) * s << 0,
                              n = a.axisX.reversed ? l - s << 0 : l + s << 0);
                              !b && r > f && (ha = r,
                              r = f,
                              f = ha);
                              b && l > n && (ha = l,
                              ...
                              z(c, Math.min(l, n), Math.min(r, f), Math.max(n, l), Math.max(f, r), e, L, T, b);
                              u && z(this._eventManager.ghostCtx, l, r, n, f, e, L, T, b);
                              if (A[t].indexLabel || w.indexLabel || A[t].indexLabelFormatter || w.indexLabelFormatter)
                                  this._indexLabels.push({
                                      chartType: "error",
                                      dataPoint: A[t],
                                      dataSeries: w,
                                      indexKeyword: 0,
                                      point: {
                                          x: b ? A[t].y[1] >= A[t].y[0] ? l : n : l + (n - l) / 2,
                                          y: b ? r + (f - r) / 2 : A[t].y[1] >= A[t].y[0] ? f : r
                                      },
                                      direction: A[t].y[1] >= A[t].y[0] ? -1 : 1,
                                      bounds: {
                                          x1: b ? Math.min(l, n) : l,
                                          y1: b ? r : Math.min(r, f),
                                          x2: b ? Math.max(l, n) : n,
                                  ...
                                  this._indexLabels.push({
                                      ...
                                      indexKeyword: 1,
                                      point: {
                                          x: b ? A[t].y[1] >= A[t].y[0] ? n : l : l + (n - l) / 2,
                                          y: b ? r + (f - r) / 2 : A[t].y[1] >= A[t].y[0] ? r : f
                                      },
                                      direction: A[t].y[1] >= A[t].y[0] ? 1 : -1,
                                      bounds: {
                                          x1: b ? Math.min(l, n) : l,
      ...
      p.prototype.renderRangeBar = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = u ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, g = 0, q, t, h, k, g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
              ...
              for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                  var r = a.dataSeriesIndexes[n]
                    ...
                    , p = f.dataPoints;
                  if (0 < p.length) {
                      var J = 5 < l && f.bevelEnabled ? !0 : !1;
                      c.strokeStyle = "#4572A7 ";
                      for (g = 0; g < p.length; g++)
                          if (p[g].getTime ? k = p[g].x.getTime() : k = p[g].x,
                          !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !m(p[g].y) && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                              q = a.axisY.convertValueToPixel(p[g].y[0]);
                              t = a.axisY.convertValueToPixel(p[g].y[1]);
                              h = a.axisX.convertValueToPixel(k);
                              h = a.axisX.reversed ? h + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount + n) * l << 0 : h - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount + n) * l << 0;
                              var x = a.axisX.reversed ? h - l << 0 : h + l << 0;
                              q > t && (b = q,
                              q = t,
                              t = b);
                              b = p[g].color ? p[g].color : f._colorSet[g % f._colorSet.length];
                              ba(c, q, a.axisX.reversed ? x : h, t, a.axisX.reversed ? h : x, b, 0, null, J, !1, !1, !1, f.fillOpacity);
                              b = f.dataPointIds[g];
                              this._eventManager.objectMap[b] = {
                                  id: b,
                                  objectType: "dataPoint",
                              ...
                              b = Z(b);
                              u && ba(this._eventManager.ghostCtx, q, a.axisX.reversed ? x : h, t, a.axisX.reversed ? h : x, b, 0, null, !1, !1, !1, !1);
                              if (p[g].indexLabel || f.indexLabel || p[g].indexLabelFormatter || f.indexLabelFormatter)
                                  this._indexLabels.push({
                                      chartType: "rangeBar",
                                      dataPoint: p[g],
                                      dataSeries: f,
                                      indexKeyword: 0,
                                      point: {
                                          x: p[g].y[1] >= p[g].y[0] ? q : t,
                                          y: h + (x - h) / 2
                                      },
                                      direction: p[g].y[1] >= p[g].y[0] ? -1 : 1,
                                      bounds: {
                                          x1: Math.min(q, t),
                                          y1: h,
                                          x2: Math.max(q, t),
      ...
      p.prototype.renderRangeArea = function(a) {
          function d() {
              if (y) {
                  for (var a = null, c = m.length - 1; 0 <= c; c--)
                      a = m[c],
                      b.lineTo(a.x, a.y2),
                      e.lineTo(a.x, a.y2);
                  b.closePath();
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              b.clip();
              u && (e.beginPath(),
              e.rect(q.x1, q.y1, q.width, q.height),
              e.clip());
              for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                  var m = []
                  ...
                  g = Z(g);
                  e.fillStyle = g;
                  var g = [], r = !0, f = 0, p, J, x, s, y = null;
                  if (0 < n.length) {
                      var v = l._colorSet[f % l._colorSet.length]
                        , w = l.lineColor = l.options.lineColor || v
                        , A = w;
                      b.fillStyle = v;
                      b.strokeStyle = w;
                      b.lineWidth = l.lineThickness;
                      ...
                      for (var L = !0; f < n.length; f++)
                          if (s = n[f].x.getTime ? n[f].x.getTime() : n[f].x,
                          !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !L)))
                              if (null !== n[f].y && n[f].y.length && "number" === typeof n[f].y[0] && "number" === typeof n[f].y[1]) {
                                  p = a.axisX.convertValueToPixel(s);
                                  J = a.axisY.convertValueToPixel(n[f].y[0]);
                                  x = a.axisY.convertValueToPixel(n[f].y[1]);
                                  r || L ? (l.connectNullData && !r ? (b.setLineDash && (l.options.nullDataLineDashType || B === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (m[m.length - 1].newLineDashArray = D,
                                  B = l.nullDataLineDashType,
                                  b.setLineDash(z)),
                                  b.lineTo(p, J),
                                  u && e.lineTo(p, J),
                                  m.push({
                                  ...
                                  f < n.length - 1 && (A !== (n[f].lineColor || w) || B !== (n[f].lineDashType || l.lineDashType)) && (d(),
                                  A = n[f].lineColor || w,
                                  m[m.length - 1].newStrokeStyle = A,
                                  b.strokeStyle = A,
                                  b.setLineDash && (n[f].lineDashType ? (B = n[f].lineDashType,
                                  m[m.length - 1].newLineDashArray = I(B, l.lineThickness),
                                  b.setLineDash(m[m.length - 1].newLineDashArray)) : (B = l.lineDashType,
                                  m[m.length - 1].newLineDashArray = D,
                                  b.setLineDash(D))));
                                  if (0 !== n[f].markerSize && (0 < n[f].markerSize || 0 < l.markerSize)) {
                                      var T = l.getMarkerProperties(f, p, x, b);
                                      g.push(T);
                                      var ha = Z(s);
                                      u && g.push({
                                          x: p,
                                      ...
                                      T = l.getMarkerProperties(f, p, J, b);
                                      g.push(T);
                                      ha = Z(s);
                                      u && g.push({
                                          x: p,
                                  ...
                                  if (n[f].indexLabel || l.indexLabel || n[f].indexLabelFormatter || l.indexLabelFormatter)
                                      this._indexLabels.push({
                                          ...
                                          direction: n[f].y[0] > n[f].y[1] === a.axisY.reversed ? -1 : 1,
                                          color: v
                                      }),
                                      this._indexLabels.push({
                                          chartType: "rangeArea",
          ...
          function d(a, c) {
              ...
              if (0 < d.length) {
                  ...
                  for (f = 0; f < d.length - 3; f += 3)
                      b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y),
                      u && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
                  d = w(x, 2);
                  ...
                  if (0 < k.lineThickness) {
                      ...
                      g++) {
                          if (J[g].newStrokeStyle || J[g].newLineDashArray)
                              b.stroke(),
                              b.beginPath(),
                              b.moveTo(d[f].x, d[f].y),
                              J[g].newStrokeStyle && (b.strokeStyle = J[g].newStrokeStyle),
                              J[g].newLineDashArray && b.setLineDash(J[g].newLineDashArray);
                          b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                      }
                      d = w(J, 2);
                      b.moveTo(d[0].x, d[0].y);
                      for (g = f = 0; f < d.length - 3; f += 3,
                      g++) {
                          if (J[g].newStrokeStyle || J[g].newLineDashArray)
                              b.stroke(),
                              b.beginPath(),
              ...
              for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                  ...
                  if (0 < l.length) {
                      var s = k._colorSet[n % k._colorSet.length]
                        , y = k.lineColor = k.options.lineColor || s
                        , v = y;
                      b.fillStyle = s;
                      b.lineWidth = k.lineThickness;
                      var z = "solid", A;
                      ...
                      for (f = !1; n < l.length; n++)
                          if (r = l[n].x.getTime ? l[n].x.getTime() : l[n].x,
                          !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !f)))
                              if (null !== l[n].y && l[n].y.length && "number" === typeof l[n].y[0] && "number" === typeof l[n].y[1]) {
                                  ...
                                  p = a.axisY.convertValueToPixel(l[n].y[1]);
                                  ...
                                  n < l.length - 1 && (v !== (l[n].lineColor || y) || z !== (l[n].lineDashType || k.lineDashType)) && (v = l[n].lineColor || y,
                                  J[J.length - 1].newStrokeStyle = v,
                                  b.setLineDash && (l[n].lineDashType ? (z = l[n].lineDashType,
                                  J[J.length - 1].newLineDashArray = I(z, k.lineThickness)) : (z = k.lineDashType,
                                  J[J.length - 1].newLineDashArray = A)));
                                  if (0 !== l[n].markerSize && (0 < l[n].markerSize || 0 < k.markerSize)) {
                                      var E = k.getMarkerProperties(n, r, f, b);
                                      g.push(E);
                                      var L = Z(D);
                                      u && g.push({
                                          x: r,
                                      ...
                                      E = k.getMarkerProperties(n, r, p, b);
                                      g.push(E);
                                      L = Z(D);
                                      u && g.push({
                                          x: r,
                                  ...
                                  0 < n && !f && (k.connectNullData ? b.setLineDash && (0 < J.length && (k.options.nullDataLineDashType || !l[n - 1].lineDashType)) && (J[J.length - 1].newLineDashArray = B,
                                  z = k.nullDataLineDashType) : (d(A, y),
                                  J = [],
                                  x = [])),
                                  f = !0;
                      d(A, y);
      ...
      p.prototype.renderWaterfall = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = u ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx, e = null, g = this.plotArea, q = 0, h, m, k, l, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), q = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
              ...
              this.dataPointMaxWidth && q > m && (q = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m));
              !this.dataPointMaxWidth && (this.dataPointMinWidth && m < q) && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, q));
              r < q && (r = q);
              r > m && (r = m);
              c.save();
              u && this._eventManager.ghostCtx.save();
              ...
              for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
                  ...
                  var s = "number" === typeof w.options.lineThickness ? Math.round(w.lineThickness) : 1
                    , y = 1 === Math.round(s) % 2 ? -0.5 : 0;
                  if (0 < x.length)
                      for (var v = 5 < r && w.bevelEnabled ? !0 : !1, z = !1, A = null, B = null, q = 0; q < x.length; q++)
                          if (x[q].getTime ? l = x[q].x.getTime() : l = x[q].x,
                          "number" !== typeof x[q].y) {
                              if (0 < q && !z && w.connectNullData)
                                  var D = w.options.nullDataLineDashType || !x[q - 1].lineDashType ? w.nullDataLineDashType : x[q - 1].lineDashType;
                              z = !0
                          } else {
                              h = a.axisX.convertValueToPixel(l);
                              m = 0 === w.dataPointEOs[q].cumulativeSum ? n : a.axisY.convertValueToPixel(w.dataPointEOs[q].cumulativeSum);
                              k = 0 === w.dataPointEOs[q].cumulativeSumYStartValue ? n : a.axisY.convertValueToPixel(w.dataPointEOs[q].cumulativeSumYStartValue);
                              h = a.axisX.reversed ? h + a.plotType.totalDataSeries * r / 2 - (a.previousDataSeriesCount + f) * r << 0 : h - a.plotType.totalDataSeries * r / 2 + (a.previousDataSeriesCount + f) * r << 0;
                              var E = a.axisX.reversed ? h - r << 0 : h + r << 0;
                              m > k && (e = m,
                              m = k,
                              k = e);
                              ...
                              var L = x[q].color ? x[q].color : 0 < x[q].y ? w.risingColor : w.fallingColor;
                              ba(c, a.axisX.reversed ? E : h, a.axisY.reversed ? k : m, a.axisX.reversed ? h : E, a.axisY.reversed ? m : k, L, 0, L, v, v, !1, !1, w.fillOpacity);
                              e = Z(e);
                              u && ba(this._eventManager.ghostCtx, a.axisX.reversed ? E : h, m, a.axisX.reversed ? h : E, k, e, 0, null, !1, !1, !1, !1);
                              var T, L = h;
                              T = "undefined" !== typeof x[q].isIntermediateSum && !0 === x[q].isIntermediateSum || "undefined" !== typeof x[q].isCumulativeSum && !0 === x[q].isCumulativeSum ? 0 < x[q].y ? m : k : 0 < x[q].y ? k : m;
                              0 < q && A && (!z || w.connectNullData) && (z && c.setLineDash && c.setLineDash(I(D, s)),
                              c.beginPath(),
                              c.moveTo(A, B - y),
                              c.lineTo(L, T - y),
                              0 < s && c.stroke(),
                              ...
                              A = E;
                              B = 0 < x[q].y ? m : k;
                              L = x[q].lineDashType ? x[q].lineDashType : w.options.lineDashType ? w.options.lineDashType : "shortDash";
                              c.strokeStyle = x[q].lineColor ? x[q].lineColor : w.options.lineColor ? w.options.lineColor : "#9e9e9e";
                              c.lineWidth = s;
                              c.setLineDash && (L = I(L, s),
                              c.setLineDash(L));
                              (x[q].indexLabel || w.indexLabel || x[q].indexLabelFormatter || w.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: "waterfall",
                                  dataPoint: x[q],
                                  dataSeries: w,
                                  point: {
      ...
      ;
      var ra = function(a, d, c, b, e, g, q, h, m) {
          if (!(0 > c)) {
      ...
      p.prototype.renderPie = function(a) {
          function d() {
              if (k && l) {
                  for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < l.length; e++) {
                      ...
                      n = g.indexLabelFormatter ? g.indexLabelFormatter(t) : g.indexLabel ? p.replaceKeywordsWithValue(g.indexLabel, g, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(t) : k.indexLabel ? p.replaceKeywordsWithValue(k.indexLabel, g, k, e) : g.label ? g.label : "";
                      p._eventManager.objectMap[q] = h;
                      h.center = {
                          x: v.x,
                          y: v.y
                      };
                      ...
                      h.indexLabelLineColor = g.indexLabelLineColor ? g.indexLabelLineColor : k.options.indexLabelLineColor ? k.options.indexLabelLineColor : g.color ? g.color : k._colorSet[e % k._colorSet.length];
                      h.indexLabelLineThickness = m(g.indexLabelLineThickness) ? k.indexLabelLineThickness : g.indexLabelLineThickness;
                      h.indexLabelLineDashType = g.indexLabelLineDashType ? g.indexLabelLineDashType : k.indexLabelLineDashType;
                      h.indexLabelFontColor = g.indexLabelFontColor ? g.indexLabelFontColor : k.indexLabelFontColor;
                      h.indexLabelFontStyle = g.indexLabelFontStyle ? g.indexLabelFontStyle : k.indexLabelFontStyle;
                      h.indexLabelFontWeight = g.indexLabelFontWeight ? g.indexLabelFontWeight : k.indexLabelFontWeight;
                      h.indexLabelFontSize = m(g.indexLabelFontSize) ? k.indexLabelFontSize : g.indexLabelFontSize;
                      h.indexLabelFontFamily = g.indexLabelFontFamily ? g.indexLabelFontFamily : k.indexLabelFontFamily;
                      h.indexLabelBackgroundColor = g.indexLabelBackgroundColor ? g.indexLabelBackgroundColor : k.options.indexLabelBackgroundColor ? k.options.indexLabelBackgroundColor : k.indexLabelBackgroundColor;
                      h.indexLabelMaxWidth = g.indexLabelMaxWidth ? g.indexLabelMaxWidth : k.indexLabelMaxWidth ? k.indexLabelMaxWidth : 0.33 * r.width;
                      h.indexLabelWrap = "undefined" !== typeof g.indexLabelWrap ? g.indexLabelWrap : k.indexLabelWrap;
                      h.indexLabelTextAlign = g.indexLabelTextAlign ? g.indexLabelTextAlign : k.indexLabelTextAlign ? k.indexLabelTextAlign : "left";
                      h.startAngle = 0 === e ? k.startAngle ? k.startAngle / 180 * Math.PI : 0 : f[e - 1].endAngle;
                      h.startAngle = (h.startAngle + 2 * Math.PI) % (2 * Math.PI);
                      h.endAngle = h.startAngle + 2 * Math.PI / z * Math.abs(g.y);
                      g = (h.endAngle + h.startAngle) / 2;
                      g = (g + 2 * Math.PI) % (2 * Math.PI);
                      h.midAngle = g;
                      if (h.midAngle > Math.PI / 2 - s && h.midAngle < Math.PI / 2 + s) {
                          if (0 === a || f[c].midAngle > h.midAngle)
                              c = e;
                          a++
                      } else if (h.midAngle > 3 * Math.PI / 2 - s && h.midAngle < 3 * Math.PI / 2 + s) {
                          if (0 === b || f[d].midAngle > h.midAngle)
                              d = e;
                          b++
                      }
                      h.hemisphere = g > Math.PI / 2 && g <= 3 * Math.PI / 2 ? "left" : "right";
                      h.indexLabelTextBlock = new la(p.plotArea.ctx,{
                  ...
                  for (e = 0; e < l.length; e++)
                      h = f[(c + e) % l.length],
                      1 < a && (h.midAngle > Math.PI / 2 - s && h.midAngle < Math.PI / 2 + s) && (g <= a / 2 && !n ? (h.hemisphere = "right",
                      g++) : (h.hemisphere = "left",
                      n = !0));
                  n = !1;
                  for (e = 0; e < l.length; e++)
                      h = f[(d + e) % l.length],
                      1 < b && (h.midAngle > 3 * Math.PI / 2 - s && h.midAngle < 3 * Math.PI / 2 + s) && (q <= b / 2 && !n ? (h.hemisphere = "left",
                      q++) : (h.hemisphere = "right",
                      n = !0))
              }
          }
          function c(a, b) {
              var c = p.plotArea.ctx;
              c.clearRect(r.x1, r.y1, r.width, r.height);
              c.fillStyle = p.backgroundColor;
              c.fillRect(r.x1, r.y1, r.width, r.height);
              for (c = 0; c < l.length; c++) {
                  var d = f[c].startAngle
                    , e = f[c].endAngle;
                  if (e > d) {
                      var g = 0.07 * B * Math.cos(f[c].midAngle)
                        , q = 0.07 * B * Math.sin(f[c].midAngle)
                        , h = !1;
                      if (l[c].exploded) {
                          if (1E-9 < Math.abs(f[c].center.x - (v.x + g)) || 1E-9 < Math.abs(f[c].center.y - (v.y + q)))
                              f[c].center.x = v.x + g * a,
                              f[c].center.y = v.y + q * a,
                              h = !0
                      } else if (0 < Math.abs(f[c].center.x - v.x) || 0 < Math.abs(f[c].center.y - v.y))
                          f[c].center.x = v.x + g * (1 - a),
                          f[c].center.y = v.y + q * (1 - a),
                          h = !0;
                      h && b && (g = {},
                      g.dataSeries = k,
                      g.dataPoint = k.dataPoints[c],
                      g.index = c,
                      p.toolTip.highlightObjects([g]));
                      ra(p.plotArea.ctx, f[c].center, f[c].radius, l[c].color ? l[c].color : k._colorSet[c % k._colorSet.length], k.type, d, e, k.fillOpacity, f[c].percentInnerRadius)
                  }
              }
              c = p.plotArea.ctx;
              c.save();
              ...
              c.lineJoin = "round";
              for (d = d = 0; d < l.length; d++)
                  e = f[d],
                  e.indexLabelText && (e.indexLabelTextBlock.y -= e.indexLabelTextBlock.height / 2 - e.indexLabelTextBlock.fontSize / 2,
                  g = 0,
                  g = "left" === e.hemisphere ? "inside" !== k.indexLabelPlacement ? -(e.indexLabelTextBlock.width + n) : -e.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? n : -e.indexLabelTextBlock.width / 2,
                  ...
                  "inside" !== e.indexLabelPlacement && 0 < e.indexLabelLineThickness && (g = e.center.x + B * Math.cos(e.midAngle),
          ...
          function e(a) {
              for (var c = null, e = 1; e < l.length; e++)
                  if (c = (a + e + f.length) % f.length,
                  f[c].hemisphere !== f[a].hemisphere) {
                      c = null;
                      break
                  } else if (f[c].indexLabelText && c !== a && (0 > b(f[c], f[a]) || ("right" === f[a].hemisphere ? f[c].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y : f[c].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y)))
                      break;
                  else
                      c = null;
              return c
          ...
          function g(a, c, d) {
              ...
              if (0 <= a && a < l.length) {
                  var n = f[a];
                  if (0 > c && n.indexLabelTextBlock.y < k || 0 < c && n.indexLabelTextBlock.y > h)
                      return 0;
                  var m = 0
                    , r = 0
                    , r = m = m = 0;
                  ...
                  k = 0;
                  k = "right" === n.hemisphere ? v.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - v.y, 2)) : v.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - v.y, 2));
                  r = v.x + B * Math.cos(n.midAngle);
                  m = v.y + B * Math.sin(n.midAngle);
                  m = Math.sqrt(Math.pow(k - r, 2) + Math.pow(c - m, 2));
                  r = Math.acos(B / w);
                  m = Math.acos((w * w + B * B - m * m) / (2 * B * w));
                  c = m < r ? c - n.indexLabelTextBlock.y : 0;
                  k = null;
                  for (h = 1; h < l.length; h++)
                      if (k = (a - h + f.length) % f.length,
                      f[k].hemisphere !== f[a].hemisphere) {
                          k = null;
                          break
                      } else if (f[k].indexLabelText && f[k].hemisphere === f[a].hemisphere && k !== a && (0 > b(f[k], f[a]) || ("right" === f[a].hemisphere ? f[k].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y : f[k].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y)))
                          break;
                      else
                          k = null;
                  r = k;
                  m = e(a);
                  h = k = 0;
                  0 > c ? (h = "right" === n.hemisphere ? r : m,
                  q = c,
                  null !== h && (r = -c,
                  c = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (f[h].indexLabelTextBlock.y + f[h].indexLabelTextBlock.height / 2),
                  c - r < u && (k = -r,
                  h = g(h, k, d + 1),
                  +h.toFixed(y) > +k.toFixed(y) && (q = c > u ? -(c - u) : -(r - (h - k)))))) : 0 < c && (h = "right" === n.hemisphere ? m : r,
                  q = c,
                  null !== h && (r = c,
                  c = f[h].indexLabelTextBlock.y - f[h].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2),
                  c - r < u && (k = r,
                  h = g(h, k, d + 1),
                  +h.toFixed(y) < +k.toFixed(y) && (q = c > u ? c - u : r - (k - h)))));
                  q && (d = n.indexLabelTextBlock.y + q,
                  c = 0,
                  c = "right" === n.hemisphere ? v.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - v.y, 2)) : v.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - v.y, 2)),
                  n.midAngle > Math.PI / 2 - s && n.midAngle < Math.PI / 2 + s ? (k = (a - 1 + f.length) % f.length,
                  k = f[k],
                  a = f[(a + 1 + f.length) % f.length],
                  "left" === n.hemisphere && "right" === k.hemisphere && c > k.indexLabelTextBlock.x ? c = k.indexLabelTextBlock.x - 15 : "right" === n.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : n.midAngle > 3 * Math.PI / 2 - s && n.midAngle < 3 * Math.PI / 2 + s && (k = (a - 1 + f.length) % f.length,
                  k = f[k],
                  a = f[(a + 1 + f.length) % f.length],
                  "right" === n.hemisphere && "left" === k.hemisphere && c < k.indexLabelTextBlock.x ? c = k.indexLabelTextBlock.x + 15 : "left" === n.hemisphere && ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)),
                  n.indexLabelTextBlock.y = d,
                  n.indexLabelTextBlock.x = c,
                  n.indexLabelAngle = Math.atan2(n.indexLabelTextBlock.y - v.y, n.indexLabelTextBlock.x - v.x))
              }
              return q
          }
          function q() {
              ...
              for (var c = a = 0, d = 0, q = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                  if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && B - d <= D)
                      q = !1;
                  q && (B -= d);
                  d = 0;
                  if ("inside" !== k.indexLabelPlacement) {
                      ...
                      for (a = 0; a < l.length; a++) {
                          var h = f[a];
                          h.indexLabelTextBlock.x = v.x + w * Math.cos(h.midAngle);
                          h.indexLabelTextBlock.y = v.y + w * Math.sin(h.midAngle);
                          h.indexLabelAngle = h.midAngle;
                          h.radius = B;
                          h.percentInnerRadius = E
                      }
                      for (var m, t, a = 0; a < l.length; a++) {
                          var h = f[a]
                            , s = e(a);
                          if (null !== s) {
                              m = f[a];
                              ...
                              var A = 0
                                , A = b(m, t) - u;
                              if (0 > A) {
                                  for (var z = t = 0, H = 0; H < l.length; H++)
                                      H !== a && f[H].hemisphere === h.hemisphere && (f[H].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? t++ : z++);
                                  t = A / (t + z || 1) * z;
                                  var z = -1 * (A - t)
                                    , I = H = 0;
                                  "right" === h.hemisphere ? (H = g(a, t),
                                  z = -1 * (A - H),
                                  I = g(s, z),
                                  +I.toFixed(y) < +z.toFixed(y) && +H.toFixed(y) <= +t.toFixed(y) && g(a, -(z - I))) : (H = g(s, t),
                                  z = -1 * (A - H),
                                  I = g(a, z),
                                  +I.toFixed(y) < +z.toFixed(y) && +H.toFixed(y) <= +t.toFixed(y) && g(s, -(z - I)))
                              }
                          }
                      }
                  } else
                      for (a = 0; a < l.length; a++)
                          ...
                          s = v.x + w * Math.cos(h.midAngle),
                          t = v.y + w * Math.sin(h.midAngle),
                  ...
                  for (a = 0; a < l.length; a++)
                      ...
                      0 !== s.height && 0 !== s.width)
                          s = s = 0,
                          "right" === h.hemisphere ? (s = r.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + n),
                          s *= -1) : s = r.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - n),
                          0 < s && (!q && h.indexLabelText && (t = "right" === h.hemisphere ? r.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - r.x1,
                          ...
                          Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - v.y) < B || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - v.y) < B) && (s /= Math.abs(Math.cos(h.indexLabelAngle)),
                          9 < s && (s *= 0.3),
                          s > d && (d = s)),
                          s = s = 0,
                          0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (s = r.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5),
                          s *= -1) : s = r.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5),
                          0 < s && (!q && h.indexLabelText && (t = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1,
                          0 === g(a, s * t) && g(a, 2 * t)),
                          Math.abs(h.indexLabelTextBlock.x - v.x) < B && (s /= Math.abs(Math.sin(h.indexLabelAngle)),
                          9 < s && (s *= 0.3),
                          s > d && (d = s)));
                  ...
                  (function() {
                      for (var a = -1, c = -1, d = 0, g = !1, q = 0; q < l.length; q++)
                          if (g = !1,
                          m = f[q],
                          m.indexLabelText) {
                              var k = e(q);
                              if (null !== k) {
                                  ...
                                  var r;
                                  if (r = 0 > A) {
                                      r = m.indexLabelTextBlock.x;
                                      var t = m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2
                                        , p = m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2
                                        , s = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2
                                        , C = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width
                                        , v = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2;
                                      r = m.indexLabelTextBlock.x + m.indexLabelTextBlock.width < h.indexLabelTextBlock.x - n || r > C + n || t > v + n || p < s - n ? !1 : !0
                                  }
                                  r ? (0 > a && (a = q),
                                  k !== a && (c = k,
                                  d += -A),
                                  0 === q % Math.max(l.length / 10, 3) && (g = !0)) : g = !0;
                                  g && (0 < d && 0 <= a && 0 <= c) && (M(d, a, c),
                                  c = a = -1,
                                  d = 0)
                              }
                          }
          ...
          function h() {
              ...
              p.title && (p.title.dockInsidePlotArea || "center" === p.title.horizontalAlign && "center" === p.title.verticalAlign) && p.title.render();
              if (p.subtitles)
                  for (var a = 0; a < p.subtitles.length; a++) {
                      var b = p.subtitles[a];
                      (b.dockInsidePlotArea || "center" === b.horizontalAlign && "center" === b.verticalAlign) && b.render()
                  }
              p.legend && (p.legend.dockInsidePlotArea || "center" === p.legend.horizontalAlign && "center" === p.legend.verticalAlign) && (p.legend.setLayout(),
              p.legend.render())
          }
          var p = this;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var k = this.data[a.dataSeriesIndexes[0]], l = k.dataPoints, n = 10, r = this.plotArea, f = k.dataPointEOs, u = 2, w, x = 1.3, s = 20 / 180 * Math.PI, y = 6, v = {
                  x: (r.x2 + r.x1) / 2,
                  y: (r.y2 + r.y1) / 2
              }, z = 0;
              a = !1;
              for (var A = 0; A < l.length; A++)
                  z += Math.abs(l[A].y),
                  !a && ("undefined" !== typeof l[A].indexLabel && null !== l[A].indexLabel && 0 < l[A].indexLabel.toString().length) && (a = !0),
                  !a && ("undefined" !== typeof l[A].label && null !== l[A].label && 0 < l[A].label.toString().length) && (a = !0);
              if (0 !== z) {
                  ...
                  var D = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ta(k.innerRadius, B) : 0.7 * B;
                  k.radius = B;
                  "doughnut" === k.type && (k.innerRadius = D);
                  var E = Math.min(D / B, (B - 1) / B);
                  this.pieDoughnutClickHandler = function(a) {
                      p.isAnimating || !m(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
                  ...
                  this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                      ...
                      for (var b = f[0].startAngle + 2 * Math.PI * a, c = 0; c < l.length; c++) {
                          var e = 0 === c ? f[c].startAngle : d
                            , d = e + (f[c].endAngle - f[c].startAngle)
                            , g = !1;
                          d > b && (d = b,
                          g = !0);
                          var q = l[c].color ? l[c].color : k._colorSet[c % k._colorSet.length];
                          d > e && ra(p.plotArea.ctx, f[c].center, f[c].radius, q, k.type, e, d, k.fillOpacity, f[c].percentInnerRadius);
                          if (g)
                              break
                      }
                      h();
                      ...
                      1 <= a && p.dispatchEvent("dataAnimationEnd", {
                          chart: p
                      })
                  }, function() {
                      p.disableToolTip = !1;
      ...
      p.prototype.renderFunnel = function(a) {
          function d() {
              ...
              for (c = b[0] = 0; c < y.length; c++)
                  b.push(Math.abs(y[c].y) * D / a);
              return b
          }
          function c() {
              var a = U, b = Y, c = M, e = $, d, f;
              d = N;
              f = P - R;
              ...
              f = Math.abs(f);
              f = e + f;
              for (var e = [], g = 0, q = 0; q < y.length; q++) {
                  if ("undefined" === typeof y[q].y)
                      return -1;
                  y[q].y = "number" === typeof y[q].y ? y[q].y : 0;
                  g += Math.abs(y[q].y)
              }
              if (0 === g)
                  return -1;
              for (var k = e[0] = 0, h = 0, l, n, b = b - a, k = !1, q = 0; q < y.length; q++)
                  a = Math.abs(y[q].y) * f / g,
                  k ? l = 0 == Number(c.toFixed(3)) ? 0 : a / c : (n = da * da * b * b - 4 * Math.abs(da) * a,
                  0 > n ? (n = c,
                  k = (b + n) * (d - h) / 2,
                  a -= k,
                  l = d - h,
                  ...
                  l += 0 == n ? 0 : a / n,
                  h += a / n,
                  k = !0) : (l = (Math.abs(da) * b - Math.sqrt(n)) / 2,
                  n = b - 2 * l / Math.abs(da),
                  h += l,
                  h > d && (h -= l,
                  n = c,
          ...
          function b() {
              if (s && y) {
                  for (var a, b, c, d, e, g, q, k, h, l, n, r, t, p, v, C = [], w = [], z = {
                      percent: null,
                      total: null
                  }, J = null, A = 0; A < y.length; A++)
                      v = S[A],
                      v = "undefined" !== typeof v.x5 ? (v.y2 + v.y4) / 2 : (v.y2 + v.y3) / 2,
                      v = f(v).x2 + 1,
                      C[A] = K - v - Z;
                  v = 0.5 * Z;
                  for (var A = 0, B = y.length - 1; A < y.length || 0 <= B; A++,
                  B--) {
                      b = s.reversed ? y[B] : y[A];
                      a = b.color ? b.color : s.reversed ? s._colorSet[(y.length - 1 - A) % s._colorSet.length] : s._colorSet[A % s._colorSet.length];
                      c = b.indexLabelPlacement || s.indexLabelPlacement || "outside";
                      p = b.indexLabelTextAlign || s.indexLabelTextAlign || "left";
                      d = b.indexLabelBackgroundColor || s.indexLabelBackgroundColor || (u ? "transparent" : null);
                      e = b.indexLabelFontColor || s.indexLabelFontColor || "#979797";
                      g = m(b.indexLabelFontSize) ? s.indexLabelFontSize : b.indexLabelFontSize;
                      q = b.indexLabelFontStyle || s.indexLabelFontStyle || "normal";
                      k = b.indexLabelFontFamily || s.indexLabelFontFamily || "arial";
                      h = b.indexLabelFontWeight || s.indexLabelFontWeight || "normal";
                      ...
                      r = "undefined" !== typeof b.indexLabelWrap ? b.indexLabelWrap : "undefined" !== typeof s.indexLabelWrap ? s.indexLabelWrap : !0;
                      t = s.dataPointIds[A];
                      x._eventManager.objectMap[t] = {
                          ...
                          dataPointIndex: A,
                          dataSeriesIndex: 0,
                          funnelSection: S[s.reversed ? y.length - 1 - A : A]
                      };
                      "inside" === s.indexLabelPlacement && (C[A] = A !== ea ? s.reversed ? S[A].x2 - S[A].x1 : S[A].x3 - S[A].x4 : S[A].x3 - S[A].x6,
                      20 > C[A] && (C[A] = A !== ea ? s.reversed ? S[A].x3 - S[A].x4 : S[A].x2 - S[A].x1 : S[A].x2 - S[A].x1,
                      C[A] /= 2));
                      t = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth : C[A];
                      if (t > C[A] || 0 > t)
                          t = C[A];
                      w[A] = "inside" === s.indexLabelPlacement ? r ? Math.max(S[A].height, g) : 1.5 * g : !1;
                      z = x.getPercentAndTotal(s, b);
                      ...
                      b = b.indexLabelFormatter ? b.indexLabelFormatter(J) : b.indexLabel ? x.replaceKeywordsWithValue(b.indexLabel, b, s, A) : s.indexLabelFormatter ? s.indexLabelFormatter(J) : s.indexLabel ? x.replaceKeywordsWithValue(s.indexLabel, b, s, A) : b.label ? b.label : "";
                      0 >= l && (l = 0);
                      1E3 > t && 1E3 - t < v && (t += 1E3 - t);
                      Q.roundRect || Aa(Q);
                      c = new la(Q,{
                          fontSize: g,
                          fontFamily: k,
                          ...
                          backgroundColor: d,
                          maxWidth: t,
                          maxHeight: !1 === w[A] ? r ? 4.28571429 * g : 1.5 * g : w[A],
                          text: b,
                          padding: fa,
                          textBaseline: "middle"
                      });
          ...
          function e() {
              ...
              e = !1;
              c = 0;
              for (var g, q = K - Y - Z / 2, q = s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth > q ? q : s.indexLabelMaxWidth : q, k = G.length - 1; 0 <= k; k--) {
                  g = y[G[k].id];
                  c = G[k];
                  d = c.textBlock;
                  b = (a = r(k) < S.length ? G[r(k)] : null) ? a.textBlock : null;
                  c = c.height;
                  a && d.y + c + fa > b.y && (e = !0);
                  c = g.indexLabelMaxWidth || q;
                  if (c > q || 0 > c)
                      c = q;
                  f.push(c)
              }
              if (e)
                  for (k = G.length - 1; 0 <= k; k--)
                      ...
                      s.reversed ? (G[k].textBlock.y + G[k].height > W + z && (G[k].textBlock.y = W + z - G[k].height),
                      G[k].textBlock.y < va - z && (G[k].textBlock.y = va - z)) : (G[k].textBlock.y < W - z && (G[k].textBlock.y = W - z),
                      G[k].textBlock.y + G[k].height > va + z && (G[k].textBlock.y = va + z - G[k].height))
          }
          function g() {
              var a, b, c, e;
              if ("inside" !== s.indexLabelPlacement)
                  for (var d = 0; d < S.length; d++)
                      0 == G[d].textBlock.text.length ? G[d].isDirty = !0 : (a = S[d],
                      c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                      b = s.reversed ? "undefined" !== typeof a.x5 ? c > X ? f(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < X ? f(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1,
                      G[d].textBlock.x = b + Z,
                      G[d].textBlock.y = c - G[d].height / 2,
                      s.reversed ? (G[d].textBlock.y + G[d].height > W + z && (G[d].textBlock.y = W + z - G[d].height),
                      G[d].textBlock.y < va - z && (G[d].textBlock.y = va - z)) : (G[d].textBlock.y < W - z && (G[d].textBlock.y = W - z),
                      G[d].textBlock.y + G[d].height > va + z && (G[d].textBlock.y = va + z - G[d].height)));
              else
                  for (d = 0; d < S.length; d++)
                      ...
                      c = G[d].height,
                      e = G[d].width,
                      b >= c ? (b = d != ea ? (a.x4 + a.x3) / 2 - e / 2 : (a.x5 + a.x4) / 2 - e / 2,
                      c = d != ea ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2,
                      G[d].textBlock.x = b,
                      G[d].textBlock.y = c) : G[d].isDirty = !0)
          }
          function q() {
              function a(b, c) {
                  var d;
              ...
              function b() {
                  ...
                  for (var q, h = 1; h < k; h++) {
                      ...
                      for (var m = G.length - 1; 0 <= m; m--)
                          !G[m].isDirty && (G[m].textBlock.y < e && G[m].textBlock.y + G[m].height > e) && (q = r(m),
                          !(q >= G.length - 1) && G[m].textBlock.y + G[m].height + fa > G[q].textBlock.y && (G[m].textBlock.y = G[m].textBlock.y + G[m].height - e > e - G[m].textBlock.y ? e + 1 : e - G[m].height - 1))
                  }
                  for (q = S.length - 1; 0 < q; q--)
                      if (!G[q].isDirty) {
                          ...
                          G[e].isDirty))
                              break;
                          if (G[q].textBlock.y < G[e].textBlock.y + G[e].height) {
                              d = d || q;
                              f = q;
                              for (k = 0; G[f].textBlock.y < G[e].textBlock.y + G[e].height + fa; ) {
              ...
              for (var d, e, f, g, k, q, l = 1, m = 0; m < 2 * l; m++) {
                  for (var p = G.length - 1; 0 <= p && !(0 <= n(p) && n(p),
                  f = G[p],
                  g = f.textBlock,
                  q = (k = r(p) < S.length ? G[r(p)] : null) ? k.textBlock : null,
                  d = +f.height.toFixed(6),
                  e = +g.y.toFixed(6),
                  !f.isDirty && (k && e + d + fa > +q.y.toFixed(6)) && (d = g.y + d + fa - q.y,
                  e = a(p, -d),
                  e < d && (0 < e && (d -= e),
                  e = a(r(p), d),
                  e != d))); p--)
          ...
          function h(a, b) {
              return (b < S.length ? G[b].textBlock.y : s.reversed ? W + z : va + z) - (0 > a ? s.reversed ? va - z : W - z : G[a].textBlock.y + G[a].height + fa)
          }
          function p(a, b, c) {
              var d, e, f, q = [], h = z, n = [];
              -1 !== b && (0 <= aa.indexOf(b) ? (e = aa.indexOf(b),
              aa.splice(e, 1)) : (aa.push(b),
              ...
              if (0 === aa.length)
                  ...
                  e = z * (1 != aa.length || 0 != aa[0] && aa[0] != S.length - 1 ? 2 : 1) / k();
                  for (var m = 0; m < S.length; m++) {
                      if (1 == aa.length && 0 == aa[0]) {
                          ...
                          0 === m && (d = -1 * h);
                      q.push(ka[m] + d);
                      if (0 <= aa.indexOf(m) || m < S.length && 0 <= aa.indexOf(m + 1))
                          d += e
                  }
              }
              f = function() {
              ...
              a._animator.animate(0, c, function(c) {
                  ...
                  var e = {};
                  e.dataSeries = s;
                  e.dataPoint = s.reversed ? s.dataPoints[y.length - 1 - b] : s.dataPoints[b];
                  e.index = s.reversed ? y.length - 1 - b : b;
                  a.toolTip.highlightObjects([e]);
                  for (e = 0; e < S.length; e++)
                      ta(d, S[e], s.fillOpacity);
                  J(d);
                  L && ("inside" !== s.indexLabelPlacement ? l(d) : g(),
                  w(d));
                  1 <= c && (ja = !1)
          ...
          function l(a) {
              for (var b, c, d, e, g = 0; g < S.length; g++)
                  e = 1 === G[g].lineThickness % 2 ? 0.5 : 0,
                  c = ((S[g].y2 + S[g].y4) / 2 << 0) + e,
                  b = f(c).x2 - 1,
                  d = G[g].textBlock.x,
                  ...
                  a.setLineDash && a.setLineDash(I(G[g].lineDashType, G[g].lineThickness)),
                  a.beginPath(),
                  a.moveTo(b, c),
                  a.lineTo(d, e),
                  a.stroke())
          ...
          function J(a) {
              ...
              a.roundRect || Aa(a);
              x.title && (x.title.dockInsidePlotArea || "center" === x.title.horizontalAlign && "center" === x.title.verticalAlign) && (x.title.ctx = a,
              x.title.render());
              if (x.subtitles)
              ...
              x.legend && (x.legend.dockInsidePlotArea || "center" === x.legend.horizontalAlign && "center" === x.legend.verticalAlign) && (x.legend.ctx = a,
              x.legend.setLayout(),
              x.legend.render());
              xa.fNg && xa.fNg(x)
          }
          var x = this;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              for (var s = this.data[a.dataSeriesIndexes[0]], y = s.dataPoints, v = this.plotArea, z = 0.025 * v.width, A = 0.01 * v.width, B = 0, D = v.height - 2 * z, E = Math.min(v.width - 2 * A, 2.8 * v.height), L = !1, T = 0; T < y.length; T++)
                  if (!L && ("undefined" !== typeof y[T].indexLabel && null !== y[T].indexLabel && 0 < y[T].indexLabel.toString().length) && (L = !0),
                  !L && ("undefined" !== typeof y[T].label && null !== y[T].label && 0 < y[T].label.toString().length) && (L = !0),
                  !L && "function" === typeof s.indexLabelFormatter || "function" === typeof y[T].indexLabelFormatter)
                      L = !0;
              L = L || "undefined" !== typeof s.indexLabel && null !== s.indexLabel && 0 < s.indexLabel.toString().length;
              "inside" !== s.indexLabelPlacement && L || (A = (v.width - 0.75 * E) / 2);
              var T = v.x1 + A
                , K = v.x2 - A
                , N = v.y1 + z
                , P = v.y2 - z
              ...
              if (0 != s.length && (s.dataPoints && s.visible) && 0 !== y.length) {
                  ...
                  a = 75 * E / 100;
                  var Z = 30 * (K - a) / 100;
                  "funnel" === s.type ? (R = m(s.options.neckHeight) ? 0.35 * D : s.neckHeight,
                  F = m(s.options.neckWidth) ? 0.25 * a : s.neckWidth,
                  "string" === typeof R && R.match(/%$/) ? (R = parseInt(R),
                  R = R * D / 100) : R = parseInt(R),
                  "string" === typeof F && F.match(/%$/) ? (F = parseInt(F),
                  F = F * a / 100) : F = parseInt(F),
                  R > D ? R = D : 0 >= R && (R = 0),
                  F > a ? F = a - 0.5 : 0 >= F && (F = 0)) : "pyramid" === s.type && (F = R = 0,
                  ...
                  var A = T + a / 2
                    ...
                    , M = A - F / 2
                    , $ = A + F / 2
                    , X = s.reversed ? N + R : P - R
                    , va = s.reversed ? N : P;
                  a = [];
                  var A = [], S = [], E = [], ba = N, ea, da = (X - W) / (M - U), ga = -da, T = "area" === (s.valueRepresents ? s.valueRepresents : "height") ? c() : d();
                  if (-1 !== T) {
                      if (s.reversed)
                          for (E.push(ba),
                          F = T.length - 1; 0 < F; F--)
                      ...
                      if (s.reversed)
                          for (F = 0; F < T.length; F++)
                              E[F] < X ? (a.push(M),
                              A.push($),
                              ea = F) : (a.push((E[F] - W + da * U) / da),
                              A.push((E[F] - W + ga * Y) / ga));
                      else
                          for (F = 0; F < T.length; F++)
                              E[F] < X ? (a.push((E[F] - W + da * U) / da),
                              A.push((E[F] - W + ga * Y) / ga),
                              ea = F) : (a.push(M),
                              A.push($));
                      for (F = 0; F < T.length - 1; F++)
                          ba = s.reversed ? y[y.length - 1 - F].color ? y[y.length - 1 - F].color : s._colorSet[(y.length - 1 - F) % s._colorSet.length] : y[F].color ? y[F].color : s._colorSet[F % s._colorSet.length],
                          F === ea ? S.push({
                              x1: a[F],
                              y1: E[F],
                              x2: A[F],
                      ...
                      for (F = 0; F < y.length; F++)
                          y[F].exploded && (T = !0,
                          s.reversed ? aa.push(y.length - 1 - F) : aa.push(F));
                      ...
                      for (F = 0; F < S.length; F++)
                          B = S[F],
                          ta(Q, B, s.fillOpacity),
                          ka.push(B.y1);
                      J(Q);
                      L && s.visible && ("inside" === s.indexLabelPlacement || x.animationEnabled || l(Q),
                      x.animationEnabled || w());
                      if (!L)
                          for (F = 0; F < y.length; F++)
                              B = s.dataPointIds[F],
                              a = {
                                  ...
                                  dataPointIndex: F,
                                  dataSeriesIndex: 0,
                                  funnelSection: S[s.reversed ? y.length - 1 - F : F]
                              },
                              x._eventManager.objectMap[B] = a;
                      !x.animationEnabled && T ? p(x, -1, 0) : x.animationEnabled && !x.animatedRender && p(x, -1, 0);
                      this.funnelPyramidClickHandler = function(a) {
                          var b = -1;
                          if (!ja && !x.isAnimating && (m(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = s.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex,
                          0 <= b)) {
                              a = b;
                              if ("funnel" === s.type || "pyramid" === s.type)
                                  s.reversed ? y[y.length - 1 - a].exploded = y[y.length - 1 - a].exploded ? !1 : !0 : y[a].exploded = y[a].exploded ? !1 : !0;
                              p(x, b, 500)
                          }
                      }
                      ;
      ...
      p.prototype.set = function(a, d, c) {
          ...
          c && this.render()) : p.base.set.call(this, a, d, c)
      }
      ;
      p.prototype.exportChart = function(a) {
          ...
          if (b && d && c) {
              ...
              if ("undefined" !== typeof Blob && new Blob) {
                  for (var q = b.replace(/^data:[a-z\/]*;base64,/, ""), q = atob(q), h = new ArrayBuffer(q.length), h = new Uint8Array(h), m = 0; m < q.length; m++)
                      h[m] = q.charCodeAt(m);
                  d = new Blob([h.buffer],{
                      type: "image/" + d
                  });
                  try {
                      ...
                      g.dataset.downloadurl = [a, g.download, g.href].join(":"),
                      g.href = window.URL.createObjectURL(d)
                  }
              }
              if (!e)
                  try {
                      ...
                      g.dispatchEvent ? g.dispatchEvent(event) : g.fireEvent && g.fireEvent("onclick")
                  } catch (l) {
                      d = window.open(),
      ...
      p.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
          ...
          if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
              var q = "#percent"
                ...
                , q = isNaN(m.percent) ? q : m.percent;
              do {
                  m = "";
                  if (c.percentFormatString)
                      m = c.percentFormatString;
                  else {
                      var m = "#,##0."
                  ...
                  a = a.replace("#percent", ga(q, m, g._cultureInfo));
                  a = a.replace("#total", ga(h, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", g._cultureInfo))
          ...
          return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
              ...
              try {
                  var f = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                  f && 0 < f.length && (k = Ha(f[2]),
                  a = Ha(f[1]))
              } catch (q) {}
              f = null;
              if ("color" === a)
                  return "waterfall" === c.type ? d.color ? d.color : 0 < d.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[k % c._colorSet.length] : d.color ? d.color : c.color ? c.color : c._colorSet[b % c._colorSet.length];
      ...
      E.prototype.setLayout = function() {
          var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart
            ...
            , g = 0
            , q = 0
            , h = this.markerMargin = this.chart.options.legend && !m(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
          this.height = 0;
          var p = []
            , k = [];
          if ("top" === this.verticalAlign || "bottom" === this.verticalAlign)
              ...
              q = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height;
              ...
              if (n.dataPoints && n.dataPoints.length)
                  if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                      var r = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ? "error" === n.type && n._linkedSeries ? n._linkedSeries.legendMarkerType ? n._linkedSeries.legendMarkerType : R.getDefaultLegendMarker(n._linkedSeries.type) : R.getDefaultLegendMarker(n.type) : n.markerType
                        , f = n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                          chart: this.chart,
                          legend: this.options,
                          dataSeries: n,
                          dataPoint: null
                      }) : n.name
                        , u = n.legendMarkerColor = n.legendMarkerColor ? n.legendMarkerColor : n.markerColor ? n.markerColor : "error" === n.type ? m(n.whiskerColor) ? n._colorSet[0] : n.whiskerColor : n._colorSet[0]
                      ...
                      "error" === n.type && this.errorMarkerColor.push(u);
                      ...
                      for (var y = 0; y < n.dataPoints.length; y++) {
                          var v = n.dataPoints[y]
                            , r = v.legendMarkerType ? v.legendMarkerType : n.legendMarkerType ? n.legendMarkerType : R.getDefaultLegendMarker(n.type)
                            , f = v.legendText ? v.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                              chart: this.chart,
                              legend: this.options,
                              dataSeries: n,
                              dataPoint: v
                          }) : v.name ? v.name : "DataPoint: " + (y + 1)
                            , u = v.legendMarkerColor ? v.legendMarkerColor : n.legendMarkerColor ? n.legendMarkerColor : v.color ? v.color : n.color ? n.color : n._colorSet[y % n._colorSet.length]
                            , w = 0.75 * this.lineHeight
                            , x = v.legendMarkerBorderColor ? v.legendMarkerBorderColor : n.legendMarkerBorderColor ? n.legendMarkerBorderColor : v.markerBorderColor ? v.markerBorderColor : n.markerBorderColor
                            , s = v.legendMarkerBorderThickness ? v.legendMarkerBorderThickness : n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness : v.markerBorderThickness || n.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0
                            , f = this.chart.replaceKeywordsWithValue(f, v, n, y)
                            , r = {
                              markerType: r,
                              markerColor: u,
                              text: f,
                          ...
                          (v.showInLegend || n.showInLegend && !1 !== v.showInLegend) && p.push(r)
                      }
          }
          ...
          if (0 < p.length) {
              ...
              v = (this.itemMaxWidth ? this.itemMaxWidth : v) - (w + h);
              for (l = 0; l < p.length; l++) {
                  r = p[l];
                  u = v;
                  if ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType)
                      u -= 2 * 0.1 * this.lineHeight;
                  if (!(0 >= q || "undefined" === typeof q || 0 >= u || "undefined" === typeof u))
                      if ("horizontal" === this.orientation) {
                          r.textBlock = new la(this.ctx,{
                              x: 0,
                              y: 0,
                              maxWidth: u,
                          ...
                          if (!n || n.width + Math.round(r.textBlock.width + w + h + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g)
                              n = {
                                  items: [],
                                  width: 0
                              },
                          ...
                          r.textBlock.y = 0;
                          n.width += Math.round(r.textBlock.width + w + h + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0));
                          n.items.push(r);
                          ...
                          r.textBlock.measureText(),
                          null !== this.itemWidth && (r.textBlock.width = this.itemWidth - (w + h + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                          this.height < q - this.lineHeight ? (n = {
                              items: [],
                              width: 0
                          },
                          k.push(n)) : (n = k[y],
                          y = (y + 1) % k.length),
                          n && (this.height += r.textBlock.height ? r.textBlock.height : this.lineHeight,
                          r.textBlock.x = n.width,
                          r.textBlock.y = 0,
                          n.width += Math.round(r.textBlock.width + w + h + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0)),
                          n.items.push(r),
          ...
          this.markerSize = w;
          this.rows = k;
          0 < p.length && a.layoutManager.registerSpace(c, {
      ...
      E.prototype.render = function() {
          ...
          for (var h = 0, m = 0; m < q.length; m++) {
              for (var k = q[m], l = 0, n = 0; n < k.items.length; n++) {
                  var r = k.items[n]
                    , f = r.textBlock.x + a + (0 === n ? 0.2 * g : this.horizontalSpacing)
                    , p = d + h
                    , u = f;
                  ...
                  X.drawMarker(f + g / 2, p + this.lineHeight / 2, this.ctx, r.markerType, "error" === r.chartType || "line" === r.chartType || "spline" === r.chartType ? r.markerSize / 2 : r.markerSize, r.markerColor, r.markerBorderColor, r.markerBorderThickness);
                  r.textBlock.x = f + c + g;
                  if ("line" === r.chartType || "stepLine" === r.chartType || "spline" === r.chartType)
                      r.textBlock.x += 0.1 * this.lineHeight;
                  r.textBlock.y = Math.round(p + this.lineHeight / 2);
                  ...
                  this.ghostCtx.fillRect(u, r.textBlock.y - this.lineHeight / 2, r.textBlock.x + r.textBlock.width - u, r.textBlock.height ? r.textBlock.height : this.lineHeight);
                  r.x1 = this.chart._eventManager.objectMap[r.id].x1 = u;
      ...
      ;
      R.prototype.getDataPointAtX = function(a, d) {
          ...
          var c = {
            ...
            , k = 0
            , l = 0;
          "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (l = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
          l = 1 < l ? Math.min(Math.max((this.dataPoints.length - 1) / l * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (l = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
      ...
      ;
      R.prototype.getDataPointAtXY = function(a, d, c) {
          ...
          if ("none" !== this.chart.plotInfo.axisPlacement)
              ...
              this.axisX.logarithmic)
                  var r = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x)
                    , n = 1 < r ? Math.min(Math.max((this.dataPoints.length - 1) / r * Math.log(n / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
              else
                  r = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
                  n = 0 < r ? Math.min(Math.max((this.dataPoints.length - 1) / r * (n - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
          for (; ; ) {
              g = 0 < q ? n + e : n - e;
              if (0 <= g && g < this.dataPoints.length) {
                  var r = this.chart._eventManager.objectMap[this.dataPointIds[g]]
                    , f = this.dataPoints[g]
                    , u = null;
                  if (r) {
                      switch (this.type) {
                      ...
                      case "waterfall":
                      case "error":
                          a >= r.x1 && (a <= r.x2 && d >= r.y1 && d <= r.y2) && (b.push({
                              dataPoint: f,
                              dataPointIndex: g,
                              dataSeries: this,
                              distance: Math.min(Math.abs(r.x1 - a), Math.abs(r.x2 - a), Math.abs(r.y1 - d), Math.abs(r.y2 - d))
                          }),
                          h = !0);
                          break;
                      case "line":
                      ...
                      case "splineArea":
                      case "scatter":
                          var w = oa("markerSize", f, this) || 4
                            , x = c ? 20 : w
                            , u = Math.sqrt(Math.pow(r.x1 - a, 2) + Math.pow(r.y1 - d, 2));
                          u <= x && b.push({
                              dataPoint: f,
                              dataPointIndex: g,
                              dataSeries: this,
                      ...
                      case "rangeSplineArea":
                          w = oa("markerSize", f, this) || 4;
                          x = c ? 20 : w;
                          u = Math.min(Math.sqrt(Math.pow(r.x1 - a, 2) + Math.pow(r.y1 - d, 2)), Math.sqrt(Math.pow(r.x1 - a, 2) + Math.pow(r.y2 - d, 2)));
                          u <= x && b.push({
                              dataPoint: f,
                              dataPointIndex: g,
                              dataSeries: this,
                      ...
                      case "doughnut":
                          ...
                          u = Math.sqrt(Math.pow(w.x - a, 2) + Math.pow(w.y - d, 2));
                          u < r.radius && u > x && (u = Math.atan2(d - w.y, a - w.x),
                          0 > u && (u += 2 * Math.PI),
                          u = Number(((180 * (u / Math.PI) % 360 + 360) % 360).toFixed(12)),
                          w = Number(((180 * (r.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                          x = Number(((180 * (r.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                          0 === x && 1 < r.endAngle && (x = 360),
                          w >= x && (0 !== f.y && !m(f.y)) && (x += 360,
                          u < w && (u += 360)),
                          u > w && u < x && (b.push({
                              dataPoint: f,
                              dataPointIndex: g,
                      ...
                      case "pyramid":
                          u = r.funnelSection;
                          d > u.y1 && d < u.y4 && (u.y6 ? d > u.y6 ? (g = u.x6 + (u.x5 - u.x6) / (u.y5 - u.y6) * (d - u.y6),
                          u = u.x3 + (u.x4 - u.x3) / (u.y4 - u.y3) * (d - u.y3)) : (g = u.x1 + (u.x6 - u.x1) / (u.y6 - u.y1) * (d - u.y1),
                          u = u.x2 + (u.x3 - u.x2) / (u.y3 - u.y2) * (d - u.y2)) : (g = u.x1 + (u.x4 - u.x1) / (u.y4 - u.y1) * (d - u.y1),
                          u = u.x2 + (u.x3 - u.x2) / (u.y3 - u.y2) * (d - u.y2)),
                          a > g && a < u && (b.push({
                              dataPoint: f,
                              dataPointIndex: r.dataPointIndex,
                              dataSeries: this,
                      ...
                      case "boxAndWhisker":
                          if (a >= r.x1 - r.borderThickness / 2 && a <= r.x2 + r.borderThickness / 2 && d >= r.y4 - r.borderThickness / 2 && d <= r.y1 + r.borderThickness / 2 || Math.abs(r.x2 - a + r.x1 - a) < r.borderThickness && d >= r.y1 && d <= r.y4)
                              b.push({
                                  ...
                                  dataPointIndex: g,
                                  dataSeries: this,
                                  distance: Math.min(Math.abs(r.x1 - a), Math.abs(r.x2 - a), Math.abs(r.y2 - d), Math.abs(r.y3 - d))
                              }),
                              h = !0;
                          break;
                      case "candlestick":
      ...
      ;
      R.prototype.getMarkerProperties = function(a, d, c, b) {
          var e = this.dataPoints
            , g = e[a].markerColor ? e[a].markerColor : this.markerColor ? this.markerColor : e[a].color ? e[a].color : this.color ? this.color : this._colorSet[a % this._colorSet.length]
            , q = e[a].markerBorderColor ? e[a].markerBorderColor : this.markerBorderColor ? this.markerBorderColor : null
            , h = m(e[a].markerBorderThickness) ? this.markerBorderThickness ? this.markerBorderThickness : null : e[a].markerBorderThickness
      ...
      D.prototype.createLabels = function() {
          var a, d, c = 0, b = 0, e, g = 0, q = 0, b = 0, b = this.interval, h = 0, p, k = 0.6 * this.chart.height, l;
          a = !1;
          var n = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : []
            , r = n.length ? m(this.scaleBreaks.firstBreakIndex) ? 0 : this.scaleBreaks.firstBreakIndex : 0;
          if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
              e = this.viewportMaximum;
              if (this.labels) {
                  a = Math.ceil(b);
                  for (var b = Math.ceil(this.intervalStartPosition), f = !1, c = b; c < this.viewportMaximum; c += a)
                      if (this.labels[c])
                          f = !0;
                      else {
                          f = !1;
              ...
              if (this.logarithmic && !this.equidistantInterval)
                  ...
                  b = 0,
                  f = r; b < this.logLabelValues.length; b++)
                      ...
                      c < this.viewportMinimum)
                          ...
                          }) : "axisX" === this.type && this.labels[l] ? this.labels[l] : ga(l, this.valueFormatString, this.chart._cultureInfo),
                          a = new la(this.ctx,{
                              x: 0,
                              y: 0,
                              maxWidth: g,
              ...
              f = r,
              c = this.intervalStartPosition; c < e; Xa(c, b, this.intervalType)) {
                  ...
                  a || (a = this.labelFormatter ? this.labelFormatter({
                      ...
                      value: new Date(l),
                      label: this.labels[l] ? this.labels[l] : null
                  }) : "axisX" === this.type && this.labels[l] ? this.labels[l] : Da(l, this.valueFormatString, this.chart._cultureInfo),
                  a = new la(this.ctx,{
                      x: 0,
                      y: 0,
                      maxWidth: g,
          ...
          if ("bottom" === this._position || "top" === this._position)
              ...
              q = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
          ...
          if (this.labelAutoFit || this.options.labelAutoFit)
              if (m(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360,
              90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)),
                  ...
                  !this.chart.panEnabled && 1 <= this._labels.length) {
                      ...
                      for (c = 0; c < this._labels.length; c++)
                          if (!this._labels[c].breaksLabelType) {
                              ...
                              for (var z, f = a.text.split(" "), b = 0; b < f.length; b++)
                                  l = f[b],
                      ...
                      for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                          if (!this._labels[c].breaksLabelType) {
                              ...
                              if (m(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                  if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? q : Math.min((b - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b),
                                  l = (k - (p + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)),
                                  !m(this.options.labelWrap))
                                      this.labelWrap ? m(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, r), l),
                                      this.sessionVariables.labelWrap = this.labelWrap,
                                      d && w.width + d.width >> 0 > 2 * g && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                      this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                      this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > g ? -25 : this.sessionVariables.labelAngle) : m(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                                      this.sessionVariables.labelMaxHeight = q,
                                      this.sessionVariables.labelMaxWidth = g,
                                      d && w.width + d.width >> 0 > 2 * g && (this.sessionVariables.labelAngle = -25,
                                      this.sessionVariables.labelMaxWidth = l)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > g ? -25 : this.sessionVariables.labelAngle,
                                      this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                      this.sessionVariables.labelMaxHeight = q,
                                      this.sessionVariables.labelWrap = this.labelWrap);
                                  else {
                                      if (m(this.options.labelWrap))
                                          if (!m(this.options.labelMaxWidth))
                                              ...
                                              if (b = w.width + d.width >> 0,
                                              f = this.labelFontSize,
                                              r < g)
                                                  b - 2 * g > n && (n = b - 2 * g,
                                                  b >= 2 * g && b < 2.2 * g ? (this.sessionVariables.labelMaxWidth = g,
                                                  m(this.options.labelFontSize) && 12 < f && (f = Math.floor(12 / 13 * f),
                                                  a.measureText()),
                                                  this.sessionVariables.labelFontSize = m(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  this.sessionVariables.labelAngle = this.labelAngle) : b >= 2.2 * g && b < 2.8 * g ? (this.sessionVariables.labelAngle = -25,
                                                  this.sessionVariables.labelMaxWidth = l,
                                                  this.sessionVariables.labelFontSize = f) : b >= 2.8 * g && b < 3.2 * g ? (this.sessionVariables.labelMaxWidth = Math.max(g, r),
                                                  this.sessionVariables.labelWrap = !0,
                                                  m(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                                  a.measureText()),
                                                  this.sessionVariables.labelFontSize = m(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * g && b < 3.6 * g ? (this.sessionVariables.labelAngle = -25,
                                                  this.sessionVariables.labelWrap = !0,
                                                  this.sessionVariables.labelMaxWidth = l,
                                                  this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * g && b < 5 * g ? (m(this.options.labelFontSize) && 12 < f && (f = Math.floor(12 / 13 * f),
                                                  a.measureText()),
                                                  this.sessionVariables.labelFontSize = m(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  this.sessionVariables.labelWrap = !0,
                                                  this.sessionVariables.labelAngle = -25,
                                                  this.sessionVariables.labelMaxWidth = l) : b > 5 * g && (this.sessionVariables.labelWrap = !0,
                                                  this.sessionVariables.labelMaxWidth = g,
                                                  this.sessionVariables.labelFontSize = f,
                                                  this.sessionVariables.labelMaxHeight = q,
                                                  this.sessionVariables.labelAngle = this.labelAngle));
                                              else if (z === c && (0 === z && r + this._labels[z + 1].textBlock.measureText().width - 2 * g > n || z === this._labels.length - 1 && r + this._labels[z - 1].textBlock.measureText().width - 2 * g > n || 0 < z && z < this._labels.length - 1 && r + this._labels[z + 1].textBlock.measureText().width - 2 * g > n && r + this._labels[z - 1].textBlock.measureText().width - 2 * g > n))
                                                  n = 0 === z ? r + this._labels[z + 1].textBlock.measureText().width - 2 * g : r + this._labels[z - 1].textBlock.measureText().width - 2 * g,
                                                  this.sessionVariables.labelFontSize = m(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  this.sessionVariables.labelWrap = !0,
                                                  this.sessionVariables.labelAngle = -25,
                                                  this.sessionVariables.labelMaxWidth = l;
                                              else if (0 === n)
                                                  for (this.sessionVariables.labelFontSize = m(this.options.labelFontSize) ? f : this.options.labelFontSize,
                                                  this.sessionVariables.labelWrap = !0,
                                                  b = 0; b < this._labels.length; b++)
                                                      a = this._labels[b].textBlock,
                                                      a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, r), l),
                                                      w = a.measureText(),
                                                      b < this._labels.length - 1 && (f = b + 1,
                                                      d = this._labels[f].textBlock,
                                                      d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, r), l),
                                                      d = d.measureText(),
                                                      w.width + d.width >> 0 > 2 * g && (this.sessionVariables.labelAngle = -25))
                                  }
                              else
                                  (this.sessionVariables.labelAngle = this.labelAngle,
                                  this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? q : Math.min((b - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b),
                                  l = 0 != this.labelAngle ? (k - (p + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) : g,
                                  this.sessionVariables.labelMaxHeight = this.labelWrap ? (k - l * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) : 1.5 * this.labelFontSize,
                                  m(this.options.labelWrap)) ? m(this.options.labelWrap) && (this.labelWrap && !m(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                                  this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : l,
                                  this.sessionVariables.labelMaxHeight = q) : (this.sessionVariables.labelAngle = this.labelAngle,
                                  this.sessionVariables.labelMaxWidth = l,
                                  ...
                                  this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : l) : (m(this.options.labelMaxWidth),
                                  this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : l,
                                  this.sessionVariables.labelWrap = this.labelWrap),
                                  this.sessionVariables.labelMaxHeight = q)
                          }
                      ...
                      for (c = 0; c < this._labels.length; c++)
                          a = this._labels[c].textBlock,
                          a.maxWidth = this.labelMaxWidth = m(this.options.labelMaxWidth) ? m(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = g : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth,
                          a.fontSize = this.labelFontSize = m(this.options.labelFontSize) ? m(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize,
                          a.angle = this.labelAngle = m(this.options.labelAngle) ? m(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle,
                          a.wrap = this.labelWrap = m(this.options.labelWrap) ? m(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap,
                          a.maxHeight = m(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = q : this.sessionVariables.labelMaxHeight,
                          a.measureText();
              else if ("left" === this._position || "right" === this._position)
                  if (g = m(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth,
                  q = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                  !this.chart.panEnabled && 1 <= this._labels.length) {
                      this.sessionVariables.labelFontSize = this.labelFontSize;
                      this.sessionVariables.labelMaxWidth = g;
                      ...
                      for (c = 0; c < this._labels.length; c++)
                          if (!this._labels[c].breaksLabelType) {
                              ...
                              Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                              Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                              m(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? m(this.options.labelWrap) ? m(this.options.labelWrap) && (m(this.options.labelMaxWidth) ? m(d) || (h = w.height + d.height >> 0,
                              h - 2 * q > r && (r = h - 2 * q,
                              h >= 2 * q && h < 2.4 * q ? (m(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                              a.measureText()),
                              this.sessionVariables.labelMaxHeight = q,
                              this.sessionVariables.labelFontSize = m(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : h >= 2.4 * q && h < 2.8 * q ? (this.sessionVariables.labelMaxHeight = b,
                              this.sessionVariables.labelFontSize = this.labelFontSize,
                              this.sessionVariables.labelWrap = !0) : h >= 2.8 * q && h < 3.2 * q ? (this.sessionVariables.labelMaxHeight = q,
                              this.sessionVariables.labelWrap = !0,
                              m(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                              a.measureText()),
                              this.sessionVariables.labelFontSize = m(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                              this.sessionVariables.labelAngle = m(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h >= 3.2 * q && h < 3.6 * q ? (this.sessionVariables.labelMaxHeight = b,
                              this.sessionVariables.labelWrap = !0,
                              this.sessionVariables.labelFontSize = this.labelFontSize) : h > 3.6 * q && h < 10 * q ? (m(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                              a.measureText()),
                              this.sessionVariables.labelFontSize = m(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                              this.sessionVariables.labelMaxWidth = g,
                              this.sessionVariables.labelMaxHeight = q,
                              this.sessionVariables.labelAngle = m(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h > 10 * q && h < 50 * q && (m(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                              a.measureText()),
                              this.sessionVariables.labelFontSize = m(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                              this.sessionVariables.labelMaxHeight = q,
                              this.sessionVariables.labelMaxWidth = g,
                              this.sessionVariables.labelAngle = m(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = q,
                              this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : g,
                              this.sessionVariables.labelMaxHeight = q) : (this.sessionVariables.labelAngle = this.labelAngle,
                              this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? g : Math.min((b - q * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), q),
                              m(this.options.labelWrap)) ? m(this.options.labelWrap) && (this.labelWrap && !m(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth,
                              this.sessionVariables.labelWrap = this.labelWrap,
                              this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : g,
                              this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? q : b,
                              m(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? q : b,
                              this.sessionVariables.labelWrap = this.labelWrap,
                              this.sessionVariables.labelMaxWidth = g) : (this.sessionVariables.labelMaxHeight = q,
          ...
          for (c = 0; c < this.stripLines.length; c++) {
              ...
              if ("outside" === g.labelPlacement) {
                  ...
                  q = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0,
                  x = m(g.options.labelWrap) || g.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                  m(g.labelBackgroundColor) && (m(g.startValue) && 0 !== g.startValue ? g.labelBackgroundColor = u ? "transparent" : null : g.labelBackgroundColor = "#EEEEEE");
              a = new la(this.ctx,{
                  x: 0,
                  y: 0,
                  ...
                  maxWidth: g.options.labelMaxWidth ? g.options.labelMaxWidth : q,
                  maxHeight: x,
                  angle: this.labelAngle,
      ...
      D.prototype.createLabelsAndCalculateWidth = function() {
          ...
          if ("left" === this._position || "right" === this._position) {
              ...
              if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index)
                  for (d = 0; d < this._labels.length; d++) {
                      var b = this._labels[d].textBlock
                        , e = b.measureText()
                        , g = 0
                        , g = 0 === this.labelAngle ? e.width : e.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - b.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
              ...
              for (d = 0; d < this._stripLineLabels.length; d++)
                  ...
                  a < g && (a = g),
                  this.stripLineLabelEffectiveWidth = this._stripLineLabels[d].effectiveWidth = g)
          }
      ...
      D.prototype.createLabelsAndCalculateHeight = function() {
          ...
          if ("bottom" === this._position || "top" === this._position) {
              ...
              for (c = 0; c < this._stripLineLabels.length; c++)
                  ...
                  "inside" === this.labelPlacement && (a += 0 < this._index ? g : 0),
                  a < g && (a = g),
                  this.stripLineLabelEffectiveHeight = this._stripLineLabels[c].effectiveHeight = g)
          }
      ...
      D.setLayout = function(a, d, c, b, e, g) {
          var q, h, p, k, l = a[0] ? a[0].chart : d[0].chart, n = l.isNavigator ? 0 : 10, r = l._axes;
          if (a && 0 < a.length)
          ...
          for (f = 0; f < r.length; f++)
              if (r[f] && r[f].scaleBreaks && r[f].scaleBreaks._appliedBreaks.length)
                  for (var u = r[f].scaleBreaks._appliedBreaks, w = 0; w < u.length && !(u[w].startValue > r[f].viewportMaximum); w++)
                      u[w].endValue < r[f].viewportMinimum || (m(r[f].scaleBreaks.firstBreakIndex) && (r[f].scaleBreaks.firstBreakIndex = w),
                      u[w].startValue >= r[f].viewPortMinimum && (r[f].scaleBreaks.lastBreakIndex = w));
          for (var x = w = 0, s = 0, y = 0, v = 0, z = 0, A = 0, B, D, E = h = 0, I, K, N, u = I = K = N = !1, f = 0; f < r.length; f++)
          ...
          for (f = 0; f < r.length; f++)
              if (r[f].title)
                  ...
                  case "right":
                      ...
                      break;
                  default:
                      r[f]._titleTextBlock.maxWidth = r[f].titleMaxWidth || g.width,
                      r[f]._titleTextBlock.maxHeight = r[f].titleWrap ? 0.8 * g.height : 1.5 * r[f].titleFontSize,
                      r[f]._titleTextBlock.angle = 0
                  }
          if ("normal" === e) {
              for (var y = [], v = [], z = [], A = [], O = [], R = [], P = [], Q = []; 4 > w; ) {
                  var F = 0
                    , Z = 0
                    , U = 0
                    , W = 0
                  ...
                  if (c && 0 < c.length)
                      ...
                      f = S = 0; f < c.length; f++)
                          ...
                          S += z[f],
                          M += c[f] && !l.isNavigator ? c[f].margin : 0;
                  else
                  ...
                  p = Math.round(g.x2 - ba - aa > l.width - n ? l.width - n : g.x2 - ba - aa);
                  if (a && 0 < a.length)
                      for (y = [],
                      f = X = 0; f < a.length; f++)
                          a[f] && (a[f].lineCoordinates = {}),
                          a[f].lineCoordinates.width = Math.abs(p - q),
                          ...
                          y.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateHeight() : 0)),
                          X += y[f],
                  ...
                  if (d && 0 < d.length)
                      ...
                      f = $ = 0; f < d.length; f++)
                          ...
                          d[f].lineCoordinates.width = Math.abs(p - q),
                          ...
                          v.push(Math.ceil(d[f] ? d[f].createLabelsAndCalculateHeight() : 0)),
                          $ += v[f],
                          Y += d[f] && !l.isNavigator ? d[f].margin : 0;
                  else
                      v.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                  R.push(v);
                  if (a && 0 < a.length)
                      for (f = 0; f < a.length; f++)
                          a[f] && (a[f].lineCoordinates.x1 = q,
                          p = Math.round(g.x2 - ba - aa > l.width - n ? l.width - n : g.x2 - ba - aa),
                          a[f]._labels && 1 < a[f]._labels.length && (h = k = 0,
                          k = a[f]._labels[1],
                          h = "dateTime" === a[f].valueType ? a[f]._labels[a[f]._labels.length - 2] : a[f]._labels[a[f]._labels.length - 1],
                          ...
                          s = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))),
                          !a[f] || (!a[f].labelAutoFit || m(B) || m(D) || l.isNavigator || l.stockChart) || (h = 0,
                          0 < a[f].labelAngle ? D + s > p && (h += 0 < a[f].labelAngle ? D + s - p - ba : 0) : 0 > a[f].labelAngle ? B - x < q && B - x < a[f].viewportMinimum && (E = q - (M + a[f].tickLength + z + B - x + a[f].labelFontSize / 2)) : 0 === a[f].labelAngle && (D + s > p && (h = D + s / 2 - p - ba),
                          B - x < q && B - x < a[f].viewportMinimum && (E = q - M - a[f].tickLength - z - B + x / 2)),
                          a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 < a[f].labelAngle && 0 < h ? p -= h : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 > a[f].labelAngle && 0 < E ? q += E : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 === a[f].labelAngle && (0 < E && (q += E),
                          0 < h && (p -= h))),
                          l.panEnabled ? X = m(l.sessionVariables.axisX.height) ? l.sessionVariables.axisX.height = X : l.sessionVariables.axisX.height : l.sessionVariables.axisX.height = X,
                          h = Math.round(g.y2 - X - e + F),
                          k = Math.round(g.y2),
                          a[f].lineCoordinates.x2 = p,
                          a[f].lineCoordinates.width = p - q,
                          a[f].lineCoordinates.y1 = h,
                          a[f].lineCoordinates.y2 = h,
                          "inside" === a[f].labelPlacement && 0 < f && (a[f].lineCoordinates.y1 = a[f - 1].lineCoordinates.y2 + F + (a[f].labelEffectiveHeight || 0),
                          a[f].lineCoordinates.y2 = a[f].lineCoordinates.y1 + a[f].lineThickness / 2),
                          "inside" === a[f].tickPlacement && 0 < f && (a[f].lineCoordinates.y1 += a[f].tickLength,
                          a[f].lineCoordinates.y2 = a[f].lineCoordinates.y1 + a[f].lineThickness / 2),
                          a[f].bounds = {
                              x1: q,
                              y1: h,
                  ...
                  if (d && 0 < d.length)
                      for (f = 0; f < d.length; f++)
                          d[f].lineCoordinates.x1 = Math.round(g.x1 + S + M),
                          d[f].lineCoordinates.x2 = Math.round(g.x2 - ba - aa > l.width - n ? l.width - n : g.x2 - ba - aa),
                          d[f].lineCoordinates.width = Math.abs(p - q),
                          d[f]._labels && 1 < d[f]._labels.length && (k = d[f]._labels[1],
                          h = "dateTime" === d[f].valueType ? d[f]._labels[d[f]._labels.length - 2] : d[f]._labels[d[f]._labels.length - 1],
                          x = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)),
                          s = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))),
                          l.panEnabled ? $ = m(l.sessionVariables.axisX2.height) ? l.sessionVariables.axisX2.height = $ : l.sessionVariables.axisX2.height : l.sessionVariables.axisX2.height = $,
                          h = Math.round(g.y1),
                          k = d[f].lineCoordinates.y1 = h + $ + Y - Z,
                          d[f].lineCoordinates.y2 = h,
                          "inside" === d[f].labelPlacement && 0 < f && (d[f].lineCoordinates.y1 = d[f - 1].lineCoordinates.y1 - Z - (d[f].labelEffectiveHeight || 0)),
                          "inside" === d[f].tickPlacement && 0 < f && (d[f].lineCoordinates.y1 -= d[f].tickLength),
                          d[f].bounds = {
                              x1: q,
                              y1: h + ($ + Y - v[f] - Z),
                              x2: p,
                          ...
                          d[f].bounds.height = d[f].bounds.y2 - d[f].bounds.y1,
                          Z += v[f] + d[f].margin;
                  if (c && 0 < c.length)
                      for (f = 0; f < c.length; f++)
                          M = l.isNavigator ? 0 : 10,
                          c[f] && (q = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1),
                          M = c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[c[f]._labels.length - 1].textBlock.height / 2 : n,
                          h = Math.round(g.y1 + $ + Y < Math.max(M, n) ? Math.max(M, n) : g.y1 + $ + Y),
                          p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1),
                          M = 0 < a.length ? 0 : c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[0].textBlock.height / 2 : n,
                          k = Math.round(g.y2 - X - e - M),
                          c[f].lineCoordinates = {
                              x1: q - U,
                              y1: h,
                              x2: p - U,
                          ...
                          "inside" === c[f].labelPlacement && 0 < f && (c[f].lineCoordinates.x1 = c[f - 1].lineCoordinates.x1 - U - (c[f].labelEffectiveWidth || 0),
                          c[f].lineCoordinates.x2 = c[f].lineCoordinates.x1 + c[f].lineThickness / 2),
                          "inside" === c[f].tickPlacement && 0 < f && (c[f].lineCoordinates.x1 -= c[f].tickLength,
                          c[f].lineCoordinates.x2 = c[f].lineCoordinates.x1 + c[f].lineThickness / 2),
                          c[f].bounds = {
                              x1: q - (z[f] + U),
                              y1: h,
                  ...
                  if (b && 0 < b.length)
                      for (f = 0; f < b.length; f++)
                          b[f] && (q = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2),
                          p = Math.round(q),
                          M = b[f]._labels && 0 < b[f]._labels.length ? b[f]._labels[b[f]._labels.length - 1].textBlock.height / 2 : 0,
                          h = Math.round(g.y1 + $ + Y < Math.max(M, n) ? Math.max(M, n) : g.y1 + $ + Y),
                          M = 0 < a.length ? 0 : b[f]._labels && 0 < b[f]._labels.length ? b[f]._labels[0].textBlock.height / 2 : 0,
                          k = Math.round(g.y2 - (X + e + M)),
                          b[f].lineCoordinates = {
                              x1: q + W,
                              y1: h,
                          ...
                          "inside" === b[f].labelPlacement && 0 < f && (b[f].lineCoordinates.x1 = b[f - 1].lineCoordinates.x2 + W + (b[f].labelEffectiveWidth || 0),
                          b[f].lineCoordinates.x2 = b[f].lineCoordinates.x1 + b[f].lineThickness / 2),
                          "inside" === b[f].tickPlacement && 0 < f && (b[f].lineCoordinates.x1 += b[f].tickLength,
                          b[f].lineCoordinates.x2 = b[f].lineCoordinates.x1 + b[f].lineThickness / 2),
                          b[f].bounds = {
                              x1: q + W,
                              y1: h,
                  ...
                  if (a && 0 < a.length)
                      for (f = 0; f < a.length; f++)
                          ...
                          a[f]._labels && 1 < a[f]._labels.length && (B = (a[f].logarithmic ? Math.log(a[f]._labels[1].position / a[f].viewportMinimum) / a[f].conversionParameters.lnLogarithmBase : a[f]._labels[1].position - a[f].viewportMinimum) * Math.abs(a[f].conversionParameters.pixelPerUnit) + a[f].lineCoordinates.x1,
                          q = a[f]._labels[a[f]._labels.length - ("dateTime" === a[f].valueType ? 2 : 1)].position,
                          q = a[f].getApparentDifference(a[f].viewportMinimum, q),
                          D = a[f].logarithmic ? (1 < q ? Math.log(q) / a[f].conversionParameters.lnLogarithmBase * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1 : (0 < q ? q * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1));
                  if (d && 0 < d.length)
                      for (f = 0; f < d.length; f++)
                          d[f].calculateValueToPixelConversionParameters(),
                          d[f].calculateBreaksSizeInValues(),
                          d[f]._labels && 1 < d[f]._labels.length && (B = (d[f].logarithmic ? Math.log(d[f]._labels[1].position / d[f].viewportMinimum) / d[f].conversionParameters.lnLogarithmBase : d[f]._labels[1].position - d[f].viewportMinimum) * Math.abs(d[f].conversionParameters.pixelPerUnit) + d[f].lineCoordinates.x1,
                          q = d[f]._labels[d[f]._labels.length - ("dateTime" === d[f].valueType ? 2 : 1)].position,
                          q = d[f].getApparentDifference(d[f].viewportMinimum, q),
                          D = d[f].logarithmic ? (1 < q ? Math.log(q) / d[f].conversionParameters.lnLogarithmBase * Math.abs(d[f].conversionParameters.pixelPerUnit) : 0) + d[f].lineCoordinates.x1 : (0 < q ? q * Math.abs(d[f].conversionParameters.pixelPerUnit) : 0) + d[f].lineCoordinates.x1);
                  for (f = 0; f < r.length; f++)
                      "axisY" === r[f].type && (r[f].calculateValueToPixelConversionParameters(),
              ...
              O = [];
              for (R = []; 4 > w; ) {
                  X = W = U = aa = M = Y = e = Q = P = F = $ = 0;
                  if (a && 0 < a.length)
                      for (E = [],
                      f = W = 0; f < a.length; f++)
                          E.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateWidth() : 0)),
                          W += E[f],
                          e += a[f] && !l.isNavigator ? a[f].margin : 0;
                  else
                  ...
                  if (d && 0 < d.length)
                      for (x = [],
                      f = X = 0; f < d.length; f++)
                          x.push(Math.ceil(d[f] ? d[f].createLabelsAndCalculateWidth() : 0)),
                          X += x[f],
                          Y += d[f] ? d[f].margin : 0;
                  else
                  ...
                  if (c && 0 < c.length)
                      for (f = 0; f < c.length; f++)
                          c[f].lineCoordinates = {},
                          q = Math.round(g.x1 + W + e),
                          p = Math.round(g.x2 - X - Y > l.width - 10 ? l.width - 10 : g.x2 - X - Y),
                          c[f].labelAutoFit && !m(y) && (0 < !a.length && (q = 0 > c[f].labelAngle ? Math.max(q, y) : 0 === c[f].labelAngle ? Math.max(q, y / 2) : q),
                          0 < !d.length && (p = 0 < c[f].labelAngle ? p - v / 2 : 0 === c[f].labelAngle ? p - v / 2 : p)),
                          c[f].lineCoordinates.x1 = q,
                          c[f].lineCoordinates.x2 = p,
                          c[f].lineCoordinates.width = Math.abs(p - q),
                  ...
                  if (b && 0 < b.length)
                      for (f = 0; f < b.length; f++)
                          b[f].lineCoordinates = {},
                          q = Math.round(g.x1 + W + e),
                          p = Math.round(g.x2 - X - Y > b[f].chart.width - 10 ? b[f].chart.width - 10 : g.x2 - X - Y),
                          b[f] && b[f].labelAutoFit && !m(z) && (0 < !a.length && (q = 0 < b[f].labelAngle ? Math.max(q, z) : 0 === b[f].labelAngle ? Math.max(q, z / 2) : q),
                          0 < !d.length && (p -= A / 2)),
                          b[f].lineCoordinates.x1 = q,
                          b[f].lineCoordinates.x2 = p,
                          b[f].lineCoordinates.width = Math.abs(p - q),
                  ...
                  if (c && 0 < c.length)
                      for (n = [],
                      f = U = 0; f < c.length; f++)
                          n.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateHeight() : 0)),
                          U += n[f] + c[f].margin,
                          M += c[f].margin;
                  else
                  ...
                  if (b && 0 < b.length)
                      for (B = [],
                      f = 0; f < b.length; f++)
                          B.push(Math.ceil(b[f] ? b[f].createLabelsAndCalculateHeight() : 0)),
                          aa += b[f].margin;
                  else
                  ...
                  if (c && 0 < c.length)
                      for (f = 0; f < c.length; f++)
                          0 < c[f]._labels.length && (k = c[f]._labels[0],
                          h = c[f]._labels[c[f]._labels.length - 1],
                  ...
                  if (b && 0 < b.length)
                      for (f = 0; f < b.length; f++)
                          b[f] && 0 < b[f]._labels.length && (k = b[f]._labels[0],
                          h = b[f]._labels[b[f]._labels.length - 1],
                  ...
                  if (c && 0 < c.length)
                      for (f = c.length - 1; 0 <= f; f--)
                          h = Math.round(g.y2),
                          k = Math.round(g.y2 > c[f].chart.height ? c[f].chart.height : g.y2),
                          c[f].lineCoordinates.y1 = h - (n[f] + c[f].margin + $),
                          c[f].lineCoordinates.y2 = h - (n[f] + c[f].margin + $),
                          "inside" === c[f].labelPlacement && 0 < f && (c[f].lineCoordinates.y1 = c[f].lineCoordinates.y1 + n[f] - (c[f]._titleTextBlock ? c[f]._titleTextBlock.height : 0) - c[f].tickLength - (c[f].stripLineLabelEffectiveHeight || 0) - 5,
                          c[f].lineCoordinates.y2 = c[f].lineCoordinates.y1 + c[f].lineThickness / 2),
                          "inside" === c[f].tickPlacement && 0 < f && (c[f].lineCoordinates.y1 += c[f].tickLength,
                          c[f].lineCoordinates.y2 = c[f].lineCoordinates.y1 + c[f].lineThickness / 2),
                          c[f].bounds = {
                              x1: q,
                              y1: h - (n[f] + $ + c[f].margin),
                  ...
                  if (b && 0 < b.length)
                      for (f = b.length - 1; 0 <= f; f--)
                          b[f] && (h = Math.round(g.y1),
                          k = Math.round(g.y1 + (B[f] + b[f].margin + F)),
                          b[f].lineCoordinates.y1 = k,
                          b[f].lineCoordinates.y2 = k,
                          "inside" === b[f].labelPlacement && 0 < f && (b[f].lineCoordinates.y1 = k - B[f] + (b[f]._titleTextBlock ? b[f]._titleTextBlock.height : 0) + b[f].tickLength + (b[f].stripLineLabelEffectiveHeight || 0),
                          b[f].lineCoordinates.y2 = b[f].lineCoordinates.y1 - b[f].lineThickness / 2),
                          "inside" === b[f].tickPlacement && 0 < f && (b[f].lineCoordinates.y1 -= b[f].tickLength,
                          b[f].lineCoordinates.y2 = b[f].lineCoordinates.y1 - b[f].lineThickness / 2),
                          b[f].bounds = {
                              x1: q,
                              y1: h + (b[f].margin + F),
                  ...
                  if (a && 0 < a.length)
                      for (f = 0; f < a.length; f++) {
                          ...
                          q = Math.round(g.x1 + e);
                          h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : g.y1 < Math.max(M, 10) ? Math.max(M, 10) : g.y1) : g.y1 < Math.max(M, 10) ? Math.max(M, 10) : g.y1;
                          p = Math.round(g.x1 + W + e);
                          k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : g.y2 - U > l.height - Math.max(M, 10) ? l.height - Math.max(M, 10) : g.y2 - U) : g.y2 > l.height - Math.max(M, 10) ? l.height - Math.max(M, 10) : g.y2;
                          if (c && 0 < c.length)
                              for (M = 0; M < c.length; M++)
                                  c[M] && c[M].labelAutoFit && (p = c[M].lineCoordinates.x1,
                                  q = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? p - W : q);
                          if (b && 0 < b.length)
                              for (M = 0; M < b.length; M++)
                                  b[M] && b[M].labelAutoFit && (p = b[M].lineCoordinates.x1,
                                  q = p - W);
                          a[f].lineCoordinates = {
                              x1: p - P,
                              y1: h,
                          ...
                          "inside" === a[f].labelPlacement && 0 < f && (a[f].lineCoordinates.x1 = a[f].lineCoordinates.x1 - (E[f] - (a[f]._titleTextBlock ? a[f]._titleTextBlock.height : 0)) + a[f].tickLength + (a[f].stripLineLabelEffectiveWidth || 0),
                          a[f].lineCoordinates.x2 = a[f].lineCoordinates.x1 + a[f].lineThickness / 2);
                          "inside" === a[f].tickPlacement && 0 < f && (a[f].lineCoordinates.x1 -= a[f].tickLength,
                          a[f].lineCoordinates.x2 = a[f].lineCoordinates.x1 + a[f].lineThickness / 2);
                          a[f].bounds = {
                              x1: p - (E[f] + P),
                              y1: h,
                  ...
                  if (d && 0 < d.length)
                      for (f = 0; f < d.length; f++) {
                          ...
                          q = Math.round(g.x1 - e);
                          h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : g.y1 < Math.max(M, 10) ? Math.max(M, 10) : g.y1) : g.y1 < Math.max(M, 10) ? Math.max(M, 10) : g.y1;
                          p = Math.round(g.x2 - X - Y);
                          k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : g.y2 - U > l.height - Math.max(M, 10) ? l.height - Math.max(M, 10) : g.y2 - U) : g.y2 > l.height - Math.max(M, 10) ? l.height - Math.max(M, 10) : g.y2;
                          if (c && 0 < c.length)
                              for (M = 0; M < c.length; M++)
                                  c[M] && c[M].labelAutoFit && (p = 0 > c[M].labelAngle ? Math.max(p, y) : 0 === c[M].labelAngle ? Math.max(p, y / 2) : p,
                                  q = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? p - X : q);
                          if (b && 0 < b.length)
                              for (M = 0; M < b.length; M++)
                                  b[M] && b[M].labelAutoFit && (p = b[M].lineCoordinates.x2,
                                  q = p - X);
                          d[f].lineCoordinates = {
                              x1: p + Q,
                              y1: h,
                          ...
                          "inside" === d[f].labelPlacement && 0 < f && (d[f].lineCoordinates.x1 = d[f].lineCoordinates.x1 + (x[f] - (d[f]._titleTextBlock ? d[f]._titleTextBlock.height : 0) - 2) - d[f].tickLength - (d[f].stripLineLabelEffectiveWidth || 0),
                          d[f].lineCoordinates.x2 = d[f].lineCoordinates.x1 + d[f].lineThickness / 2);
                          "inside" === d[f].tickPlacement && 0 < f && (d[f].lineCoordinates.x1 += d[f].tickLength,
                          d[f].lineCoordinates.x2 = d[f].lineCoordinates.x1 + d[f].lineThickness / 2);
                          d[f].bounds = {
      ...
      D.render = function(a, d, c, b, e) {
          ...
          if (a && 0 < a.length)
              for (var h = 0; h < a.length; h++)
                  a[h].renderLabelsTicksAndTitle();
          if (d && 0 < d.length)
              for (h = 0; h < d.length; h++)
                  d[h].renderLabelsTicksAndTitle();
          e.restore();
          if (c && 0 < c.length)
              for (h = 0; h < c.length; h++)
                  c[h].renderLabelsTicksAndTitle();
          if (b && 0 < b.length)
              for (h = 0; h < b.length; h++)
                  b[h].renderLabelsTicksAndTitle();
          g.preparePlotArea();
          g = g.plotArea;
          e.save();
          e.beginPath();
          ...
          if (a && 0 < a.length)
              for (h = 0; h < a.length; h++)
                  a[h].renderStripLinesOfThicknessType("value");
          if (d && 0 < d.length)
              for (h = 0; h < d.length; h++)
                  d[h].renderStripLinesOfThicknessType("value");
          if (c && 0 < c.length)
              for (h = 0; h < c.length; h++)
                  c[h].renderStripLinesOfThicknessType("value");
          if (b && 0 < b.length)
              for (h = 0; h < b.length; h++)
                  b[h].renderStripLinesOfThicknessType("value");
          if (a && 0 < a.length)
              for (h = 0; h < a.length; h++)
                  a[h].renderInterlacedColors();
          if (d && 0 < d.length)
              for (h = 0; h < d.length; h++)
                  d[h].renderInterlacedColors();
          if (c && 0 < c.length)
              for (h = 0; h < c.length; h++)
                  c[h].renderInterlacedColors();
          if (b && 0 < b.length)
              for (h = 0; h < b.length; h++)
                  b[h].renderInterlacedColors();
          e.restore();
          if (a && 0 < a.length)
              for (h = 0; h < a.length; h++)
                  a[h].renderGrid(),
                  u && (a[h].createMask(),
                  a[h].renderBreaksBackground());
          if (d && 0 < d.length)
              for (h = 0; h < d.length; h++)
                  d[h].renderGrid(),
                  u && (d[h].createMask(),
                  d[h].renderBreaksBackground());
          if (c && 0 < c.length)
              for (h = 0; h < c.length; h++)
                  c[h].renderGrid(),
                  u && (c[h].createMask(),
                  c[h].renderBreaksBackground());
          if (b && 0 < b.length)
              for (h = 0; h < b.length; h++)
                  b[h].renderGrid(),
                  u && (b[h].createMask(),
                  b[h].renderBreaksBackground());
          if (a && 0 < a.length)
              for (h = 0; h < a.length; h++)
                  a[h].renderAxisLine();
          if (d && 0 < d.length)
          ...
          if (a && 0 < a.length)
              for (h = 0; h < a.length; h++)
                  a[h].renderStripLinesOfThicknessType("pixel");
          if (d && 0 < d.length)
              for (h = 0; h < d.length; h++)
                  d[h].renderStripLinesOfThicknessType("pixel");
          if (c && 0 < c.length)
              for (h = 0; h < c.length; h++)
                  c[h].renderStripLinesOfThicknessType("pixel");
          if (b && 0 < b.length)
              for (h = 0; h < b.length; h++)
                  b[h].renderStripLinesOfThicknessType("pixel")
      }
      ;
      ...
      D.prototype.calculateBreaksSizeInValues = function() {
          for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, d = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !m(this.scaleBreaks.options.spacing), e, g = 0; g < d.length; g++)
              e = b || !m(d[g].options.spacing),
              d[g].spacing = Ta(d[g].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0,
              d[g].size = 0 > d[g].spacing ? 0 : Math.abs(d[g].spacing / c),
      ...
      D.prototype.calculateBreaksInPixels = function() {
          if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
              ...
              for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++)
                  a[d].endValue < this.conversionParameters.minimum || (m(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d),
      ...
      D.prototype.renderLabelsTicksAndTitle = function() {
          ...
          if ("undefined" === typeof this.options.interval) {
              if ("bottom" === this._position || "top" === this._position)
                  if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                      for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, h, m = this.viewportMaximum, p = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                          n = this._labels[k];
                          if (n.position < this.viewportMinimum)
                              break;
                          n.position > this.viewportMaximum || !(k === this._labels.length - 1 || h < Math.log(m / n.position) * p / e) || (c.push(n),
                          m = n.position,
                          h = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                      }
                      this._labels = c
                  } else {
                      for (k = 0; k < this._labels.length; k++)
                          n = this._labels[k],
                          n.position < this.viewportMinimum || (h = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                          c += h);
                      c > this.lineCoordinates.width * e && this.labelAutoFit && (d = !0)
                  }
              if ("left" === this._position || "right" === this._position)
                  if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                      for (var c = [], l, m = this.viewportMaximum, p = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                          n = this._labels[k];
                          if (n.position < this.viewportMinimum)
                              break;
                          n.position > this.viewportMaximum || !(k === this._labels.length - 1 || l < Math.log(m / n.position) * p) || (c.push(n),
                          m = n.position,
                          l = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                      }
                      this._labels = c
                  } else {
                      for (k = 0; k < this._labels.length; k++)
                          n = this._labels[k],
                          n.position < this.viewportMinimum || (l = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                          b += l);
          ...
          if ("bottom" === this._position) {
              for (k = 0; k < this._labels.length; k++)
                  n = this._labels[k],
                  n.position < this.viewportMinimum || n.position > this.viewportMaximum || (r = this.getPixelCoordinatesOnAxis(n.position),
                  ...
                  this.ctx.stroke()),
                  d && 0 !== g++ % 2 && this.labelAutoFit || (0 === n.textBlock.angle ? (r.x -= n.textBlock.width / 2,
                  r.y = "inside" === this.labelPlacement ? r.y - (("inside" === this.tickPlacement ? this.tickLength : 0) + n.textBlock.height - n.textBlock.fontSize / 2) : r.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + n.textBlock.fontSize / 2 + 5) : (r.x = "inside" === this.labelPlacement ? 0 > this.labelAngle ? r.x : r.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : r.x - (0 > this.labelAngle ? n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                  r.y = "inside" === this.labelPlacement ? 0 > this.labelAngle ? r.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : r.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - Math.abs(n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5) : r.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)),
                  n.textBlock.x = r.x,
                  n.textBlock.y = r.y));
              "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {
                  for (k = 0; k < a._labels.length; k++)
                      if (n = a._labels[k],
                      !(n.position < a.viewportMinimum || n.position > a.viewportMaximum) && (r = a.getPixelCoordinatesOnAxis(n.position),
                      a.tickThickness)) {
              ...
              for (k = 0; k < this._labels.length; k++)
                  ...
                  this.ctx.stroke()),
                  d && 0 !== g++ % 2 && this.labelAutoFit || (0 === n.textBlock.angle ? (r.x -= n.textBlock.width / 2,
                  r.y = "inside" === this.labelPlacement ? r.y + this.labelFontSize / 2 + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : r.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + n.textBlock.height - n.textBlock.fontSize / 2)) : (r.x = "inside" === this.labelPlacement ? 0 < this.labelAngle ? r.x : r.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : r.x + (n.textBlock.height - this.labelFontSize) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                  r.y = "inside" === this.labelPlacement ? 0 < this.labelAngle ? r.y + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : r.y - n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : r.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + ((n.textBlock.height - n.textBlock.fontSize / 2) * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))),
                  n.textBlock.x = r.x,
                  n.textBlock.y = r.y));
              "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {
                  for (k = 0; k < a._labels.length; k++)
              ...
              for (k = 0; k < this._labels.length; k++)
                  ...
                  this.ctx.stroke()),
                  d && 0 !== g++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (n.textBlock.y = r.y,
                  n.textBlock.x = "inside" === this.labelPlacement ? r.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : r.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5) : (n.textBlock.y = "inside" === this.labelPlacement ? r.y : r.y - n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),
                  n.textBlock.x = "inside" === this.labelPlacement ? r.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : 0 < this.labelAngle ? r.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5 : r.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (n.textBlock.height - n.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength))));
              "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {
                  for (k = 0; k < a._labels.length; k++)
                      if (n = a._labels[k],
                      !(n.position < a.viewportMinimum || n.position > a.viewportMaximum) && (r = a.getPixelCoordinatesOnAxis(n.position),
              ...
              this.title && (this._titleTextBlock.measureText(),
              this._titleTextBlock.x = this.bounds.x1 + this._titleTextBlock.fontSize / 2 + 1,
              ...
              for (k = 0; k < this._labels.length; k++)
                  ...
                  this.ctx.stroke()),
                  d && 0 !== g++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (n.textBlock.y = r.y,
                  n.textBlock.x = "inside" === this.labelPlacement ? r.x - n.textBlock.width - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : r.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5) : (n.textBlock.y = "inside" === this.labelPlacement ? r.y - n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0 > this.labelAngle ? r.y : r.y - (n.textBlock.height - n.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle),
                  n.textBlock.x = "inside" === this.labelPlacement ? r.x - n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : 0 < this.labelAngle ? r.x + (n.textBlock.height - n.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? 0 : this.tickLength) : r.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5)));
              "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {
                  for (k = 0; k < a._labels.length; k++)
                      if (n = a._labels[k],
                      !(n.position < a.viewportMinimum || n.position > a.viewportMaximum) && (r = a.getPixelCoordinatesOnAxis(n.position),
              ...
              this.title && (this._titleTextBlock.measureText(),
              this._titleTextBlock.x = this.bounds.x2 - this._titleTextBlock.fontSize / 2 - 1,
              this._titleTextBlock.y = this.lineCoordinates.height / 2 - this._titleTextBlock.width / 2 + this.lineCoordinates.y1,
              this.titleMaxWidth = this._titleTextBlock.maxWidth,
              this._titleTextBlock.render(!0))
          }
          ...
          if ("inside" === this.labelPlacement)
              this.chart.addEventListener("dataAnimationIterationEnd", function() {
                  for (k = 0; k < a._labels.length; k++)
                      n = a._labels[k],
                      n.position < a.viewportMinimum || (n.position > a.viewportMaximum || d && 0 !== g++ % 2 && a.labelAutoFit) || (a.ctx.save(),
                      a.ctx.beginPath(),
              ...
              for (k = 0; k < this._labels.length; k++)
                  n = this._labels[k],
                  n.position < this.viewportMinimum || (n.position > this.viewportMaximum || d && 0 !== g++ % 2 && this.labelAutoFit) || n.textBlock.render(!0)
      }
      ;
      ...
      D.prototype.renderStripLinesOfThicknessType = function(a) {
          if (this.stripLines && 0 < this.stripLines.length && a) {
              var d = this, c, b, e = 0, g = 0, h = !1;
              b = !1;
              for (var p = [], u = [], k = !1, e = 0; e < this.stripLines.length; e++) {
                  var l = this.stripLines[e];
                  l._thicknessType === a && ("pixel" === a && (l.value < this.viewportMinimum || l.value > this.viewportMaximum || m(l.value) || isNaN(this.range)) || "value" === a && (l.startValue <= this.viewportMinimum && l.endValue <= this.viewportMinimum || l.startValue >= this.viewportMaximum && l.endValue >= this.viewportMaximum || m(l.startValue) || m(l.endValue) || isNaN(this.range)) || p.push(l))
              }
              for (e = 0; e < this._stripLineLabels.length; e++)
                  if (l = this.stripLines[e],
                  c = this._stripLineLabels[e],
                  !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range)))
                      if (b = this.getPixelCoordinatesOnAxis(c.position),
                      "outside" === c.stripLine.labelPlacement) {
                          l && (this.ctx.strokeStyle = l.color,
                          this.ctx.lineWidth = "pixel" === l._thicknessType ? l.thickness : this.tickThickness);
                          if ("bottom" === this._position) {
                              ...
                              this.ctx.stroke();
                              0 === this.labelAngle ? (b.x -= c.textBlock.width / 2,
                              b.y += this.tickLength + c.textBlock.fontSize / 2 + 5) : (b.x -= 0 > this.labelAngle ? c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0,
                              b.y += this.tickLength + Math.abs(0 > this.labelAngle ? c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5))
                          } else
                              "top" === this._position ? (n = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0,
                              this.ctx.beginPath(),
                              this.ctx.moveTo(n, b.y << 0),
                              this.ctx.lineTo(n, b.y - this.tickLength << 0),
                              this.ctx.stroke(),
                              0 === this.labelAngle ? (b.x -= c.textBlock.width / 2,
                              b.y -= this.tickLength + c.textBlock.height - c.textBlock.fontSize / 2) : (b.x += (c.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                              b.y -= this.tickLength + (c.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))) : "left" === this._position ? (n = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0,
                              this.ctx.beginPath(),
                              this.ctx.moveTo(b.x << 0, n),
                              this.ctx.lineTo(b.x - this.tickLength << 0, n),
                              this.ctx.stroke(),
                              0 === this.labelAngle ? b.x = b.x - c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5 : (b.y -= c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),
                              b.x = 0 < this.labelAngle ? b.x - c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5 : b.x - c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - this.tickLength)) : "right" === this._position && (n = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0,
                              this.ctx.beginPath(),
                              this.ctx.moveTo(b.x << 0, n),
                              this.ctx.lineTo(b.x + this.tickLength << 0, n),
                              this.ctx.stroke(),
                              0 === this.labelAngle ? b.x = b.x + this.tickLength + 5 : (b.y = 0 > this.labelAngle ? b.y : b.y - (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle),
                          ...
                          l._thicknessType === a && (c.textBlock.angle = -90,
                          "bottom" === this._position ? (c.textBlock.maxWidth = this.options.stripLines[e].labelMaxWidth ? this.options.stripLines[e].labelMaxWidth : this.chart.plotArea.height - 3,
                          c.textBlock.measureText(),
                          b.x - c.textBlock.height - l.thickness / 2 > this.chart.plotArea.x1 ? m(l.startValue) ? b.x -= c.textBlock.height - c.textBlock.fontSize / 2 + l.thickness / 2 : b.x -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 : (c.textBlock.angle = 90,
                          m(l.startValue) ? b.x += c.textBlock.height - c.textBlock.fontSize / 2 + l.thickness / 2 : b.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2),
                          ...
                          c.textBlock.angle = 0,
                          c.textBlock.measureText(),
                          b.y - c.textBlock.height - l.thickness / 2 > this.chart.plotArea.y1 ? m(l.startValue) ? b.y -= c.textBlock.height - c.textBlock.fontSize / 2 + l.thickness / 2 : b.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 : m(l.startValue) ? b.y += c.textBlock.height - c.textBlock.fontSize / 2 + l.thickness / 2 : b.y += c.textBlock.height / 2 - c.textBlock.fontSize + 3,
                          b.x = "near" === c.stripLine.labelAlign ? this.chart.plotArea.x1 + 3 : "center" === c.stripLine.labelAlign ? (this.chart.plotArea.x2 + this.chart.plotArea.x1) / 2 - c.textBlock.width / 2 : this.chart.plotArea.x2 - c.textBlock.width - 3) : "right" === this._position && (c.textBlock.maxWidth = this.options.stripLines[e].labelMaxWidth ? this.options.stripLines[e].labelMaxWidth : this.chart.plotArea.width - 3,
                          c.textBlock.angle = 0,
                          c.textBlock.measureText(),
                          b.y - c.textBlock.height - l.thickness / 2 > this.chart.plotArea.y1 ? m(l.startValue) ? b.y -= c.textBlock.height - c.textBlock.fontSize / 2 + l.thickness / 2 : b.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 : m(l.startValue) ? b.y += c.textBlock.height - c.textBlock.fontSize / 2 + l.thickness / 2 : b.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3,
              ...
              if (!k) {
                  ...
                  for (e = 0; e < p.length; e++)
                      ...
                      this.chart.addEventListener("dataAnimationIterationEnd", function() {
                          ...
                          for (g = 0; g < p.length; g++)
                              l = p[g],
                              l.showOnTop && l.render();
                          this.ctx.restore()
                      }, l)) : l.render();
                  for (e = 0; e < u.length; e++)
                      c = u[e],
                      c.stripLine.showOnTop ? b || (b = !0,
                      this.chart.addEventListener("dataAnimationIterationEnd", function() {
      ...
      D.prototype.createMask = function() {
          if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
              ...
              u ? (this.maskCanvas = wa(this.chart.width, this.chart.height),
          ...
          if ("bottom" === this._position || "top" === this._position) {
              if (this.lineThickness) {
                  ...
                  if (this.scaleBreaks && !m(this.scaleBreaks.firstBreakIndex))
                      if (m(this.scaleBreaks.lastBreakIndex))
                          ...
                          for (var p = this.scaleBreaks.firstBreakIndex; p <= this.scaleBreaks.lastBreakIndex; p++)
                              d.moveTo(e, h),
                              d.lineTo(this.scaleBreaks._appliedBreaks[p].startPixel + c, h),
                              e = this.scaleBreaks._appliedBreaks[p].endPixel + b;
                  e && (d.moveTo(e, h),
                  d.lineTo(g, h));
                  d.stroke()
              }
              ...
              if (this.scaleBreaks && !m(this.scaleBreaks.firstBreakIndex))
                  if (m(this.scaleBreaks.lastBreakIndex))
                      ...
                      for (p = this.scaleBreaks.firstBreakIndex; p <= this.scaleBreaks.lastBreakIndex; p++)
                          d.moveTo(h, e),
                          d.lineTo(h, this.scaleBreaks._appliedBreaks[p].startPixel + b),
                          e = this.scaleBreaks._appliedBreaks[p].endPixel + c;
              e && (d.moveTo(h, e),
              d.lineTo(h, g));
              d.stroke()
          }
          u && (a.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height),
      ...
      D.prototype.calculateAxisParameters = function() {
          if (this.logarithmic)
              ...
              var a = Math.max(b, Math.floor(this.maxWidth / a)), e, g, h, b = 0;
              ...
              if ("axisX" === this.type) {
                  ...
                  0 === g - e && (b = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval,
                  g += b,
                  e -= b);
                  Infinity !== this.dataInfo.minDiff ? h = this.dataInfo.minDiff : 1 < g - e ? h = 0.5 * Math.abs(g - e) : (h = 1,
                  c && (d = !0))
              } else
                  ...
                  0 === e && 0 === g ? (g += 9,
                  e = 0) : 0 === g - e ? (b = Math.min(Math.abs(0.01 * Math.abs(g)), 5),
                  g += b,
                  e -= b) : e > g ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(g, e, null, !0)), 5),
                  0 <= g ? e = g - b : g = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, g, null, !0)), 0.05),
                  0 !== g && (g += b),
                  0 !== e && (e -= b)),
                  h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - e ? 0.5 * Math.abs(g - e) : 1,
              ...
              b = this.getApparentDifference(isNaN(this.viewportMinimum) || null === this.viewportMinimum ? e : this.viewportMinimum, isNaN(this.viewportMaximum) || null === this.viewportMaximum ? g : this.viewportMaximum, null, !0);
              ...
              if (null === this.minimum || null === this.maximum)
                  ...
                  g += b,
                  e -= b),
                  h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - e ? 0.5 * Math.abs(g - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min,
                  g = null !== this.maximum ? this.maximum : this.dataInfo.max,
                  ...
                  0 <= g ? e = g - b : g = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, g, null, !0)), 0.05),
                  0 !== g && (g += b),
                  0 !== e && (e -= b)) : (g = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval,
                  e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity),
                  h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - e ? 0.5 * Math.abs(g - e) : 1,
                  ...
                  "axisX" === this.type && c) {
                      ...
                      null === this.minimum && (this.minimum = "axisX" === this.type ? e - h / 2 : Math.floor(e / this.interval) * this.interval,
                      this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)),
                      null === this.maximum && (this.maximum = "axisX" === this.type ? g + h / 2 : Math.ceil(g / this.interval) * this.interval,
                      this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum)),
      ...
      D.prototype.calculateLogarithmicAxisParameters = function() {
          ...
          this.maxHeight = a.height) : (this.maxWidth = a.height,
          this.maxHeight = a.width);
          var a = "axisX" === this.type ? 500 > this.maxWidth ? 7 : Math.max(7, Math.floor(this.maxWidth / 100)) : Math.max(Math.floor(this.maxWidth / 50), 3), b, e, g, h;
          h = 1;
          if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
              this.viewportMinimum = this.minimum;
          if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
          ...
          if (this.scaleBreaks)
              for (h = 0; h < this.scaleBreaks._appliedBreaks.length; h++)
                  if ((!m(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue || !m(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[h].startValue || !m(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue) && (!m(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue || !m(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[h].endValue || !m(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue)) {
          ...
          1 === e / b && (h = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval),
          e *= h,
          b /= h),
          g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
          e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
          ...
          b = 1) : 1 === e / b ? (h = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
          e *= h,
          b /= h) : b > e ? (h = Math.min(b / e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
          1 <= e ? b = e / h : e = b * h) : (h = Math.min(e / b * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
          1 !== e && (e *= h),
          1 !== b && (b /= h)),
          g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase,
          ...
          var p = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? e : this.viewportMaximum) - (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? b : this.viewportMinimum);
          this.intervalType = "number";
          h = Math.pow(this.logarithmBase, D.getNiceNumber(Math.abs(Math.log(h) / d), !1));
          this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = D.getNiceExponent(Math.log(h) / d / (a - 1), !0),
          c = D.getNiceNumber(p / (a - 1), !0));
          if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
          ...
          this.options && "undefined" === typeof this.options.interval && (this.interval = D.getNiceExponent(Math.ceil(Math.log(h) / d) / (a - 1)),
          ...
          if (null === this.minimum || null === this.maximum)
              ...
              e *= h,
              b /= h),
              g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (b = null !== this.minimum ? this.minimum : this.dataInfo.min,
              e = null !== this.maximum ? this.maximum : this.dataInfo.max,
              isFinite(b) || isFinite(e) ? 1 === b && 1 === e ? (e *= this.logarithmBase,
              b /= this.logarithmBase) : 1 === e / b ? (h = Math.pow(this.logarithmBase, this.interval),
              e *= h,
              b /= h) : b > e ? (h = Math.min(0.01 * (b / e), 5),
              1 <= e ? b = e / h : e = b * h) : (h = Math.min(e / b * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
              1 !== e && (e *= h),
              1 !== b && (b /= h)) : (e = "undefined" === typeof this.options.interval ? 0 : this.options.interval,
              b = 1),
              g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase,
              ...
              this.intervalType = "number",
              null === this.minimum && (this.minimum = "axisX" === this.type ? b / Math.sqrt(g) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(b) / d / this.interval)),
              m(null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? "undefined" === typeof this.sessionVariables.newViewportMinimum ? Infinity : this.sessionVariables.newViewportMinimum : this.sessionVariables.viewportMinimum) || (this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? "undefined" === typeof this.sessionVariables.newViewportMinimum ? Infinity : this.sessionVariables.newViewportMinimum : this.sessionVariables.viewportMinimum))),
              ...
              m(null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? "undefined" === typeof this.sessionVariables.newViewportMaximum ? 0 : this.sessionVariables.newViewportMaximum : this.sessionVariables.viewportMaximum) || (this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? "undefined" === typeof this.sessionVariables.newViewportMaximum ? 0 : this.sessionVariables.newViewportMaximum : this.sessionVariables.viewportMaximum))),
      ...
      da.prototype.createUserOptions = function(a) {
          if ("undefined" !== typeof a || this.options._isPlaceholder) {
              ...
              this.options._isPlaceholder || (Ea(this.parent[this.optionsName]),
      ...
      da.prototype.render = function(a) {
          if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
              ...
              if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                  if (b = 1 === n % 2 ? (b.x << 0) + 0.5 : b.x << 0,
                  h = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0,
                  "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1,
                  m = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2,
                  ...
                  "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a)
                      ...
                      l = (m - k) / a / 3;
                      for (var r = 0; r < l; r++)
                          this.ctx.bezierCurveTo(p + g * a, k + a, p + g * a, k + 2 * a, p, k + 3 * a),
                          k += 3 * a,
                          g *= -1;
                      this.ctx.bezierCurveTo(p + g * a, k + a, p + g * a, k + 2 * a, p, k + 3 * a);
                      p = h;
                  ...
                  "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a)
                      ...
                      l = (h - p) / a / 3;
                      for (r = 0; r < l; r++)
                          this.ctx.bezierCurveTo(p + a, k + g * a, p + 2 * a, k + g * a, p + 3 * a, k),
                          p += 3 * a,
                          g *= -1;
                      this.ctx.bezierCurveTo(p + a, k + g * a, p + 2 * a, k + g * a, p + 3 * a, k);
                      k = m;
      ...
      P.prototype.createUserOptions = function(a) {
          if ("undefined" !== typeof a || this.options._isPlaceholder) {
              var d = 0;
              this.parent.options._isPlaceholder && this.parent.createUserOptions();
              this.options._isPlaceholder || (Ea(this.parent.stripLines),
      ...
      ea.prototype.showAt = function(a) {
          ...
          for (b = 0; b < d.axisX.length; b++)
              ...
              d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !m(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum) && (d.axisX[b].showCrosshair(a),
              d.axisX[b].crosshair._updatedValue = a,
              this === d.axisX[b].crosshair && (c = !0));
          for (b = 0; b < d.axisX2.length; b++)
              a = d.axisX2[b]._crosshairValue,
              d.axisX2[b].crosshair && (d.axisX2[b].crosshair.enabled && !m(a) && a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum) && (d.axisX2[b].showCrosshair(a),
              d.axisX2[b].crosshair._updatedValue = a,
              this === d.axisX2[b].crosshair && (c = !0));
          for (b = 0; b < d.axisY.length; b++)
              a = d.axisY[b]._crosshairValue,
              d.axisY[b].crosshair && (d.axisY[b].crosshair.enabled && !m(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum) && (d.axisY[b].showCrosshair(a),
              d.axisY[b].crosshair._updatedValue = a,
              this === d.axisY[b].crosshair && (c = !0));
          for (b = 0; b < d.axisY2.length; b++)
              a = d.axisY2[b]._crosshairValue,
              d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !m(a) && a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a),
      ...
      ;
      ea.prototype.render = function(a, d, c) {
          var b, e, g, h, p = null, u = null, k = null, l = "";
          ...
          if (this.snapToDataPoint) {
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                  var x = null;
                  if ("bottom" === this.parent._position || "top" === this.parent._position)
                      z = this.parent.dataSeries[0].axisX.convertPixelToValue({
                          y: d
                      });
                  else if ("left" === this.parent._position || "right" === this.parent._position)
                      z = this.parent.convertPixelToValue({
                          y: d
                      });
                  for (var s = 0; s < this.parent.dataSeries.length; s++)
                      (x = this.parent.dataSeries[s].getDataPointAtX(z, !0)) && 0 <= x.index && (x.dataSeries = this.parent.dataSeries[s],
                  ...
                  for (var z = Infinity, v, s = 0; s < l.length; s++) {
                      if ("rangeBar" === l[s].dataSeries.type || "error" === l[s].dataSeries.type) {
                          if (l[s].dataPoint.y)
                              for (var E = 0; E < l[s].dataPoint.y.length; E++)
                                  y = Math.abs(a - this.parent.convertValueToPixel(l[s].dataPoint.y[E])),
                                  y <= z && (z = y,
                                  x = s)
                      } else
                          "stackedBar" === l[s].dataSeries.type ? (cumulativeY = l[s].dataSeries.dataPointEOs[l[s].index].cumulativeY,
                          y = Math.abs(a - this.parent.convertValueToPixel(cumulativeY)),
                          y <= z && (z = y,
                          x = s)) : "stackedBar100" === l[s].dataSeries.type ? (y = l[0].dataPoint.x.getTime ? l[0].dataPoint.x.getTime() : l[0].dataPoint.x,
                          m(v) && (v = Math.abs(a - this.parent.convertValueToPixel(100 * (l[0].dataSeries.dataPointEOs[l[0].index].cumulativeY / l[0].dataSeries.plotUnit.dataPointYSums[y])))),
                          cumulativeY = l[s].dataSeries.dataPointEOs[l[s].index].cumulativeY,
                          y = l[s].dataPoint.x.getTime ? l[s].dataPoint.x.getTime() : l[s].dataPoint.x,
                          yPercent = 100 * (cumulativeY / l[s].dataSeries.plotUnit.dataPointYSums[y]),
                          y = Math.abs(a - this.parent.convertValueToPixel(yPercent)),
                          y <= v && (v = y,
                          x = s)) : (y = Math.abs(a - this.parent.convertValueToPixel(l[s].dataPoint.y)),
                          y <= z && (z = y,
                          x = s));
                      m(v) || (z = Math.min(z, v))
                  }
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) {
                      if ("rangeBar" === v.dataSeries.type || "error" === v.dataSeries.type) {
                          z = Math.abs(a - this.parent.convertValueToPixel(v.dataPoint.y[0]));
                          for (l = 0; l < v.dataPoint.y.length; l++)
                              y = Math.abs(a - this.parent.convertValueToPixel(v.dataPoint.y[l])),
                              y < z && (z = y,
                              s = l);
                          p = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(v.dataPoint.y[s]) << 0) + 0.5 : this.parent.convertValueToPixel(v.dataPoint.y[s]) << 0;
                          ...
                          }) : m(this.options.label) ? ga(m(c) ? v.dataPoint.y[s] : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                      } else
                          "stackedBar" === v.dataSeries.type ? (z = Math.abs(a - this.parent.convertValueToPixel(l[0].dataPoint.y)),
                          cumulativeY = v.dataSeries.dataPointEOs[v.index].cumulativeY,
                          p = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(cumulativeY) << 0) + 0.5 : this.parent.convertValueToPixel(cumulativeY) << 0,
                          ...
                          k.text = this.labelFormatter ? this.labelFormatter({
                              ...
                              crosshair: this.options,
                              value: v.dataPoint.y
                          }) : m(this.options.label) ? ga(m(c) ? v.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label) : "stackedBar100" === v.dataSeries.type ? (z = Math.abs(a - this.parent.convertValueToPixel(l[0].dataPoint.y)),
                          cumulativeY = v.dataSeries.dataPointEOs[v.index].cumulativeY,
                          y = v.dataPoint.x.getTime ? v.dataPoint.x.getTime() : v.dataPoint.x,
                          yPercent = 100 * (cumulativeY / v.dataSeries.plotUnit.dataPointYSums[y]),
                          p = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(yPercent) << 0) + 0.5 : this.parent.convertValueToPixel(yPercent) << 0,
                          this.value = yPercent,
                          k.text = this.labelFormatter ? this.labelFormatter({
                              chart: this.chart,
                              axis: this.parent.options,
                              crosshair: this.options,
                              value: yPercent
                          }) : m(this.options.label) ? ga(m(c) ? yPercent : c, this.valueFormatString, this.chart._cultureInfo) : this.label) : (p = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(v.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(v.dataPoint.y) << 0,
                          ...
                          k.text = this.labelFormatter ? this.labelFormatter({
                              ...
                              crosshair: this.options,
                              value: v.dataPoint.y
                          }) : m(this.options.label) ? ga(m(c) ? v.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
                      b = e = p;
                      ...
                      g = h = u = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(v.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(v.dataPoint.x) << 0;
                      ...
                      if (this.parent.labels)
                          for (z = Math.ceil(this.parent.interval),
                          l = 0; l < this.parent.viewportMaximum; l += z)
                      ...
                      if (s) {
                          if ("axisX" === this.parent.type)
                              for (z = this.parent.convertPixelToValue({
                                  y: d
                              }),
                              x = null,
                              s = 0; s < this.parent.dataSeries.length; s++)
                                  (x = this.parent.dataSeries[s].getDataPointAtX(z, !0)) && 0 <= x.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                      chart: this.chart,
                                      axis: this.parent.options,
                                      crosshair: this.options,
                                      value: v.dataPoint.x
                                  }) : m(this.options.label) ? x.dataPoint.label : this.label)
                      } else
                          k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({
                              ...
                              crosshair: this.options,
                              value: v.dataPoint.x
                          }) : m(this.options.label) ? ga(v.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                              chart: this.chart,
                              axis: this.parent.options,
                              crosshair: this.options,
                              value: v.dataPoint.x
                          }) : m(this.options.label) ? Da(v.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label;
                  ...
                  v = l[0];
                  b = e = p = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(v.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(v.dataPoint.x) << 0;
                  g = this.chart.plotArea.y1;
                  h = this.chart.plotArea.y2;
                  this.bounds = {
                      x1: b - r / 2,
                  ...
                  !m(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (z = this.parent.dataSeries[0].axisX.convertPixelToValue({
                      x: a
                  }));
                  for (s = 0; s < this.parent.dataSeries.length; s++)
                      (x = this.parent.dataSeries[s].getDataPointAtX(z, !0)) && 0 <= x.index && (x.dataSeries = this.parent.dataSeries[s],
                  ...
                  for (s = 0; s < l.length; s++) {
                      if ("rangeColumn" === l[s].dataSeries.type || "rangeArea" === l[s].dataSeries.type || "error" === l[s].dataSeries.type || "rangeSplineArea" === l[s].dataSeries.type || "candlestick" === l[s].dataSeries.type || "ohlc" === l[s].dataSeries.type || "boxAndWhisker" === l[s].dataSeries.type) {
                          if (l[s].dataPoint.y)
                              for (E = 0; E < l[s].dataPoint.y.length; E++)
                                  y = Math.abs(d - this.parent.convertValueToPixel(l[s].dataPoint.y[E])),
                                  y <= z && (z = y,
                                  x = s)
                      } else
                          "stackedColumn" === l[s].dataSeries.type ? (b = l[s].dataSeries.dataPointEOs[l[s].index].cumulativeY,
                          y = Math.abs(d - this.parent.convertValueToPixel(b)),
                          y <= z && (z = y,
                          x = s)) : "stackedArea" === l[s].dataSeries.type ? (b = l[s].dataSeries.dataPointEOs[l[s].index].cumulativeY,
                          y = Math.abs(d - this.parent.convertValueToPixel(b)),
                          y <= z && (z = y,
                          x = s)) : "stackedColumn100" === l[s].dataSeries.type || "stackedArea100" === l[s].dataSeries.type ? (y = l[0].dataPoint.x.getTime ? l[0].dataPoint.x.getTime() : l[0].dataPoint.x,
                          m(v) && (v = Math.abs(d - this.parent.convertValueToPixel(100 * (l[0].dataSeries.dataPointEOs[l[0].index].cumulativeY / l[0].dataSeries.plotUnit.dataPointYSums[y])))),
                          "stackedColumn100" === l[s].dataSeries.type ? (u = l[s].dataSeries.dataPointEOs[l[s].index].cumulativeY,
                          y = l[s].dataPoint.x.getTime ? l[s].dataPoint.x.getTime() : l[s].dataPoint.x,
                          b = 100 * (u / l[s].dataSeries.plotUnit.dataPointYSums[y]),
                          y = Math.abs(d - this.parent.convertValueToPixel(b)),
                          y <= v && (v = y,
                          x = s)) : "stackedArea100" === l[s].dataSeries.type && (u = l[s].dataSeries.dataPointEOs[l[s].index].cumulativeY,
                          y = l[s].dataPoint.x.getTime ? l[s].dataPoint.x.getTime() : l[s].dataPoint.x,
                          b = 100 * (u / l[s].dataSeries.plotUnit.dataPointYSums[y]),
                          y = Math.abs(d - this.parent.convertValueToPixel(b)),
                          y <= v && (v = y,
                          x = s))) : "waterfall" === l[s].dataSeries.type ? (y = Math.abs(d - this.parent.convertValueToPixel(l[s].dataSeries.dataPointEOs[l[s].index].cumulativeSum)),
                          y <= z && (v = z = y,
                          x = s)) : (y = Math.abs(d - this.parent.convertValueToPixel(l[s].dataPoint.y)),
                          y <= z && (z = y,
                          x = s));
                      m(v) || (z = Math.min(z, v))
                  }
                  ...
                  if ("rangeColumn" === v.dataSeries.type || "rangeArea" === v.dataSeries.type || "error" === v.dataSeries.type || "rangeSplineArea" === v.dataSeries.type || "candlestick" === v.dataSeries.type || "ohlc" === v.dataSeries.type || "boxAndWhisker" === v.dataSeries.type) {
                      z = Math.abs(d - this.parent.convertValueToPixel(v.dataPoint.y[0]));
                      for (l = 0; l < v.dataPoint.y.length; l++)
                          y = Math.abs(d - this.parent.convertValueToPixel(v.dataPoint.y[l])),
                          y < z && (z = y,
                          s = l);
                      u = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(v.dataPoint.y[s]) << 0) + 0.5 : this.parent.convertValueToPixel(v.dataPoint.y[s]) << 0;
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                      ...
                      "stackedColumn" === v.dataSeries.type ? (b = v.dataSeries.dataPointEOs[v.index].cumulativeY,
                      u = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                      ...
                      this.value = b) : "stackedArea" === v.dataSeries.type ? (b = v.dataSeries.dataPointEOs[v.index].cumulativeY,
                      u = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                      ...
                      this.value = b) : "stackedColumn100" === v.dataSeries.type ? (u = v.dataSeries.dataPointEOs[v.index].cumulativeY,
                      y = v.dataPoint.x.getTime ? v.dataPoint.x.getTime() : v.dataPoint.x,
                      b = 100 * (u / v.dataSeries.plotUnit.dataPointYSums[y]),
                      u = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                          value: b
                      }) : m(this.options.label) ? ga(m(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                      this.value = b) : "stackedArea100" === v.dataSeries.type ? (u = v.dataSeries.dataPointEOs[v.index].cumulativeY,
                      y = v.dataPoint.x.getTime ? v.dataPoint.x.getTime() : v.dataPoint.x,
                      b = 100 * (u / v.dataSeries.plotUnit.dataPointYSums[y]),
                      u = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                      ...
                      this.value = b) : "waterfall" === v.dataSeries.type ? (u = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(v.dataSeries.dataPointEOs[v.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(v.dataSeries.dataPointEOs[v.index].cumulativeSum) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                          value: v.dataSeries.dataPointEOs[v.index].cumulativeSum
                      }) : m(this.options.label) ? ga(m(c) ? v.dataSeries.dataPointEOs[v.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                      this.value = v.dataSeries.dataPointEOs[v.index].cumulativeSum) : (u = 1 === f.lineWidth % 2 ? (m(a) ? d : this.parent.convertValueToPixel(v.dataPoint.y) << 0) + 0.5 : m(a) ? d : this.parent.convertValueToPixel(v.dataPoint.y) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
              ...
              if ("bottom" === this.parent._position || "top" === this.parent._position)
                  ...
                  this.value >= Math.min(this.parent.viewportMinimum, this.parent.viewportMaximum) && this.value <= Math.max(this.parent.viewportMinimum, this.parent.viewportMaximum) && 0 < r && (f.moveTo(b, g),
                  f.lineTo(e, h),
                  f.stroke(),
                  this._hidden = !1);
              ...
              if ("bottom" === this.parent._position || "top" === this.parent._position)
                  b = e = p = 1 === f.lineWidth % 2 ? (a << 0) + 0.5 : a << 0,
                  g = this.chart.plotArea.y1,
                  h = this.chart.plotArea.y2,
                  this.bounds = {
                      x1: b - r / 2,
                  ...
                  g = h = u = 1 === f.lineWidth % 2 ? (d << 0) + 0.5 : d << 0,
                  b = this.chart.plotArea.x1,
                  e = this.chart.plotArea.x2,
                  this.bounds = {
                      x1: b,
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                  if ("left" === this.parent._position || "right" === this.parent._position) {
                      ...
                      if (s) {
                          ...
                          k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({
                              ...
                              axis: this.parent.options,
                              crosshair: this.options,
                              value: m(c) ? this.parent.convertPixelToValue(d) : c
                          }) : m(this.options.label) ? ga(m(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                              chart: this.chart,
                              axis: this.parent.options,
                              crosshair: this.options,
                              value: m(c) ? this.parent.convertPixelToValue(d) : c
                          }) : m(this.options.label) ? Da(m(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                      ...
                      if ("bottom" === this.parent._position || "top" === this.parent._position)
                          k.text = this.labelFormatter ? this.labelFormatter({
                              ...
                              crosshair: this.options,
                              value: m(c) ? this.parent.convertPixelToValue(a) : c
                          }) : m(this.options.label) ? ga(m(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                          k.x = b - k.measureText().width / 2,
                          k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width),
                          k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1),
                          "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
                      ...
                      if ("axisX" === this.parent.type)
                          ...
                          s = 0; s < this.parent.dataSeries.length; s++)
                              (x = this.parent.dataSeries[s].getDataPointAtX(z, !0)) && 0 <= x.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                  ...
                                  crosshair: this.options,
                                  value: m(c) ? this.parent.convertPixelToValue(a) : c
                              }) : m(this.options.label) ? m(c) ? x.dataPoint.label : c : this.label)
                  } else
                      k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                          value: m(c) ? 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" : c
                      }) : m(this.options.label) ? ga(m(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                          value: m(c) ? this.parent.convertPixelToValue(a) : c
                  ...
                  k.text = this.labelFormatter ? this.labelFormatter({
                      ...
                      crosshair: this.options,
                      value: m(c) ? this.parent.convertPixelToValue(d) : c
                  }) : m(this.options.label) ? ga(m(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                  k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2,
                  k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2),
                  "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x2 - k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2);
          ...
          if ("left" === this.parent._position || "right" === this.parent._position)
              this._updatedValue = this.parent.convertPixelToValue(u);
          this._textBlock = k;
          this._label = c;
      ...
      ea.prototype.renderLabel = function() {
          ...
          m(this._label) && this.dispatchEvent("updated", {
              chart: this.chart,
              crosshair: this.options,
              axis: this.parent,
              value: this.value
      ...
      W.prototype._initialize = function() {
          ...
          if (this.enabled) {
              ...
              u || (a.style.filter = "alpha(opacity = 90)",
      ...
      W.prototype.mouseMoveHandler = function(a, d) {
          ...
          !this._updatedEventParameters || (isNaN(this._prevX) || isNaN(this._prevY)) || this.dispatchEvent("updated", this._updatedEventParameters, this))
      }
      ;
          ...
          if (!this.chart.disableToolTip) {
              ...
              if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                  ...
                  if (this.chart.axisX)
                      for (var w = 0; w < this.chart.axisX.length; w++) {
                          for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[w].convertPixelToValue({
                              ...
                              x: a
                          }), k = null, b = 0; b < this.chart.axisX[w].dataSeries.length; b++)
                              (k = this.chart.axisX[w].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[w].dataSeries[b],
                              null !== k.dataPoint.y && k.dataSeries.visible && p.push(k));
                          k = null
                      }
                  if (this.chart.axisX2)
                      for (w = 0; w < this.chart.axisX2.length; w++) {
                          h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[w].convertPixelToValue({
                              y: d
                          ...
                          for (b = 0; b < this.chart.axisX2[w].dataSeries.length; b++)
                              (k = this.chart.axisX2[w].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[w].dataSeries[b],
                              null !== k.dataPoint.y && k.dataSeries.visible && p.push(k));
                          k = null
                      }
                  if (0 === p.length)
                  ...
                  for (b = 0; b < p.length; b++)
                      p[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() && g.push(p[b]);
                  p = null
              } else {
                  if (b = this.chart.getDataPointAtXY(a, d, c))
                      ...
                      if (b = $a(a, d, this.chart._eventManager.ghostCtx),
                      ...
                      if (!m(k) && !m(k.dataPoint) && !m(k.dataPoint.y))
                          if (k.dataSeries.axisY)
                              if (0 < k.dataPoint.y.length) {
                                  ...
                                  "column" === e.type || "bar" === e.type ? 0 > k.dataPoint.y ? 0 > k.dataSeries.axisY.viewportMinimum && k.dataSeries.axisY.viewportMaximum >= k.dataPoint.y && g.push(k) : k.dataSeries.axisY.viewportMinimum <= k.dataPoint.y && 0 <= k.dataSeries.axisY.viewportMaximum && g.push(k) : "bubble" === e.type ? (c = this.chart._eventManager.objectMap[e.dataPointIds[k.index]].size / 2,
                                  k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum - c && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum + c && g.push(k)) : "waterfall" === e.type ? (c = 0,
                                  ...
                                  2 > c && -2 < c && g.push(k)) : (0 <= k.dataSeries.type.indexOf("100") || "stackedColumn" === e.type || "stackedBar" === e.type || k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum) && g.push(k);
                          else
                              g.push(k)
                  }
              }
      ...
      W.prototype.highlightObjects = function(a) {
          ...
          for (c = 0; c < a.length; c++) {
              ...
              if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                  ...
                  X.drawMarkers([g]),
                  "undefined" !== typeof e.y2 && (g = b.getMarkerProperties(h, e.x1, e.y2, this.chart.overlaidCanvasCtx),
                  g.size = Math.max(1.5 * g.size << 0, 10),
                  g.borderColor = g.borderColor || "#FFFFFF",
                  g.borderThickness = g.borderThickness || Math.ceil(0.1 * g.size),
                  X.drawMarkers([g]))) : "bubble" === b.type ? (g = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx),
                  g.size = e.size,
                  g.color = "white",
                  g.borderColor = "white",
                  d.globalAlpha = 0.3,
                  X.drawMarkers([g]),
                  d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? ba(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? ra(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? ta(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1,
                  ...
                  d.stroke(),
                  ba(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1),
                  ...
                  d.stroke()),
                  d.beginPath(),
                  ba(d, e.x1, Math.max(e.y2, e.y3), e.x2, Math.min(e.y2, e.y3), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1),
                  d.globalAlpha = 1,
                  ...
                  d.stroke()),
                  d.restore(),
                  d.globalAlpha = 1) : "error" === b.type && z(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
              }
          }
          d.restore();
          d.globalAlpha = 1;
      ...
      W.prototype.getToolTipInnerHTML = function(a) {
          ...
          if (this.isToolTipDefinedInData && (this.content && "function" === typeof this.content || this.contentFormatter))
              ...
              for (var m = null, p = "", h = 0; h < a.length; h++) {
                  c = a[h].dataSeries;
                  b = a[h].dataPoint;
                  e = a[h].index;
                  g = "";
                  if (0 === h && this.isToolTipDefinedInData && !this.content) {
                      this.chart.axisX && 0 < this.chart.axisX.length ? p += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (p += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}");
                      p += "</br>";
                      if (!c.visible)
                          continue;
                      p = this.chart.replaceKeywordsWithValue(p, b, c, e)
                  }
                  ...
                  g += b.toolTipContent ? b.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span data-color='\"" + (this.options.fontColor ? "" : "'{color}'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}",
                  m = c.axisXIndex) : "bubble" === c.type ? (this.chart.axisX && 1 < this.chart.axisX.length && (g += m != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
                  ...
                  g += b.toolTipContent ? b.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span data-color='\"" + (this.options.fontColor ? "" : "'{color}'") + "\"'>{name}:</span><br/>Minimum: &nbsp;{y[0]}<br/>Q1:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[1]}<br/>Q2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[4]}<br/>Q3:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Maximum: &nbsp;{y[3]}"),
                  null === d && (d = ""),
                  c.visible && (!0 === this.reversed ? (d = this.chart.replaceKeywordsWithValue(g, b, c, e) + d,
                  h < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(g, b, c, e),
                  h < a.length - 1 && (d += "</br>"))))
              }
              null !== d && (d = p + d)
          } else {
      ...
      W.prototype.showAtX = function(a, d) {
          ...
          if (this.shared)
              for (var h = 0; h < this.chart.data.length; h++)
                  c = this.chart.data[h],
                  (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !m(b.dataPoint.y) && c.visible) && (b.dataSeries = c,
                  g.push(b));
          else
              c = this.chart.data[d],
              (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !m(b.dataPoint.y) && c.visible) && (b.dataSeries = c,
          ...
          if (0 < g.length) {
              for (h = 0; h < g.length; h++)
                  if (b = g[h],
                  (this.shared || 0 <= b.dataSeries.type.indexOf("100")) && b.dataPoint.x >= b.dataSeries.axisX.viewportMinimum && b.dataPoint.x <= b.dataSeries.axisX.viewportMaximum) {
                      e = !1;
                      break
              ...
              if (null !== h) {
                  ...
                  if (this.isToolTipDefinedInData && m(this.options.content) && m(this.options.contentFormatter))
                      for (b = this.contentDiv.getElementsByTagName("span"),
                      h = 0; h < b.length; h++)
                  ...
                  "pie" === g[0].dataSeries.type || "doughnut" === g[0].dataSeries.type || "funnel" === g[0].dataSeries.type || "pyramid" === g[0].dataSeries.type ? c = mouseX - 10 - this.container.clientWidth : (c = "bar" === g[0].dataSeries.type || "rangeBar" === g[0].dataSeries.type || "stackedBar" === g[0].dataSeries.type || "stackedBar100" === g[0].dataSeries.type ? g[0].dataSeries.axisY.convertValueToPixel(g[0].dataPoint.y) - this.container.clientWidth << 0 : g[0].dataSeries.axisX.convertValueToPixel(g[0].dataPoint.x) - this.container.clientWidth << 0,
                  c -= 10);
      ...
      aa.prototype.reset = function() {
          ...
          this.previousDataPointEventObject = null;
          this.eventObjects = [];
          u && (this.ghostCtx.clearRect(0, 0, this.chart.width, this.chart.height),
          this.ghostCtx.beginPath())
      }
      ;
          ...
          if ("mousemove" === a.type || "click" === a.type) {
              ...
              if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b])
                  ...
                  "dataPoint" === b.objectType) {
                      ...
                      g = null !== b.dataPointIndex ? e.dataPoints[b.dataPointIndex] : null,
                      b.eventParameter = {
                          x: c.x,
                          y: c.y,
                          dataSeries: e.options,
      ...
      aa.prototype.fireEvent = function(a, d, c) {
          if (a && d) {
              ...
              "mouseout" !== d ? g.cursor && g.cursor !== c.target.style.cursor && (c.target.style.cursor = g.cursor) : (c.target.style.cursor = this.chart.panEnabled ? "itemmouseout" !== e.mouseout || g.dockInsidePlotArea ? "move" : this.chart._defaultCursor : this.chart._defaultCursor,
      ...
      var O = {
        ...
        , X = {
          drawMarker: function(a, d, c, b, e, g, h, m) {
              if (c) {
                  var p = 1;
                  ...
                  g && c.fill(),
                  m && (h ? c.stroke() : (p = c.globalAlpha,
                  c.globalAlpha = 0.15,
                  c.strokeStyle = "black",
                  c.stroke(),
                  c.globalAlpha = p))) : "square" === b ? (c.beginPath(),
                  ...
                  c.strokeStyle = "black",
                  c.stroke(),
                  c.globalAlpha = p))) : "triangle" === b ? (c.beginPath(),
                  ...
                  c.stroke(),
                  c.globalAlpha = p)),
                  c.beginPath()) : "cross" === b && (c.strokeStyle = g,
                  c.lineWidth = e / 4,
                  c.beginPath(),
                  c.moveTo(a - e / 2, d - e / 2),
                  c.lineTo(a + e / 2, d + e / 2),
